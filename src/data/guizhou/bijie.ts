...
export const bijieCityData: CityInsuranceData = {
  cityCode: '520500',
  cityName: '毕节市',
  provinceCode: '520000',
  provinceName: '贵州省',
  hotline: '0857-12393',
  officialPortalUrl: 'http://ybj.bijie.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'bj-employee-outpatient-2022',
      title: '毕节市人民政府办公室关于印发毕节市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '毕府办发〔2022〕20号',
      issuingDept: ['毕节市人民政府办公室', '毕节市医疗保障局'],
      publishDate: '2022-12-16',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.bijie.gov.cn/zwgk/zcfg/202212/t20221221_1189234.html',
    ...
    {
      docId: 'bj-medical-insurance-policy-2023',
      title: '毕节市医疗保障局关于进一步完善基本医疗保险待遇政策的通知',
      docNumber: '毕医保发〔2023〕18号',
      issuingDept: ['毕节市医疗保障局', '毕节市财政局'],
      publishDate: '2023-11-20',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.bijie.gov.cn/zwgk/zcfg/202311/t20231126_1289123.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'bj-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'bj-medical-insurance-policy-2023',
      annualCap: 500000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'bj-medical-insurance-policy-2023',
      filingChannels: ['国家医保服务平台APP', '贵州通', '毕节医保微信公众号'],
