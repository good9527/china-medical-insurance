...
export const tongrenCityData: CityInsuranceData = {
  cityCode: '520600',
  cityName: '铜仁市',
  provinceCode: '520000',
  provinceName: '贵州省',
  hotline: '0856-12393',
  officialPortalUrl: 'http://ybj.trs.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'tr-employee-outpatient-2022',
      title: '铜仁市人民政府办公室关于印发铜仁市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '铜府办发〔2022〕19号',
      issuingDept: ['铜仁市人民政府办公室', '铜仁市医疗保障局'],
      publishDate: '2022-12-16',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.trs.gov.cn/zwgk/zcfg/202212/t20221221_1189234.html',
    ...
    {
      docId: 'tr-medical-insurance-policy-2023',
      title: '铜仁市医疗保障局关于进一步完善基本医疗保险待遇政策的通知',
      docNumber: '铜医保发〔2023〕17号',
      issuingDept: ['铜仁市医疗保障局', '铜仁市财政局'],
      publishDate: '2023-11-20',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.trs.gov.cn/zwgk/zcfg/202311/t20231126_1289123.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'tr-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'tr-medical-insurance-policy-2023',
      annualCap: 500000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'tr-medical-insurance-policy-2023',
      filingChannels: ['国家医保服务平台APP', '贵州通', '铜仁医保微信公众号'],
