...
export const zunyiCityData: CityInsuranceData = {
  cityCode: '520300',
  cityName: '遵义市',
  provinceCode: '520000',
  provinceName: '贵州省',
  hotline: '0851-12393',
  officialPortalUrl: 'http://ybj.zunyi.gov.cn/',
  ...
  sourceDocs: [
    {
      ...
      title: '遵义市人民政府办公室关于印发遵义市建立健全职工基本医疗保险门诊共济保障机制实施方案的通知',
      docNumber: '遵府办发〔2022〕21号',
      issuingDept: ['遵义市人民政府办公室', '遵义市医疗保障局'],
    ...
    },
    {
      ...
      title: '遵义市医疗保障局关于调整基本医疗保险待遇政策的通知',
      docNumber: '遵医保发〔2023〕18号',
      issuingDept: ['遵义市医疗保障局', '遵义市财政局'],
      publishDate: '2023-11-20',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.zunyi.gov.cn/zwgk/zcfg/202311/t20231126_1289123.html',
  ...
  employee: {
    ...
    remoteMedical: {
      sourceDocId: 'zy-medical-insurance-policy-2023',
      filingChannels: ['国家医保服务平台APP', '贵州通', '遵义医保微信公众号'],
