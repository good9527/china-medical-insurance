...
export const qianxinanCityData: CityInsuranceData = {
  cityCode: '522300',
  cityName: '黔西南布依族苗族自治州',
  provinceCode: '520000',
  provinceName: '贵州省',
  hotline: '0859-12393',
  officialPortalUrl: 'http://ybj.qxn.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'qxn-employee-outpatient-2022',
      title: '黔西南州人民政府办公室关于印发黔西南州建立健全职工基本医疗保险门诊共济保障机制实施方案的通知',
      docNumber: '州府办发〔2022〕22号',
      issuingDept: ['黔西南布依族苗族自治州人民政府办公室', '黔西南州医疗保障局'],
      publishDate: '2022-12-16',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.qxn.gov.cn/zwgk/zcfg/202212/t20221221_1189234.html',
    ...
    {
      docId: 'qxn-medical-insurance-policy-2023',
      title: '黔西南州医疗保障局关于进一步完善基本医疗保险待遇政策的通知',
      docNumber: '州医保发〔2023〕19号',
      issuingDept: ['黔西南州医疗保障局', '黔西南州财政局'],
  ...
  employee: {
    outpatient: {
      sourceDocId: 'qxn-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'qxn-medical-insurance-policy-2023',
      annualCap: 500000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'qxn-medical-insurance-policy-2023',
      filingChannels: ['国家医保服务平台APP', '贵州通', '黔西南医保微信公众号'],
