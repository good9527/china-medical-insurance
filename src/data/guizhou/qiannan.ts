...
export const qiannanCityData: CityInsuranceData = {
  cityCode: '522700',
  cityName: '黔南布依族苗族自治州',
  provinceCode: '520000',
  provinceName: '贵州省',
  hotline: '0854-12393',
  officialPortalUrl: 'http://ybj.qiannan.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'qn-employee-outpatient-2022',
      title: '黔南州人民政府办公室关于印发黔南州建立健全职工基本医疗保险门诊共济保障机制实施方案的通知',
      docNumber: '黔南府办发〔2022〕21号',
      issuingDept: ['黔南布依族苗族自治州人民政府办公室', '黔南州医疗保障局'],
      publishDate: '2022-12-16',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.qiannan.gov.cn/zwgk/zcfg/202212/t20221221_1189234.html',
    ...
    {
      docId: 'qn-medical-insurance-policy-2023',
      title: '黔南州医疗保障局关于进一步完善基本医疗保险待遇政策的通知',
      docNumber: '黔南医保发〔2023〕18号',
      issuingDept: ['黔南州医疗保障局', '黔南州财政局'],
      publishDate: '2023-11-20',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.qiannan.gov.cn/zwgk/zcfg/202311/t20231126_1289123.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'qn-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'qn-medical-insurance-policy-2023',
      annualCap: 500000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'qn-medical-insurance-policy-2023',
      filingChannels: ['国家医保服务平台APP', '贵州通', '黔南医保微信公众号'],
