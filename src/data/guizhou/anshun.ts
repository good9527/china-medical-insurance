...
export const anshunCityData: CityInsuranceData = {
  cityCode: '520400',
  cityName: '安顺市',
  provinceCode: '520000',
  provinceName: '贵州省',
  hotline: '0851-12393',
  officialPortalUrl: 'http://ybj.anshun.gov.cn/',
  ...
  sourceDocs: [
    {
      ...
      title: '安顺市人民政府办公室关于印发安顺市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '安府办发〔2022〕18号',
      issuingDept: ['安顺市人民政府办公室', '安顺市医疗保障局'],
      publishDate: '2022-12-16',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.anshun.gov.cn/zwgk/zcfg/202212/t20221221_1189234.html',
    ...
    {
      docId: 'as-medical-insurance-policy-2023',
      title: '安顺市医疗保障局关于进一步完善基本医疗保险待遇政策的通知',
      docNumber: '安医保发〔2023〕15号',
      issuingDept: ['安顺市医疗保障局', '安顺市财政局'],
      publishDate: '2023-11-20',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.anshun.gov.cn/zwgk/zcfg/202311/t20231126_1289123.html',
  ...
  employee: {
    ...
    inpatient: {
      sourceDocId: 'as-medical-insurance-policy-2023',
      annualCap: 500000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'as-medical-insurance-policy-2023',
      filingChannels: ['国家医保服务平台APP', '贵州通', '安顺医保微信公众号'],
