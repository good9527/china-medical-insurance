...
export const qiandongnanCityData: CityInsuranceData = {
  cityCode: '522600',
  cityName: '黔东南苗族侗族自治州',
  provinceCode: '520000',
  provinceName: '贵州省',
  hotline: '0855-12393',
  officialPortalUrl: 'http://ybj.qdn.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'qdn-employee-outpatient-2022',
      title: '黔东南州人民政府办公室关于印发黔东南州建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '黔东南府办发〔2022〕20号',
      issuingDept: ['黔东南苗族侗族自治州人民政府办公室', '黔东南州医疗保障局'],
      publishDate: '2022-12-16',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.qdn.gov.cn/zwgk/zcfg/202212/t20221221_1189234.html',
    ...
    {
      docId: 'qdn-medical-insurance-policy-2023',
      title: '黔东南州医疗保障局关于进一步完善基本医疗保险待遇政策的通知',
      docNumber: '黔东南医保发〔2023〕17号',
      issuingDept: ['黔东南州医疗保障局', '黔东南州财政局'],
      publishDate: '2023-11-20',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.qdn.gov.cn/zwgk/zcfg/202311/t20231126_1289123.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'qdn-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'qdn-medical-insurance-policy-2023',
      annualCap: 500000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'qdn-medical-insurance-policy-2023',
      filingChannels: ['国家医保服务平台APP', '贵州通', '黔东南医保微信公众号'],
