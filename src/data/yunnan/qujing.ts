...
export const qujingCityData: CityInsuranceData = {
  cityCode: '530300',
  cityName: '曲靖市',
  provinceCode: '530000',
  provinceName: '云南省',
  hotline: '0874-12393',
  officialPortalUrl: 'http://ybj.qj.gov.cn/',
  ...
  sourceDocs: [
    {
      ...
      title: '曲靖市人民政府办公室关于印发曲靖市职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '曲政办规〔2022〕11号',
      issuingDept: ['曲靖市人民政府办公室', '曲靖市医疗保障局'],
      publishDate: '2022-12-15',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.qj.gov.cn/zwgk/zcfg/202212/t20221220_1189234.html',
      summaryQuote: '门诊起付标准一级20元、二级40元、三级60元。在职职工统筹支付比例一级60%、二级55%、三级50%，退休人员各提高10个百分点（分别为70%、65%、60%）。门诊统筹年度最高支付限额统一为6000元。'
    },
    {
      docId: 'qj-medical-insurance-policy-2023',
      title: '曲靖市医疗保障局关于进一步完善基本医疗保险待遇政策的通知',
      docNumber: '曲医保发〔2023〕18号',
      issuingDept: ['曲靖市医疗保障局', '曲靖市财政局'],
  ...
  employee: {
    ...
    inpatient: {
      sourceDocId: 'qj-medical-insurance-policy-2023',
      annualCap: 500000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'qj-medical-insurance-policy-2023',
      filingChannels: ['国家医保服务平台APP', '一部手机办事通', '曲靖医保微信公众号'],
