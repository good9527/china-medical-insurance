...
export const chuxiongCityData: CityInsuranceData = {
  cityCode: '532300',
  cityName: '楚雄彝族自治州',
  provinceCode: '530000',
  provinceName: '云南省',
  hotline: '0878-12393',
  officialPortalUrl: 'http://ybj.cxz.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'cx-employee-outpatient-2022',
      title: '楚雄州人民政府办公室关于印发楚雄州建立健全职工基本医疗保险门诊共济保障机制实施方案的通知',
      docNumber: '楚政办规〔2022〕11号',
      issuingDept: ['楚雄彝族自治州人民政府办公室', '楚雄州医疗保障局'],
      publishDate: '2022-12-15',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.cxz.gov.cn/zwgk/zcfg/202212/t20221220_1189234.html',
      summaryQuote: '门诊起付标准一级20元、二级40元、三级60元。在职职工统筹支付比例一级60%、二级55%、三级50%，退休人员各提高10个百分点（分别为70%、65%、60%）。门诊统筹年度最高支付限额统一为6000元。'
    },
    {
      docId: 'cx-medical-insurance-policy-2023',
      title: '楚雄州医疗保障局关于进一步完善基本医疗保险待遇政策的通知',
      docNumber: '楚医保发〔2023〕18号',
      issuingDept: ['楚雄州医疗保障局', '楚雄州财政局'],
      publishDate: '2023-11-20',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.cxz.gov.cn/zwgk/zcfg/202311/t20231126_1289123.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'cx-employee-outpatient-2022',
      annualDeductible: 60,
      annualCap: 6000,
    ...
    inpatient: {
      sourceDocId: 'cx-medical-insurance-policy-2023',
      annualCap: 500000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'cx-medical-insurance-policy-2023',
      filingChannels: ['国家医保服务平台APP', '一部手机办事通', '楚雄医保微信公众号'],
