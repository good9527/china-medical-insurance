...
export const diqingCityData: CityInsuranceData = {
  cityCode: '533400',
  cityName: '迪庆藏族自治州',
  provinceCode: '530000',
  provinceName: '云南省',
  hotline: '0887-12393',
  officialPortalUrl: 'http://ybj.diqing.gov.cn/',
  ...
  sourceDocs: [
    {
      ...
      title: '迪庆州人民政府办公室关于印发迪庆州职工基本医疗保险门诊共济保障机制实施方案的通知',
      docNumber: '迪政办规〔2022〕11号',
      issuingDept: ['迪庆藏族自治州人民政府办公室', '迪庆州医疗保障局'],
      publishDate: '2022-12-15',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.diqing.gov.cn/zwgk/zcfg/202212/t20221220_1189234.html',
    ...
    },
    {
      ...
      title: '迪庆州医疗保障局关于进一步完善基本医疗保险待遇政策的通知',
      docNumber: '迪医保发〔2023〕17号',
      issuingDept: ['迪庆州医疗保障局', '迪庆州财政局'],
      publishDate: '2023-11-20',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.diqing.gov.cn/zwgk/zcfg/202311/t20231126_1289123.html',
  ...
  employee: {
    ...
    remoteMedical: {
      sourceDocId: 'dq-medical-insurance-policy-2023',
      filingChannels: ['国家医保服务平台APP', '一部手机办事通', '迪庆医保微信公众号'],
