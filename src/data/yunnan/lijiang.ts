...
export const lijiangCityData: CityInsuranceData = {
  cityCode: '530700',
  cityName: '丽江市',
  provinceCode: '530000',
  provinceName: '云南省',
  hotline: '0888-12393',
  officialPortalUrl: 'http://ybj.lijiang.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'lj-employee-outpatient-2022',
      title: '丽江市人民政府办公室关于印发丽江市职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '丽政办规〔2022〕11号',
      issuingDept: ['丽江市人民政府办公室', '丽江市医疗保障局'],
      publishDate: '2022-12-15',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.lijiang.gov.cn/zwgk/zcfg/202212/t20221220_1189234.html',
      summaryQuote: '门诊起付标准一级20元、二级40元、三级60元。在职职工统筹支付比例一级60%、二级55%、三级50%，退休人员各提高10个百分点（分别为70%、65%、60%）。门诊统筹年度最高支付限额统一为6000元。'
    },
    {
      docId: 'lj-medical-insurance-policy-2023',
      title: '丽江市医疗保障局关于调整基本医疗保险待遇政策的通知',
      docNumber: '丽医保发〔2023〕17号',
      issuingDept: ['丽江市医疗保障局', '丽江市财政局'],
      publishDate: '2023-11-20',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.lijiang.gov.cn/zwgk/zcfg/202311/t20231126_1289123.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'lj-employee-outpatient-2022',
      annualDeductible: 60,
      annualCap: 6000,
    ...
    inpatient: {
      sourceDocId: 'lj-medical-insurance-policy-2023',
      annualCap: 500000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'lj-medical-insurance-policy-2023',
      filingChannels: ['国家医保服务平台APP', '一部手机办事通', '丽江医保微信公众号'],
