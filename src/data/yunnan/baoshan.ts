...
export const baoshanCityData: CityInsuranceData = {
  cityCode: '530500',
  cityName: '保山市',
  provinceCode: '530000',
  provinceName: '云南省',
  hotline: '0875-12393',
  officialPortalUrl: 'http://ybj.baoshan.gov.cn/',
  ...
  sourceDocs: [
    {
      ...
      title: '保山市人民政府办公室关于印发保山市建立健全职工基本医疗保险门诊共济保障机制实施方案的通知',
      docNumber: '保政办发〔2022〕20号',
      issuingDept: ['保山市人民政府办公室', '保山市医疗保障局'],
      publishDate: '2022-12-15',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.baoshan.gov.cn/zwgk/zcfg/202212/t20221220_1189234.html',
    ...
    },
    {
      ...
      title: '保山市医疗保障局关于调整基本医疗保险待遇政策的通知',
      docNumber: '保医保发〔2023〕18号',
      issuingDept: ['保山市医疗保障局', '保山市财政局'],
  ...
  employee: {
    ...
    remoteMedical: {
      sourceDocId: 'bs-medical-insurance-policy-2023',
      filingChannels: ['国家医保服务平台APP', '一部手机办事通', '保山医保微信公众号'],
