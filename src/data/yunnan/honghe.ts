...
export const hongheCityData: CityInsuranceData = {
  cityCode: '532500',
  cityName: '红河哈尼族彝族自治州',
  provinceCode: '530000',
  provinceName: '云南省',
  hotline: '0873-12393',
  officialPortalUrl: 'http://ybj.hh.gov.cn/',
  ...
  sourceDocs: [
    {
      ...
      title: '红河州人民政府办公室关于印发红河州职工基本医疗保险门诊共济保障机制实施方案的通知',
      docNumber: '红政办规〔2022〕13号',
      issuingDept: ['红河哈尼族彝族自治州人民政府办公室', '红河州医疗保障局'],
      publishDate: '2022-12-15',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.hh.gov.cn/zwgk/zcfg/202212/t20221220_1189234.html',
    ...
    },
    {
      ...
      title: '红河州医疗保障局关于调整基本医疗保险待遇政策的通知',
      docNumber: '红医保发〔2023〕18号',
      issuingDept: ['红河州医疗保障局', '红河州财政局'],
  ...
  employee: {
    ...
    remoteMedical: {
      sourceDocId: 'hh-medical-insurance-policy-2023',
      filingChannels: ['国家医保服务平台APP', '一部手机办事通', '红河医保微信公众号'],
