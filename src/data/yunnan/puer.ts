...
export const puerCityData: CityInsuranceData = {
  cityCode: '530800',
  cityName: '普洱市',
  provinceCode: '530000',
  provinceName: '云南省',
  hotline: '0879-12393',
  officialPortalUrl: 'http://ybj.puershi.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'pe-employee-outpatient-2022',
      title: '普洱市人民政府办公室关于印发普洱市职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '普政办规〔2022〕12号',
      issuingDept: ['普洱市人民政府办公室', '普洱市医疗保障局'],
      publishDate: '2022-12-15',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.puershi.gov.cn/zwgk/zcfg/202212/t20221220_1189234.html',
      summaryQuote: '门诊起付标准一级20元、二级40元、三级60元。在职职工统筹支付比例一级60%、二级55%、三级50%，退休人员各提高10个百分点（分别为70%、65%、60%）。门诊统筹年度最高支付限额统一为6000元。'
    },
    {
      docId: 'pe-medical-insurance-policy-2023',
      title: '普洱市医疗保障局关于调整基本医疗保险待遇政策的通知',
      docNumber: '普医保发〔2023〕18号',
      issuingDept: ['普洱市医疗保障局', '普洱市财政局'],
      publishDate: '2023-11-20',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.puershi.gov.cn/zwgk/zcfg/202311/t20231126_1289123.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'pe-employee-outpatient-2022',
      annualDeductible: 60,
      annualCap: 6000,
    ...
    inpatient: {
      sourceDocId: 'pe-medical-insurance-policy-2023',
      annualCap: 500000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'pe-medical-insurance-policy-2023',
      filingChannels: ['国家医保服务平台APP', '一部手机办事通', '普洱医保微信公众号'],
