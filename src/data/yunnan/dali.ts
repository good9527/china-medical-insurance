...
export const daliCityData: CityInsuranceData = {
  cityCode: '532900',
  cityName: '大理白族自治州',
  provinceCode: '530000',
  provinceName: '云南省',
  hotline: '0872-12393',
  officialPortalUrl: 'http://ybj.dali.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'dl-employee-outpatient-2022',
      title: '大理州人民政府办公室关于印发大理州建立健全职工基本医疗保险门诊共济保障机制实施方案的通知',
      docNumber: '大政办规〔2022〕12号',
      issuingDept: ['大理白族自治州人民政府办公室', '大理州医疗保障局'],
      publishDate: '2022-12-15',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.dali.gov.cn/zwgk/zcfg/202212/t20221220_1189234.html',
      summaryQuote: '门诊起付标准一级20元、二级40元、三级60元。在职职工统筹支付比例一级60%、二级55%、三级50%，退休人员各提高10个百分点（分别为70%、65%、60%）。门诊统筹年度最高支付限额统一为6000元。'
    },
    {
      docId: 'dl-medical-insurance-policy-2023',
      title: '大理州医疗保障局关于调整基本医疗保险待遇政策的通知',
      docNumber: '大医保发〔2023〕18号',
      issuingDept: ['大理州医疗保障局', '大理州财政局'],
      publishDate: '2023-11-20',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.dali.gov.cn/zwgk/zcfg/202311/t20231126_1289123.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'dl-employee-outpatient-2022',
      annualDeductible: 60,
      annualCap: 6000,
    ...
    inpatient: {
      sourceDocId: 'dl-medical-insurance-policy-2023',
      annualCap: 500000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'dl-medical-insurance-policy-2023',
      filingChannels: ['国家医保服务平台APP', '一部手机办事通', '大理医保微信公众号'],
