...
export const gannanData: CityInsuranceData = {
  cityCode: '623000',
  cityName: '甘南藏族自治州',
  provinceCode: '620000',
  provinceName: '甘肃省',
  hotline: '0941-12393',
  officialPortalUrl: 'http://ybj.gnz.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'gn-employee-outpatient-2022',
      title: '甘南州职工基本医疗保险门诊共济保障实施细则',
      docNumber: '州政办发〔2022〕72号',
      issuingDept: ['甘南藏族自治州人民政府办公室', '甘南藏族自治州医疗保障局'],
      publishDate: '2022-08-22',
      effectiveDate: '2022-09-01',
      status: 'active',
      officialUrl: 'http://ybj.gnz.gov.cn/art/2022/08/28/art_11221_1189912.html',
      summaryQuote: '门诊年度起付标准为200元，统筹基金最高支付限额2500元。一级医疗机构在职报销65%、退休70%；二级医疗机构在职报销60%、退休65%；三级医疗机构在职报销55%、退休60%。'
    },
    {
      docId: 'gn-medical-insurance-inpatient-2024',
      title: '甘南州基本医疗保险综合保障政策管理方案',
      docNumber: '州医保字〔2024〕38号',
      issuingDept: ['甘南藏族自治州医疗保障局', '甘南藏族自治州财政局'],
      publishDate: '2024-11-25',
      effectiveDate: '2025-01-01',
      status: 'active',
      officialUrl: 'http://ybj.gnz.gov.cn/art/2024/11/30/art_11221_1345672.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'gn-employee-outpatient-2022',
      ...
      note: '门诊年度起付标准200元，限额2500元，退休人员报销比例各提高5个百分点。'
    },
    inpatient: {
      sourceDocId: 'gn-medical-insurance-inpatient-2024',
      annualCap: 500000,
      tierBenefits: {
