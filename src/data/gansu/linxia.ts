...
export const linxiaData: CityInsuranceData = {
  cityCode: '622900',
  cityName: '临夏回族自治州',
  provinceCode: '620000',
  provinceName: '甘肃省',
  hotline: '0930-12393',
  officialPortalUrl: 'http://ybj.linxia.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'lx-employee-outpatient-2022',
      title: '临夏州职工基本医疗保险门诊共济保障机制实施细则',
      docNumber: '临州政办发〔2022〕138号',
      issuingDept: ['临夏回族自治州人民政府办公室', '临夏回族自治州医疗保障局'],
      publishDate: '2022-12-30',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.linxia.gov.cn/art/2022/12/31/art_11221_1189912.html',
      summaryQuote: '门诊年度起付标准为200元，统筹基金最高支付限额2500元。一级医疗机构在职报销65%、退休70%；二级医疗机构在职报销60%、退休65%；三级医疗机构在职报销55%、退休60%。'
    },
    {
      docId: 'lx-medical-insurance-inpatient-2024',
      title: '临夏州基本医疗保险待遇保障实施办法及经办服务规程',
      docNumber: '临州医保发〔2024〕35号',
      issuingDept: ['临夏回族自治州医疗保障局', '临夏回族自治州财政局'],
      publishDate: '2024-11-25',
      effectiveDate: '2025-01-01',
      status: 'active',
      officialUrl: 'http://ybj.linxia.gov.cn/art/2024/11/30/art_11221_1345672.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'lx-employee-outpatient-2022',
      ...
      note: '门诊年度起付标准200元，统筹基金最高支付限额2500元，退休人员报销比例各提高5个百分点。'
    },
    inpatient: {
      sourceDocId: 'lx-medical-insurance-inpatient-2024',
      annualCap: 500000,
      tierBenefits: {
