...
export const qingyangData: CityInsuranceData = {
  cityCode: '621000',
  cityName: '庆阳市',
  provinceCode: '620000',
  provinceName: '甘肃省',
  hotline: '0934-12393',
  officialPortalUrl: 'http://ybj.zgqingyang.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'qy-employee-outpatient-2022',
      title: '庆阳市职工基本医疗保险门诊共济保障实施细则',
      docNumber: '庆政办发〔2022〕115号',
      issuingDept: ['庆阳市人民政府办公室', '庆阳市医疗保障局'],
      publishDate: '2022-12-10',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.zgqingyang.gov.cn/art/2022/12/15/art_11221_1189912.html',
    ...
    },
    {
      ...
      title: '庆阳市基本医疗保险综合保障政策管理方案',
      docNumber: '庆医保发〔2024〕34号',
      issuingDept: ['庆阳市医疗保障局', '庆阳市财政局'],
      publishDate: '2024-11-20',
      effectiveDate: '2025-01-01',
      status: 'active',
      officialUrl: 'http://ybj.zgqingyang.gov.cn/art/2024/11/25/art_11221_1345672.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'qy-employee-outpatient-2022',
