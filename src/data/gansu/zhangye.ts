...
export const zhangyeData: CityInsuranceData = {
  cityCode: '620700',
  cityName: '张掖市',
  provinceCode: '620000',
  provinceName: '甘肃省',
  hotline: '0936-12393',
  officialPortalUrl: 'http://ybj.zhangye.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'zy-employee-outpatient-2022',
      title: '张掖市职工基本医疗保险门诊共济保障实施细则',
      docNumber: '张政办发〔2022〕118号',
      issuingDept: ['张掖市人民政府办公室', '张掖市医疗保障局'],
      publishDate: '2022-11-20',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.zhangye.gov.cn/art/2022/11/25/art_11221_1189912.html',
      summaryQuote: '门诊年度起付标准为200元，统筹基金最高支付限额2500元。一级医疗机构在职报销65%、退休70%；二级医疗机构在职报销60%、退休65%；三级医疗机构在职报销55%、退休60%。'
    },
    {
      docId: 'zy-medical-insurance-inpatient-2024',
      title: '张掖市基本医疗保险综合保障管理办法与经办细则',
      docNumber: '张医保发〔2024〕32号',
      issuingDept: ['张掖市医疗保障局', '张掖市财政局'],
      publishDate: '2024-11-20',
      effectiveDate: '2025-01-01',
      status: 'active',
      officialUrl: 'http://ybj.zhangye.gov.cn/art/2024/11/28/art_11221_1345672.html',
      summaryQuote: '职工住院起付线：三级800元、二级450元、一级200元；在职支付比例三级85%、二级89%、一级92%（退休人员各提高3%）。居民住院起付线：三级900元、二级450元、一级200元，报销比例分别为65%、76%、85%。居民基层门诊免起付线，报销60%，年限额150元。'
    }
  ],
  ...
  employee: {
    outpatient: {
      sourceDocId: 'zy-employee-outpatient-2022',
      ...
      note: '门诊统筹年度起付标准200元，限额2500元，退休人员比例各提高5个百分点。'
    },
    inpatient: {
      sourceDocId: 'zy-medical-insurance-inpatient-2024',
      annualCap: 500000,
      tierBenefits: {
  ...
  resident: {
    ...
    inpatient: {
      ...
      tierBenefits: {
        ...
        tier3: { tierName: '三级定点医疗机构', deductible: 1500, reimbursementRatio: 0.70 },
        tier3_top: { tierName: '三级甲等综合医院', deductible: 1500, reimbursementRatio: 0.70 }
      }
    },
    catastrophic: {
      sourceDocId: 'zy-medical-insurance-inpatient-2024',
