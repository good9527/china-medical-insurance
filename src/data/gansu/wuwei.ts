...
export const wuweiData: CityInsuranceData = {
  cityCode: '620600',
  cityName: '武威市',
  provinceCode: '620000',
  provinceName: '甘肃省',
  hotline: '0935-12393',
  officialPortalUrl: 'http://ybj.gswuwei.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'ww-employee-outpatient-2022',
      title: '武威市职工基本医疗保险门诊共济保障实施细则',
      docNumber: '武政办发〔2022〕82号',
      issuingDept: ['武威市人民政府办公室', '武威市医疗保障局'],
      publishDate: '2022-12-10',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.gswuwei.gov.cn/art/2022/12/15/art_11221_1189912.html',
      summaryQuote: '门诊年度起付标准为200元，最高支付限额2500元。一级定点医疗机构在职报销70%、退休75%；二级定点医疗机构在职报销65%、退休70%；三级定点医疗机构在职报销60%、退休65%。'
    },
    {
      docId: 'ww-medical-insurance-inpatient-2024',
      title: '武威市基本医疗保险综合保障政策实施方案',
      docNumber: '武医保发〔2024〕35号',
      issuingDept: ['武威市医疗保障局', '武威市财政局'],
      publishDate: '2024-11-25',
      effectiveDate: '2025-01-01',
      status: 'active',
      officialUrl: 'http://ybj.gswuwei.gov.cn/art/2024/11/30/art_11221_1345672.html',
      summaryQuote: '职工住院起付线：三级800元、二级500元、一级200元；在职支付比例三级85%、二级88%、一级92%（退休人员各提高3%）。居民住院起付线：三级1000元、二级500元、一级200元，报销比例分别为65%、75%、85%。居民基层门诊免起付线，报销60%，年限额150元。'
    }
  ],
  ...
  employee: {
    outpatient: {
      sourceDocId: 'ww-employee-outpatient-2022',
      annualDeductible: 200,
      annualCap: 2500,
      annualCapRetiree: 2500,
      tierBenefits: {
        community: { tierName: '一级定点医疗机构/乡镇社区', deductible: 200, reimbursementRatio: 0.70, retireeRatioBonus: 0.05 },
        ...
        tier3_top: { tierName: '三级甲等综合医院', deductible: 200, reimbursementRatio: 0.60, retireeRatioBonus: 0.05 }
      },
      note: '门诊年度起付标准200元，限额2500元，在职人员一级70%、二级65%、三级60%，退休人员各提高5个百分点。'
    },
    inpatient: {
      sourceDocId: 'ww-medical-insurance-inpatient-2024',
      annualCap: 500000,
      tierBenefits: {
  ...
  resident: {
    outpatient: {
      ...
      note: '居民基层普通门诊免起付线，报销比例60%，年度最高支付限额150元。'
    },
    inpatient: {
      sourceDocId: 'ww-medical-insurance-inpatient-2024',
      annualCap: 150000,
      tierBenefits: {
        ...
        tier3_top: { tierName: '三级甲等综合医院', deductible: 1000, reimbursementRatio: 0.65 }
      }
    },
    catastrophic: {
      sourceDocId: 'ww-medical-insurance-inpatient-2024',
