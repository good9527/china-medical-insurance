...
export const pingliangData: CityInsuranceData = {
  cityCode: '620800',
  cityName: '平凉市',
  provinceCode: '620000',
  provinceName: '甘肃省',
  hotline: '0933-12393',
  officialPortalUrl: 'http://ybj.pingliang.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'pl-employee-outpatient-2022',
      title: '平凉市职工基本医疗保险门诊共济保障实施细则',
      docNumber: '平政办发〔2022〕126号',
      issuingDept: ['平凉市人民政府办公室', '平凉市医疗保障局'],
      publishDate: '2022-12-15',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.pingliang.gov.cn/art/2022/12/20/art_11221_1189912.html',
      summaryQuote: '门诊年度起付标准为200元，统筹基金最高支付限额2500元。一级医疗机构在职报销65%、退休70%；二级医疗机构在职报销60%、退休65%；三级医疗机构在职报销55%、退休60%。'
    },
    {
      docId: 'pl-medical-insurance-inpatient-2024',
      title: '平凉市基本医疗保险综合保障政策管理规程',
      docNumber: '平医保发〔2024〕30号',
      issuingDept: ['平凉市医疗保障局', '平凉市财政局'],
      publishDate: '2024-11-20',
      effectiveDate: '2025-01-01',
      status: 'active',
      officialUrl: 'http://ybj.pingliang.gov.cn/art/2024/11/26/art_11221_1345672.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'pl-employee-outpatient-2022',
      ...
      note: '门诊年度起付标准200元，最高支付限额2500元，退休人员报销比例各提高5个百分点。'
    },
    inpatient: {
      sourceDocId: 'pl-medical-insurance-inpatient-2024',
      annualCap: 500000,
      tierBenefits: {
