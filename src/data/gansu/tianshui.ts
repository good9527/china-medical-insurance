...
export const tianshuiData: CityInsuranceData = {
  cityCode: '620500',
  cityName: '天水市',
  provinceCode: '620000',
  provinceName: '甘肃省',
  hotline: '0938-12393',
  officialPortalUrl: 'http://ybj.tianshui.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'ts-employee-outpatient-2022',
      title: '天水市职工基本医疗保险门诊共济保障实施细则',
      docNumber: '天政办规〔2022〕11号',
      issuingDept: ['天水市人民政府办公室', '天水市医疗保障局'],
      publishDate: '2022-12-20',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.tianshui.gov.cn/art/2022/12/28/art_11221_1189912.html',
      summaryQuote: '门诊统筹年度累计起付标准为200元，年度最高支付限额2500元。一级医疗机构在职报销65%、退休70%；二级医疗机构在职报销60%、退休65%；三级医疗机构在职报销55%、退休60%。'
    },
    {
      docId: 'ts-medical-insurance-inpatient-2024',
      title: '天水市基本医疗保险待遇保障实施办法及经办管理规程',
      docNumber: '天医保发〔2024〕28号',
      issuingDept: ['天水市医疗保障局', '天水市财政局'],
      publishDate: '2024-11-25',
      effectiveDate: '2025-01-01',
      status: 'active',
      officialUrl: 'http://ybj.tianshui.gov.cn/art/2024/11/30/art_11221_1345672.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'ts-employee-outpatient-2022',
      ...
      note: '年度起付标准200元，在职人员一级/二级/三级报销65%/60%/55%，退休人员相应提高5个百分点，年度限额2500元。'
    },
    inpatient: {
      sourceDocId: 'ts-medical-insurance-inpatient-2024',
      annualCap: 500000, // 基本医保统筹限额 50 万元
      tierBenefits: {
        community: { tierName: '一级机构/社区服务中心', deductible: 200, reimbursementRatio: 0.92, retireeRatioBonus: 0.03 },
  ...
  resident: {
    outpatient: {
      sourceDocId: 'ts-medical-insurance-inpatient-2024',
      annualCap: 150, // 居民门诊统筹年度支付限额 150 元
      tierBenefits: {
      ...
      note: '居民普通门诊基层免起付线，报销比例60%，每人每年年度支付限额150元。'
    },
    inpatient: {
      sourceDocId: 'ts-medical-insurance-inpatient-2024',
    ...
    remoteMedical: {
      ...
      specialNotes: [
        '规范备案直接结算享受对应比例，未备案自行外出就医报销比例降低。'
      ]
    }
  }
};
