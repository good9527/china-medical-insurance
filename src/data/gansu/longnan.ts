...
export const longnanData: CityInsuranceData = {
  cityCode: '621200',
  cityName: '陇南市',
  provinceCode: '620000',
  provinceName: '甘肃省',
  hotline: '0939-12393',
  officialPortalUrl: 'http://ybj.longnan.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'ln-employee-outpatient-2022',
      title: '陇南市职工基本医疗保险门诊共济保障实施细则',
      docNumber: '陇政办发〔2022〕119号',
      issuingDept: ['陇南市人民政府办公室', '陇南市医疗保障局'],
      publishDate: '2022-12-15',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.longnan.gov.cn/art/2022/12/20/art_11221_1189912.html',
      summaryQuote: '门诊年度起付标准为200元，统筹基金最高支付限额2500元。一级医疗机构在职报销65%、退休70%；二级医疗机构在职报销60%、退休65%；三级医疗机构在职报销55%、退休60%。'
    },
    {
      docId: 'ln-medical-insurance-inpatient-2024',
      title: '陇南市基本医疗保险综合保障管理实施办法',
      docNumber: '陇医保发〔2024〕36号',
      issuingDept: ['陇南市医疗保障局', '陇南市财政局'],
      publishDate: '2024-11-20',
      effectiveDate: '2025-01-01',
      status: 'active',
      officialUrl: 'http://ybj.longnan.gov.cn/art/2024/11/25/art_11221_1345672.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'ln-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'ln-medical-insurance-inpatient-2024',
      annualCap: 500000,
      tierBenefits: {
