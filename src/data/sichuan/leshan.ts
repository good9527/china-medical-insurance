...
export const leshanCityData: CityInsuranceData = {
  cityCode: '511100',
  cityName: '乐山市',
  provinceCode: '510000',
  provinceName: '四川省',
  hotline: '0833-12393',
  officialPortalUrl: 'http://ybj.leshan.gov.cn/',
  lastUpdated: '2026-03-01',

  sourceDocs: [
    {
      docId: 'ls-employee-outpatient-2022-48',
      title: '乐山市人民政府办公室关于印发乐山市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '乐府办发〔2022〕48号',
      issuingDept: ['乐山市人民政府办公室', '乐山市医疗保障局'],
      publishDate: '2022-12-16',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.leshan.gov.cn/zwgk/zcfg/202212/t20221221_210982.shtml',
    ...
    },
    {
      ...
      title: '乐山市医疗保障局关于印发乐山市基本医疗保险统筹基金支付管理细则的通知',
      docNumber: '乐医保规〔2024〕1号',
      issuingDept: ['乐山市医疗保障局', '乐山市财政局'],
      publishDate: '2024-05-15',
      effectiveDate: '2024-07-01',
      status: 'active',
      officialUrl: 'http://ybj.leshan.gov.cn/zwgk/zcfg/202405/t20240520_231908.shtml',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'ls-employee-outpatient-2022-48',
  ...
  resident: {
    ...
    inpatient: {
      ...
      annualCap: 220000,
      tierBenefits: {
        community: { tierName: '社区/乡镇卫生院', deductible: 100, reimbursementRatio: 0.90 },
        tier1: { tierName: '一级定点医疗机构', deductible: 200, reimbursementRatio: 0.82 },
        tier2: { tierName: '二级定点医疗机构', deductible: 550, reimbursementRatio: 0.80 },
        tier3: { tierName: '三级定点医疗机构', deductible: 850, reimbursementRatio: 0.70 },
        tier3_top: { tierName: '市级重点三甲医院', deductible: 850, reimbursementRatio: 0.70 }
      },
      repeatedDeductibleRule: '参保人员自然年度内多次住院的，从第二次住院起，起付标准降低50%。'
    },
    catastrophic: {
