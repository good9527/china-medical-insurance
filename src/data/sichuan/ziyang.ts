...
export const ziyangCityData: CityInsuranceData = {
  cityCode: '512000',
  cityName: '资阳市',
  provinceCode: '510000',
  provinceName: '四川省',
  hotline: '028-12393',
  officialPortalUrl: 'http://ybj.ziyang.gov.cn/',
  lastUpdated: '2026-03-01',

  sourceDocs: [
    {
      docId: 'zy-employee-outpatient-2022-02',
      title: '资阳市人民政府办公室关于印发资阳市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '资府办规〔2022〕2号',
      issuingDept: ['资阳市人民政府办公室', '资阳市医疗保障局'],
      publishDate: '2022-12-18',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.ziyang.gov.cn/zwgk/zcfg/202212/t20221222_208392.shtml',
      summaryQuote: '职工普通门诊统筹按自然年度设一次起付标准：在职职工200元、退休人员150元；支付比例二级及以下60%（退休70%），三级50%（退休60%）；年度支付限额在职2000元、退休2500元。'
    },
    {
      docId: 'zy-medical-insurance-inpatient-2023',
      title: '资阳市医疗保障局关于印发资阳市基本医疗保险统筹支付管理细则的通知',
      docNumber: '资医保发〔2023〕25号',
      issuingDept: ['资阳市医疗保障局', '资阳市财政局'],
      publishDate: '2023-10-20',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.ziyang.gov.cn/zwgk/zcfg/202310/t20231025_229108.shtml',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'zy-employee-outpatient-2022-02',
    ...
    inpatient: {
      sourceDocId: 'zy-medical-insurance-inpatient-2023',
      annualCap: 500000,
      tierBenefits: {
  ...
  resident: {
    ...
    inpatient: {
      ...
      annualCap: 220000,
      tierBenefits: {
        community: { tierName: '基层乡镇卫生院及社区', deductible: 150, reimbursementRatio: 0.85 },
