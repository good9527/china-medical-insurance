...
export const yibinCityData: CityInsuranceData = {
  cityCode: '511500',
  cityName: '宜宾市',
  provinceCode: '510000',
  provinceName: '四川省',
  hotline: '0831-12393',
  officialPortalUrl: 'http://ybj.yibin.gov.cn/',
  lastUpdated: '2026-03-01',

  sourceDocs: [
    {
      docId: 'yb-employee-outpatient-2022-31',
      title: '宜宾市人民政府办公室关于印发宜宾市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '宜办发〔2022〕42号',
      issuingDept: ['宜宾市人民政府办公室', '宜宾市医疗保障局'],
      publishDate: '2022-12-18',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.yibin.gov.cn/zwgk/zcfg/202212/t20221222_210984.shtml',
      summaryQuote: '职工普通门诊按自然年度设一次起付线：在职200元、退休150元；报销比例二级及以下60%（退休70%），三级定点医疗机构50%（退休60%）；年度支付限额在职2000元，退休2500元。'
    },
    {
      docId: 'yb-medical-insurance-inpatient-2024',
      title: '宜宾市基本医疗保险住院与大病保险管理细则',
      docNumber: '宜医保规〔2024〕1号',
      issuingDept: ['宜宾市医疗保障局', '宜宾市财政局'],
      publishDate: '2024-06-22',
      effectiveDate: '2024-07-01',
      status: 'active',
      officialUrl: 'http://ybj.yibin.gov.cn/zwgk/zcfg/202406/t20240626_231908.shtml',
  ...
  employee: {
    ...
    inpatient: {
      sourceDocId: 'yb-medical-insurance-inpatient-2024',
      annualCap: 500000,
      tierBenefits: {
  ...
  resident: {
    ...
    inpatient: {
      ...
      tierBenefits: {
        ...
        tier2: { tierName: '二级定点医疗机构', deductible: 200, reimbursementRatio: 0.78 },
