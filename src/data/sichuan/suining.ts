...
export const suiningCityData: CityInsuranceData = {
  cityCode: '510900',
  cityName: '遂宁市',
  provinceCode: '510000',
  provinceName: '四川省',
  hotline: '0825-12393',
  officialPortalUrl: 'http://ybj.suining.gov.cn/',
  lastUpdated: '2026-03-01',

  sourceDocs: [
    {
      docId: 'sn-employee-outpatient-2022-03',
      title: '遂宁市人民政府办公室关于印发遂宁市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '遂府办规〔2022〕3号',
      issuingDept: ['遂宁市人民政府办公室', '遂宁市医疗保障局'],
      publishDate: '2022-12-19',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.suining.gov.cn/zwgk/zcfg/202212/t20221223_208392.shtml',
      summaryQuote: '职工普通门诊统筹按自然年度设一次起付标准：在职职工200元、退休人员150元；支付比例二级及以下60%（退休70%），三级50%（退休60%）；年度支付限额在职2000元、退休2500元。'
    },
    {
      docId: 'sn-medical-insurance-inpatient-2024',
      title: '遂宁市医疗保障局关于印发遂宁市基本医疗保险和大额医疗费互助管理办法的通知',
      docNumber: '遂医保发〔2024〕12号',
      issuingDept: ['遂宁市医疗保障局', '遂宁市财政局'],
  ...
  resident: {
    ...
    inpatient: {
      ...
      tierBenefits: {
        ...
        tier3_top: { tierName: '市级重点三甲医院', deductible: 800, reimbursementRatio: 0.55 }
      },
      repeatedDeductibleRule: '参保人员自然年度内多次住院的，从第二次住院起，起付标准降低50%。'
    },
    catastrophic: {
