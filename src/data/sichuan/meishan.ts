...
export const meishanCityData: CityInsuranceData = {
  cityCode: '511400',
  cityName: '眉山市',
  provinceCode: '510000',
  provinceName: '四川省',
  hotline: '028-12393',
  officialPortalUrl: 'http://ybj.ms.gov.cn/',
  lastUpdated: '2026-03-01',

  sourceDocs: [
    {
      docId: 'ms-employee-outpatient-2022-39',
      title: '眉山市人民政府办公室关于印发眉山市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '眉府办发〔2022〕39号',
      issuingDept: ['眉山市人民政府办公室', '眉山市医疗保障局'],
      publishDate: '2022-12-15',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.ms.gov.cn/zwgk/zcfg/202212/t20221220_209183.shtml',
      summaryQuote: '职工普通门诊统筹按自然年度设一次起付标准：在职职工200元、退休人员150元；支付比例二级及以下60%（退休70%），三级50%（退休60%）；年度支付限额在职2000元、退休2500元。'
    },
    {
      docId: 'ms-medical-insurance-inpatient-2023',
      title: '眉山市医疗保障局关于印发眉山市基本医疗保险待遇保障办法的通知',
      docNumber: '眉医保发〔2023〕18号',
      issuingDept: ['眉山市医疗保障局', '眉山市财政局'],
      publishDate: '2023-08-20',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.ms.gov.cn/zwgk/zcfg/202308/t20230825_221094.shtml',
