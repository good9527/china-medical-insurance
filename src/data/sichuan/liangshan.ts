...
export const liangshanCityData: CityInsuranceData = {
  cityCode: '513400',
  cityName: '凉山彝族自治州',
  provinceCode: '510000',
  provinceName: '四川省',
  hotline: '0834-12393',
  officialPortalUrl: 'http://ybj.lsz.gov.cn/',
  lastUpdated: '2026-03-01',

  sourceDocs: [
    {
      docId: 'lsz-employee-outpatient-2022-50',
      title: '凉山州人民政府办公室关于印发凉山州建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '凉府办发〔2022〕50号',
      issuingDept: ['凉山州人民政府办公室', '凉山州医疗保障局'],
      publishDate: '2022-12-22',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.lsz.gov.cn/zwgk/zcfg/202212/t20221226_218908.shtml',
      summaryQuote: '职工普通门诊统筹按自然年度设一次起付标准：在职职工200元、退休人员150元；支付比例二级及以下60%（退休70%），三级50%（退休60%）；年度支付限额在职2000元、退休2500元。'
    },
    {
      docId: 'lsz-medical-insurance-inpatient-2023',
      title: '凉山州医疗保障局关于印发凉山州基本医疗保险住院与大病保险保障细则的通知',
      docNumber: '凉医保发〔2023〕36号',
      issuingDept: ['凉山州医疗保障局', '凉山州财政局'],
  ...
  employee: {
    outpatient: {
      sourceDocId: 'lsz-employee-outpatient-2022-50',
    ...
    inpatient: {
      sourceDocId: 'lsz-medical-insurance-inpatient-2023',
      annualCap: 500000,
      tierBenefits: {
  ...
  resident: {
    ...
    inpatient: {
      ...
      tierBenefits: {
        ...
        tier3_top: { tierName: '州级重点三甲医院', deductible: 550, reimbursementRatio: 0.68 }
      },
      repeatedDeductibleRule: '参保人员自然年度内多次住院的，从第二次住院起，起付标准降低50%。'
    },
    catastrophic: {
      ...
      annualCap: 300000,
      tiers: [
        { minAmount: 11500, maxAmount: 30000, ratio: 0.60 },
