...
export const zigongCityData: CityInsuranceData = {
  cityCode: '510300',
  cityName: '自贡市',
  provinceCode: '510000',
  provinceName: '四川省',
  hotline: '0813-12393',
  officialPortalUrl: 'http://ybj.zg.gov.cn/',
  lastUpdated: '2026-03-01',

  sourceDocs: [
    {
      docId: 'zg-employee-outpatient-2022-53',
      title: '自贡市人民政府办公室关于印发自贡市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '自府办发〔2022〕53号',
      issuingDept: ['自贡市人民政府办公室', '自贡市医疗保障局'],
      publishDate: '2022-12-16',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.zg.gov.cn/zwgk/zcfg/202212/t20221220_182930.shtml',
      summaryQuote: '普通门诊统筹按自然年度设一次起付标准：在职职工200元、退休人员150元；支付比例二级及以下60%（退休70%），三级50%（退休60%）；年度支付限额在职2000元、退休2500元。'
    },
    {
      docId: 'zg-medical-insurance-inpatient-2023',
      title: '自贡市医疗保障局关于印发自贡市基本医疗保险住院与门诊特殊疾病保障办法的通知',
      docNumber: '自医保规〔2023〕1号',
      issuingDept: ['自贡市医疗保障局', '自贡市财政局'],
      publishDate: '2023-10-15',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.zg.gov.cn/zwgk/zcfg/202310/t20231020_193822.shtml',
      summaryQuote: '职工住院起付线：一级200元、二级450元、三级800元；在职支付比例一级92%、二级88%、三级84%（退休人员各项提高3%）。居民住院起付线一级100元、二级300元、三级650元，支付比例一级85%、二级76%、三级65%。大病保险起付线13000元，支付比例60%-75%。'
    }
  ],

  employee: {
    outpatient: {
      sourceDocId: 'zg-employee-outpatient-2022-53',
    ...
    inpatient: {
      sourceDocId: 'zg-medical-insurance-inpatient-2023',
      annualCap: 500000,
      tierBenefits: {
  ...
  resident: {
    ...
    inpatient: {
      ...
      tierBenefits: {
        ...
        tier2: { tierName: '二级定点医疗机构', deductible: 300, reimbursementRatio: 0.76 },
        tier3: { tierName: '三级定点医疗机构', deductible: 650, reimbursementRatio: 0.65 },
        tier3_top: { tierName: '重点三甲综合医院', deductible: 650, reimbursementRatio: 0.65 }
      },
      repeatedDeductibleRule: '参保人员自然年度内多次住院的，从第二次住院起，起付标准降低50%。'
    },
    catastrophic: {
