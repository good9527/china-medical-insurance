...
export const panzhihuaCityData: CityInsuranceData = {
  cityCode: '510400',
  cityName: '攀枝花市',
  provinceCode: '510000',
  provinceName: '四川省',
  hotline: '0812-12393',
  officialPortalUrl: 'http://ybj.panzhihua.gov.cn/',
  lastUpdated: '2026-03-01',

  sourceDocs: [
    {
      docId: 'pzh-employee-outpatient-2022-46',
      title: '攀枝花市人民政府办公室关于印发攀枝花市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '攀办发〔2022〕46号',
      issuingDept: ['攀枝花市人民政府办公室', '攀枝花市医疗保障局'],
      publishDate: '2022-12-18',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.panzhihua.gov.cn/zwgk/zcfg/202212/t20221222_198234.shtml',
      summaryQuote: '职工普通门诊统筹按自然年度设一次起付标准：在职职工200元、退休人员150元；支付比例二级及以下60%（退休70%），三级50%（退休60%）；年度支付限额在职2000元、退休2500元。'
    },
    {
      docId: 'pzh-medical-insurance-inpatient-2024',
      title: '攀枝花市医疗保障局关于印发攀枝花市基本医疗保险和大病保险管理办法的通知',
      docNumber: '攀医保规〔2024〕2号',
      issuingDept: ['攀枝花市医疗保障局', '攀枝花市财政局'],
      publishDate: '2024-05-20',
      effectiveDate: '2024-07-01',
      status: 'active',
      officialUrl: 'http://ybj.panzhihua.gov.cn/zwgk/zcfg/202405/t20240525_221876.shtml',
      summaryQuote: '职工住院起付线：一级200元、二级400元、三级700元；在职支付比例一级92%、二级88%、三级85%（退休人员各项提高3%）。居民住院起付线一级100元、二级250元、三级600元，支付比例一级85%、二级78%、三级65%。大病保险起付线13500元，支付比例60%-75%。'
    }
  ],

  employee: {
    outpatient: {
      sourceDocId: 'pzh-employee-outpatient-2022-46',
    ...
    inpatient: {
      sourceDocId: 'pzh-medical-insurance-inpatient-2024',
      annualCap: 500000,
      tierBenefits: {
  ...
  resident: {
    ...
    inpatient: {
      ...
      annualCap: 250000,
      tierBenefits: {
        community: { tierName: '基层及乡镇卫生院', deductible: 100, reimbursementRatio: 0.95 },
        ...
        tier3: { tierName: '三级定点医疗机构', deductible: 400, reimbursementRatio: 0.70 },
        tier3_top: { tierName: '市级重点三甲医院', deductible: 400, reimbursementRatio: 0.70 }
      },
      repeatedDeductibleRule: '参保人员自然年度内多次住院的，从第二次住院起，起付标准降低50%。'
    },
    catastrophic: {
