...
export const garzeCityData: CityInsuranceData = {
  cityCode: '513300',
  cityName: '甘孜藏族自治州',
  provinceCode: '510000',
  provinceName: '四川省',
  hotline: '0836-12393',
  officialPortalUrl: 'http://ybj.gzz.gov.cn/',
  lastUpdated: '2026-03-01',

  sourceDocs: [
    {
      docId: 'gz-employee-outpatient-2022-37',
      title: '甘孜州人民政府办公室关于印发甘孜州建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '甘办发〔2022〕37号',
      issuingDept: ['甘孜州人民政府办公室', '甘孜州医疗保障局'],
      publishDate: '2022-12-21',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.gzz.gov.cn/zwgk/zcfg/202212/t20221225_219082.shtml',
      summaryQuote: '职工普通门诊统筹按自然年度设一次起付标准：在职职工200元、退休人员150元；支付比例二级及以下60%（退休70%），三级50%（退休60%）；年度支付限额在职2000元、退休2500元。'
    },
    {
      docId: 'gz-medical-insurance-inpatient-2024',
      title: '甘孜州医疗保障局关于印发甘孜州基本医疗保险统筹基金待遇保障细则的通知',
      docNumber: '甘医保规〔2024〕1号',
      issuingDept: ['甘孜州医疗保障局', '甘孜州财政局'],
      publishDate: '2024-03-18',
      effectiveDate: '2024-05-01',
      status: 'active',
      officialUrl: 'http://ybj.gzz.gov.cn/zwgk/zcfg/202403/t20240322_231908.shtml',
      summaryQuote: '职工住院起付线：一级200元、二级400元、三级700元；在职支付比例一级92%、二级88%、三级85%（退休人员各项提高3%）。居民住院起付线一级100元、二级250元、三级550元，支付比例一级88%、二级80%、三级68%（高寒藏区倾斜支持）。大病保险起付线11000元，支付比例60%-75%。'
    }
  ],
  ...
  employee: {
    ...
    inpatient: {
      sourceDocId: 'gz-medical-insurance-inpatient-2024',
      annualCap: 500000,
      tierBenefits: {
        ...
        tier3_top: { tierName: '重点三甲综合医院', deductible: 700, reimbursementRatio: 0.85, retireeRatioBonus: 0.03 }
      },
