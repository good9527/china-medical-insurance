...
export const yaanCityData: CityInsuranceData = {
  cityCode: '511800',
  cityName: '雅安市',
  provinceCode: '510000',
  provinceName: '四川省',
  hotline: '0835-12393',
  officialPortalUrl: 'http://ybj.yaan.gov.cn/',
  lastUpdated: '2026-03-01',

  sourceDocs: [
    {
      docId: 'ya-employee-outpatient-2022-33',
      title: '雅安市人民政府办公室关于印发雅安市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '雅办发〔2022〕33号',
      issuingDept: ['雅安市人民政府办公室', '雅安市医疗保障局'],
      publishDate: '2022-12-16',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.yaan.gov.cn/zwgk/zcfg/202212/t20221221_210984.shtml',
      summaryQuote: '职工普通门诊统筹按自然年度设一次起付标准：在职职工200元、退休人员150元；支付比例二级及以下60%（退休70%），三级50%（退休60%）；年度支付限额在职2000元、退休2500元。'
    },
    {
      docId: 'ya-medical-insurance-inpatient-2023',
      title: '雅安市医疗保障局关于印发雅安市基本医疗保险统筹支付管理实施办法的通知',
      docNumber: '雅医保发〔2023〕21号',
      issuingDept: ['雅安市医疗保障局', '雅安市财政局'],
      publishDate: '2023-09-25',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.yaan.gov.cn/zwgk/zcfg/202309/t20230930_221908.shtml',
      summaryQuote: '职工住院起付线：一级200元、二级400元、三级750元；在职支付比例一级92%、二级88%、三级84%（退休人员各项提高3%）。居民住院起付线一级100元、二级250元、三级600元，支付比例一级85%、二级78%、三级65%。大病保险起付线13000元，支付比例60%-75%。'
    }
  ],

  employee: {
    outpatient: {
      sourceDocId: 'ya-employee-outpatient-2022-33',
    ...
    inpatient: {
      sourceDocId: 'ya-medical-insurance-inpatient-2023',
      annualCap: 500000,
      tierBenefits: {
  ...
  resident: {
    ...
    inpatient: {
      ...
      annualCap: 200000,
      tierBenefits: {
        community: { tierName: '一级基层定点医疗机构', deductible: 150, reimbursementRatio: 0.85 },
