...
export const neijiangCityData: CityInsuranceData = {
  cityCode: '511000',
  cityName: '内江市',
  provinceCode: '510000',
  provinceName: '四川省',
  hotline: '0832-12393',
  officialPortalUrl: 'http://ybj.neijiang.gov.cn/',
  lastUpdated: '2026-03-01',

  sourceDocs: [
    {
      docId: 'nj-employee-outpatient-2022-32',
      title: '内江市人民政府办公室关于印发内江市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '内办发〔2022〕32号',
      issuingDept: ['内江市人民政府办公室', '内江市医疗保障局'],
      publishDate: '2022-12-20',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.neijiang.gov.cn/zwgk/zcfg/202212/t20221224_219082.shtml',
      summaryQuote: '职工普通门诊统筹按自然年度设一次起付标准：在职职工200元、退休人员150元；支付比例二级及以下60%（退休70%），三级50%（退休60%）；年度支付限额在职2000元、退休2500元。'
    },
    {
      docId: 'nj-medical-insurance-inpatient-2023',
      title: '内江市医疗保障局关于印发内江市基本医疗保险统筹基金支付管理细则的通知',
      docNumber: '内医保规〔2023〕2号',
      issuingDept: ['内江市医疗保障局', '内江市财政局'],
  ...
  employee: {
    ...
    inpatient: {
      sourceDocId: 'nj-medical-insurance-inpatient-2023',
      annualCap: 500000,
      tierBenefits: {
  ...
  resident: {
    ...
    inpatient: {
      ...
      annualCap: 200000,
      tierBenefits: {
        community: { tierName: '乡镇卫生院及社区中心', deductible: 150, reimbursementRatio: 0.90 },
        ...
        tier3_top: { tierName: '市级重点三甲医院', deductible: 1000, reimbursementRatio: 0.55 }
      },
      repeatedDeductibleRule: '参保人员自然年度内多次住院的，从第二次住院起，起付标准降低50%。'
    },
    catastrophic: {
