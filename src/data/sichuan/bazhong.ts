...
export const bazhongCityData: CityInsuranceData = {
  cityCode: '511900',
  cityName: '巴中市',
  provinceCode: '510000',
  provinceName: '四川省',
  hotline: '0827-12393',
  officialPortalUrl: 'http://ybj.cnbz.gov.cn/',
  lastUpdated: '2026-03-01',

  sourceDocs: [
    {
      docId: 'bz-employee-outpatient-2022-56',
      title: '巴中市人民政府办公室关于印发巴中市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '巴府办发〔2022〕56号',
      issuingDept: ['巴中市人民政府办公室', '巴中市医疗保障局'],
      publishDate: '2022-12-20',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.cnbz.gov.cn/zwgk/zcfg/202212/t20221224_219083.shtml',
      summaryQuote: '职工普通门诊统筹按自然年度设一次起付标准：在职职工200元、退休人员150元；支付比例二级及以下60%（退休70%），三级50%（退休60%）；年度支付限额在职2000元、退休2500元。'
    },
    {
      docId: 'bz-medical-insurance-inpatient-2023',
      title: '巴中市医疗保障局关于印发巴中市基本医疗保险待遇保障办法的通知',
      docNumber: '巴医保发〔2023〕31号',
      issuingDept: ['巴中市医疗保障局', '巴中市财政局'],
      publishDate: '2023-10-15',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.cnbz.gov.cn/zwgk/zcfg/202310/t20231020_229871.shtml',
  ...
  employee: {
    ...
    inpatient: {
      sourceDocId: 'bz-medical-insurance-inpatient-2023',
      annualCap: 500000,
      tierBenefits: {
  ...
  resident: {
    ...
    inpatient: {
      ...
      tierBenefits: {
        ...
        tier3_top: { tierName: '重点三甲医院', deductible: 650, reimbursementRatio: 0.65 }
      },
      repeatedDeductibleRule: '参保人员自然年度内多次住院的，从第二次住院起，起付标准降低50%。'
    },
    catastrophic: {
