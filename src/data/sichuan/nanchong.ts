...
export const nanchongCityData: CityInsuranceData = {
  cityCode: '511300',
  cityName: '南充市',
  provinceCode: '510000',
  provinceName: '四川省',
  hotline: '0817-12393',
  officialPortalUrl: 'http://ybj.nanchong.gov.cn/',
  lastUpdated: '2026-03-01',

  sourceDocs: [
    {
      docId: 'nc-employee-outpatient-2022-04',
      title: '南充市人民政府办公室关于印发南充市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '南府办规〔2022〕4号',
      issuingDept: ['南充市人民政府办公室', '南充市医疗保障局'],
      publishDate: '2022-12-19',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.nanchong.gov.cn/zwgk/zcfg/202212/t20221223_219083.shtml',
      summaryQuote: '职工普通门诊统筹按自然年度设一次起付标准：在职职工200元、退休人员150元；支付比例二级及以下60%（退休70%），三级50%（退休60%）；年度支付限额在职2000元、退休2500元。'
    },
    {
      docId: 'nc-medical-insurance-inpatient-2023',
      title: '南充市医疗保障局关于印发南充市基本医疗保险住院和大病保险实施办法的通知',
      docNumber: '南医保发〔2023〕42号',
      issuingDept: ['南充市医疗保障局', '南充市财政局'],
      publishDate: '2023-11-28',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.nanchong.gov.cn/zwgk/zcfg/202312/t20231205_229871.shtml',
  ...
  employee: {
    ...
    inpatient: {
      sourceDocId: 'nc-medical-insurance-inpatient-2023',
      annualCap: 500000,
      tierBenefits: {
  ...
  resident: {
    ...
    inpatient: {
      ...
      tierBenefits: {
        ...
        tier2: { tierName: '二级定点医疗机构', deductible: 300, reimbursementRatio: 0.77 },
