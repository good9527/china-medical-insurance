...
export const hengshuiData: CityInsuranceData = {
  cityCode: '131100',
  cityName: '衡水市',
  provinceCode: '130000',
  provinceName: '河北省',
  hotline: '0318-12393',
  officialPortalUrl: 'http://ybj.hengshui.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'hs-employee-outpatient-2021',
      title: '衡水市建立健全职工基本医疗保险门诊共济保障机制实施细则',
      docNumber: '衡政规〔2021〕8号',
      issuingDept: ['衡水市人民政府', '衡水市医疗保障局'],
      publishDate: '2021-12-29',
      effectiveDate: '2022-01-01',
      status: 'active',
      officialUrl: 'http://ybj.hengshui.gov.cn/art/2021/12/31/art_1420_17832.html',
      summaryQuote: '参保职工门诊统筹起付标准在一个自然年度内累计计算为100元；起付标准以上统筹基金支付比例为：在职职工50%，退休职工60%。年度最高支付限额在职职工为800元，退休职工为1000元。个人账户资金可由家庭成员共济使用。'
    },
    {
      docId: 'hs-resident-employee-inpatient-2023',
      title: '衡水市医疗保障局关于明确基本医疗保险住院及门诊待遇标准的通知',
      docNumber: '衡医保字〔2023〕16号',
      issuingDept: ['衡水市医疗保障局', '衡水市财政局'],
  ...
  employee: {
    outpatient: {
      sourceDocId: 'hs-employee-outpatient-2021',
      annualDeductible: 100, // 门诊年度起付线 100 元
      annualCap: 800,        // 在职限额 800 元
      annualCapRetiree: 1000, // 退休限额 1000 元
      tierBenefits: {
      ...
      note: '门诊年度起付线100元，在职报销50%，退休报销60%。限额在职800元，退休1000元。'
    },
    inpatient: {
