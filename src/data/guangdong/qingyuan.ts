...
export const qingyuanCityData: CityInsuranceData = {
  ...
  resident: {
    ...
    inpatient: {
      ...
      annualCap: 300000,
      tierBenefits: {
        community: { tierName: '基层卫生服务机构', deductible: 300, reimbursementRatio: 0.88 },
        ...
        tier3: { tierName: '三级定点医疗机构', deductible: 1200, reimbursementRatio: 0.68 },
        tier3_top: { tierName: '市级三甲综合医院', deductible: 1200, reimbursementRatio: 0.68 }
      }
    },
    catastrophic: {
      sourceDocId: 'qy-medical-insurance-inpatient-2024',
