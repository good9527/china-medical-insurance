  ...
  resident: {
    outpatient: {
      ...
      tierBenefits: {
        ...
        tier2: { tierName: '二级定点机构(选定)', deductible: 450, reimbursementRatio: 0.80 },
        tier3: { tierName: '三级定点机构(选定)', deductible: 800, reimbursementRatio: 0.65 },
        tier3_top: { tierName: '市级三甲综合医院', deductible: 800, reimbursementRatio: 0.65 }
      },
