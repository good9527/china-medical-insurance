  ...
  resident: {
    outpatient: {
      ...
      tierBenefits: {
        ...
        tier1: { tierName: '一级定点医疗机构', deductible: 300, reimbursementRatio: 0.92 },
        tier2: { tierName: '二级定点机构(选定)', deductible: 500, reimbursementRatio: 0.75 },
        tier3: { tierName: '三级定点机构(选定)', deductible: 700, reimbursementRatio: 0.65 },
