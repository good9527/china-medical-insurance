...
export const xinyuData: CityInsuranceData = {
  cityCode: '360500',
  cityName: '新余市',
  provinceCode: '360000',
  provinceName: '江西省',
  hotline: '0790-12393',
  officialPortalUrl: 'http://ybj.xinyu.gov.cn/',
  ...
  sourceDocs: [
    {
      ...
      title: '新余市职工基本医疗保险门诊共济实施细则',
      docNumber: '余府办发〔2022〕18号',
      issuingDept: ['新余市人民政府办公室', '新余市医疗保障局'],
    ...
    },
    {
      ...
      title: '新余市基本医疗保险住院及门诊待遇保障细则通知',
      docNumber: '余医保发〔2023〕14号',
      issuingDept: ['新余市医疗保障局', '新余市财政局'],
  ...
  employee: {
    ...
    remoteMedical: {
      ...
      specialNotes: [
        '跨省异地就医直接联网结算，长期异地备案享受与新余本地同等报销待遇。'
      ]
    }
  },
