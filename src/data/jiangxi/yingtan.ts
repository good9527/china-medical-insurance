...
export const yingtanData: CityInsuranceData = {
  cityCode: '360600',
  cityName: '鹰潭市',
  provinceCode: '360000',
  provinceName: '江西省',
  hotline: '0701-12393',
  officialPortalUrl: 'http://ybj.yingtan.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'yt-employee-outpatient-2022',
      title: '鹰潭市职工基本医疗保险门诊共济保障机制实施方案及优化调整通知',
      docNumber: '鹰府办字〔2022〕42号',
      issuingDept: ['鹰潭市人民政府办公室', '鹰潭市医疗保障局'],
      publishDate: '2022-12-15',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.yingtan.gov.cn/zwgk/zcfg/202212/t20221220_5812930.html',
      summaryQuote: '普通门诊统筹年度起付标准调整为300元。起付线以上统筹基金支付比例：一级及以下医疗机构65%（退休70%）、二级医疗机构60%（退休65%）、三级医疗机构55%（退休60%）。门诊统筹年度最高支付限额在职职工2000元，退休人员3000元。'
    },
    {
      docId: 'yt-resident-employee-inpatient-2023',
      title: '鹰潭市基本医疗保险住院及门诊待遇保障细则通知',
      docNumber: '鹰医保发〔2023〕15号',
      issuingDept: ['鹰潭市医疗保障局', '鹰潭市财政局'],
      publishDate: '2023-05-18',
      effectiveDate: '2023-06-01',
      status: 'active',
      officialUrl: 'http://ybj.yingtan.gov.cn/zwgk/zcfg/202305/t20230522_5891042.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'yt-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'yt-resident-employee-inpatient-2023',
    ...
    remoteMedical: {
      ...
      specialNotes: [
        '跨省异地就医直接联网结算，长期异地备案享受与鹰潭本地同等报销待遇。'
      ]
    }
  },
