...
export const pingxiangData: CityInsuranceData = {
  cityCode: '360300',
  cityName: '萍乡市',
  provinceCode: '360000',
  provinceName: '江西省',
  hotline: '0799-12393',
  officialPortalUrl: 'http://ybj.pingxiang.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'px-employee-outpatient-2022',
      title: '萍乡市职工基本医疗保险门诊共济保障机制实施细则及优化待遇通知',
      docNumber: '萍府办发〔2022〕26号',
      issuingDept: ['萍乡市人民政府办公室', '萍乡市医疗保障局'],
      publishDate: '2022-12-10',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.pingxiang.gov.cn/zwgk/zcfg/202212/t20221215_6190823.html',
    ...
    {
      docId: 'px-resident-employee-inpatient-2023',
      title: '萍乡市基本医疗保险住院及门诊待遇保障细则通知',
      docNumber: '萍医保发〔2023〕18号',
      issuingDept: ['萍乡市医疗保障局', '萍乡市财政局'],
      publishDate: '2023-05-18',
      effectiveDate: '2023-06-01',
      status: 'active',
      officialUrl: 'http://ybj.pingxiang.gov.cn/zwgk/zcfg/202305/t20230522_6210943.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'px-employee-outpatient-2022',
    ...
    remoteMedical: {
      ...
      specialNotes: [
        '跨省异地就医直接联网结算，长期异地备案享受与萍乡本地同等报销待遇。'
      ]
    }
  },
