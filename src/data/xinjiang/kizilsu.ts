...
export const kizilsuData: CityInsuranceData = {
  cityCode: '653000',
  cityName: '克孜勒苏柯尔克孜自治州',
  provinceCode: '650000',
  provinceName: '新疆维吾尔自治区',
  hotline: '0908-12393',
  officialPortalUrl: 'http://ybj.xjkz.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'kz-employee-outpatient-2024-13',
      title: '关于印发新疆维吾尔自治区职工基本医疗保险门诊共济保障实施办法的通知',
      docNumber: '新政办发〔2024〕13号',
      issuingDept: ['新疆维吾尔自治区人民政府办公厅', '克孜勒苏柯尔克孜自治州医疗保障局'],
      publishDate: '2024-03-15',
      effectiveDate: '2024-04-01',
      status: 'active',
      officialUrl: 'http://ybj.xjkz.gov.cn/zwgk/zcfg/202403/t20240325_481230.html',
      summaryQuote: '门诊统筹次均起付标准一级20元、二级40元、三级90元。统筹支付比例一级80%（退休85%）、二级70%（退休75%）、三级60%（退休65%）。门诊统筹年度最高支付限额统一为4000元。'
    },
    {
      docId: 'kz-medical-insurance-inpatient-2024',
      title: '克孜勒苏柯尔克孜自治州基本医疗保险综合保障管理实施细则',
      docNumber: '克州医保发〔2024〕20号',
      issuingDept: ['克孜勒苏柯尔克孜自治州医疗保障局', '克孜勒苏柯尔克孜自治州财政局'],
      publishDate: '2024-11-20',
      effectiveDate: '2025-01-01',
      status: 'active',
      officialUrl: 'http://ybj.xjkz.gov.cn/zwgk/zcfg/202411/t20241126_591823.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'kz-employee-outpatient-2024-13',
      annualDeductible: 90,
      annualCap: 4000,
      ...
      tierBenefits: {
        ...
        tier3: { tierName: '州属三级定点医疗机构', deductible: 90, reimbursementRatio: 0.60, retireeRatioBonus: 0.05 },
    ...
    inpatient: {
      sourceDocId: 'kz-medical-insurance-inpatient-2024',
      annualCap: 500000,
      tierBenefits: {
        ...
        tier3: { tierName: '州属三级定点医疗机构', deductible: 900, reimbursementRatio: 0.85, retireeRatioBonus: 0.04 },
