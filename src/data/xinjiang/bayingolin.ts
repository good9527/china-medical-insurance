...
export const bayingolinData: CityInsuranceData = {
  cityCode: '652800',
  cityName: '巴音郭楞蒙古自治州',
  provinceCode: '650000',
  provinceName: '新疆维吾尔自治区',
  hotline: '0996-12393',
  officialPortalUrl: 'http://ybj.xjbz.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'bz-employee-outpatient-2024-13',
      title: '关于印发新疆维吾尔自治区职工基本医疗保险门诊共济保障实施办法的通知',
      docNumber: '新政办发〔2024〕13号',
      issuingDept: ['新疆维吾尔自治区人民政府办公厅', '巴音郭楞蒙古自治州医疗保障局'],
      publishDate: '2024-03-15',
      effectiveDate: '2024-04-01',
      status: 'active',
      officialUrl: 'http://ybj.xjbz.gov.cn/zwgk/zcfg/202403/t20240325_890123.html',
      summaryQuote: '门诊统筹次均起付标准一级20元、二级40元、三级90元。统筹支付比例一级80%（退休85%）、二级70%（退休75%）、三级60%（退休65%）。门诊统筹年度最高支付限额统一为4000元。'
    },
    {
      docId: 'bz-medical-insurance-inpatient-2024',
      title: '巴音郭楞蒙古自治州基本医疗保险综合保障管理实施细则',
      docNumber: '巴医保发〔2024〕28号',
      issuingDept: ['巴音郭楞蒙古自治州医疗保障局', '巴音郭楞蒙古自治州财政局'],
      publishDate: '2024-11-20',
      effectiveDate: '2025-01-01',
      status: 'active',
      officialUrl: 'http://ybj.xjbz.gov.cn/zwgk/zcfg/202411/t20241126_981240.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'bz-employee-outpatient-2024-13',
      annualDeductible: 90,
      annualCap: 4000,
    ...
    inpatient: {
      sourceDocId: 'bz-medical-insurance-inpatient-2024',
      annualCap: 500000,
      tierBenefits: {
