...
export const karamayData: CityInsuranceData = {
  cityCode: '650200',
  cityName: '克拉玛依市',
  provinceCode: '650000',
  provinceName: '新疆维吾尔自治区',
  hotline: '0990-12393',
  officialPortalUrl: 'http://ybj.klmy.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'klmy-employee-outpatient-2024-13',
      title: '关于印发新疆维吾尔自治区职工基本医疗保险门诊共济保障实施办法的通知',
      docNumber: '新政办发〔2024〕13号',
      issuingDept: ['新疆维吾尔自治区人民政府办公厅', '克拉玛依市医疗保障局'],
      publishDate: '2024-03-15',
      effectiveDate: '2024-04-01',
      status: 'active',
      officialUrl: 'http://ybj.klmy.gov.cn/zwgk/zcfg/202403/t20240322_512984.html',
      summaryQuote: '门诊统筹次均起付标准一级20元、二级40元、三级90元。统筹支付比例一级80%（退休85%）、二级70%（退休75%）、三级60%（退休65%）。门诊统筹年度最高支付限额统一为4000元。'
    },
    {
      docId: 'klmy-medical-insurance-inpatient-2024',
      title: '克拉玛依市基本医疗保险综合保障管理实施细则',
      docNumber: '克医保发〔2024〕22号',
      issuingDept: ['克拉玛依市医疗保障局', '克拉玛依市财政局'],
      publishDate: '2024-11-18',
      effectiveDate: '2025-01-01',
      status: 'active',
      officialUrl: 'http://ybj.klmy.gov.cn/zwgk/zcfg/202411/t20241120_631892.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'klmy-employee-outpatient-2024-13',
      annualDeductible: 90,
      annualCap: 4000,
    ...
    inpatient: {
      sourceDocId: 'klmy-medical-insurance-inpatient-2024',
      annualCap: 500000,
      tierBenefits: {
