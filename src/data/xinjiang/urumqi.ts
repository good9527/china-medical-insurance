...
export const urumqiCityData: CityInsuranceData = {
  cityCode: '650100',
  cityName: '乌鲁木齐市',
  provinceCode: '650000',
  provinceName: '新疆维吾尔自治区',
  hotline: '0991-12393',
  officialPortalUrl: 'http://ybj.urumqi.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'wlmq-employee-outpatient-2024-13',
      title: '关于印发新疆维吾尔自治区职工基本医疗保险门诊共济保障实施办法的通知',
      docNumber: '新政办发〔2024〕13号',
      issuingDept: ['新疆维吾尔自治区人民政府办公厅', '新疆维吾尔自治区医疗保障局'],
      publishDate: '2024-03-15',
      effectiveDate: '2024-04-01',
      status: 'active',
      officialUrl: 'http://ybj.xinjiang.gov.cn/zwgk/zcfg/202403/t20240320_7891234.html',
      summaryQuote: '门诊统筹次均起付标准一级20元、二级40元、三级90元。统筹支付比例一级80%（退休85%）、二级70%（退休75%）、三级60%（退休65%）。门诊统筹年度最高支付限额统一为4000元。'
    },
    {
      docId: 'wlmq-medical-insurance-inpatient-2024',
      title: '乌鲁木齐市基本医疗保险住院保障及大额救助管理细则',
      docNumber: '乌医保发〔2024〕20号',
      issuingDept: ['乌鲁木齐市医疗保障局', '乌鲁木齐市财政局'],
      publishDate: '2024-11-20',
      effectiveDate: '2025-01-01',
      status: 'active',
      officialUrl: 'http://ybj.urumqi.gov.cn/zwgk/zcfg/202411/t20241126_6290123.html',
      summaryQuote: '职工住院起付线：三级900元、二级400元、一级200元；在职支付比例三级85%、二级88%、一级92%（退休人员提高至89%、92%、95%）。居民住院起付线三级800元/60%、二级300元/75%、一级100元/85%。基本统筹限额15万元。大病保险起付线1.2万元，分段报销60%-75%，封顶35万元。'
    }
  ],
  ...
  employee: {
    outpatient: {
      sourceDocId: 'wlmq-employee-outpatient-2024-13',
      annualDeductible: 90, // 门诊次均起付线
      ...
      tierBenefits: {
        ...
        tier3: { tierName: '市属三级定点医疗机构', deductible: 90, reimbursementRatio: 0.60, retireeRatioBonus: 0.05 },
        tier3_top: { tierName: '自治区重点三甲医院', deductible: 90, reimbursementRatio: 0.60, retireeRatioBonus: 0.05 }
      },
      note: '门诊次均起付标准一级20元、二级40元、三级90元。统筹报销比例60%-80%，退休人员加5%（65%-85%），年度限额4000元。'
    },
    inpatient: {
      sourceDocId: 'wlmq-medical-insurance-inpatient-2024',
      annualCap: 500000, // 基本统筹 + 职工大额补助
      tierBenefits: {
        ...
        tier3: { tierName: '市属三级定点医疗机构', deductible: 900, reimbursementRatio: 0.85, retireeRatioBonus: 0.04 },
        tier3_top: { tierName: '自治区重点三甲综合医院', deductible: 900, reimbursementRatio: 0.85, retireeRatioBonus: 0.04 }
      },
      repeatedDeductibleRule: '同自然年度内多次住院起付标准按规程减半递减。'
    },
    catastrophic: {
      sourceDocId: 'wlmq-medical-insurance-inpatient-2024',
      name: '职工大额医疗费用补助',
    ...
    remoteMedical: {
      sourceDocId: 'wlmq-medical-insurance-inpatient-2024',
      filingChannels: ['国家医保服务平台APP', '新疆医保微信服务号'],
  ...
  resident: {
    ...
    remoteMedical: {
      sourceDocId: 'wlmq-medical-insurance-inpatient-2024',
      filingChannels: ['国家医保服务平台APP', '新疆医保小程序'],
      longTermFiledRatio: 1.0,
