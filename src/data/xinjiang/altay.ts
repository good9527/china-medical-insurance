...
export const altayData: CityInsuranceData = {
  cityCode: '654300',
  cityName: '阿勒泰地区',
  provinceCode: '650000',
  provinceName: '新疆维吾尔自治区',
  hotline: '0906-12393',
  officialPortalUrl: 'http://ybj.xjalt.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'alt-employee-outpatient-2024-13',
      title: '关于印发新疆维吾尔自治区职工基本医疗保险门诊共济保障实施办法的通知',
      docNumber: '新政办发〔2024〕13号',
      issuingDept: ['新疆维吾尔自治区人民政府办公厅', '阿勒泰地区医疗保障局'],
      publishDate: '2024-03-15',
      effectiveDate: '2024-04-01',
      status: 'active',
      officialUrl: 'http://ybj.xjalt.gov.cn/zwgk/zcfg/202403/t20240325_481903.html',
      summaryQuote: '门诊统筹次均起付标准一级20元、二级40元、三级90元。统筹支付比例一级80%（退休85%）、二级70%（退休75%）、三级60%（退休65%）。门诊统筹年度最高支付限额统一为4000元。'
    },
    {
      docId: 'alt-medical-insurance-inpatient-2024',
      title: '阿勒泰地区基本医疗保险综合保障管理实施细则',
      docNumber: '阿医保发〔2024〕24号',
      issuingDept: ['阿勒泰地区医疗保障局', '阿勒泰地区财政局'],
      publishDate: '2024-11-20',
      effectiveDate: '2025-01-01',
      status: 'active',
      officialUrl: 'http://ybj.xjalt.gov.cn/zwgk/zcfg/202411/t20241126_591834.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'alt-employee-outpatient-2024-13',
      annualDeductible: 90,
      annualCap: 4000,
    ...
    inpatient: {
      sourceDocId: 'alt-medical-insurance-inpatient-2024',
      annualCap: 500000,
      tierBenefits: {
