...
export const anyangCityData: CityInsuranceData = {
  cityCode: '410500',
  cityName: '安阳市',
  provinceCode: '410000',
  provinceName: '河南省',
  hotline: '0372-12393',
  officialPortalUrl: 'http://ybj.anyang.gov.cn/',
  lastUpdated: '2026-03-01',

  sourceDocs: [
    {
      docId: 'ay-employee-outpatient-2022-33',
      title: '安阳市人民政府办公室关于印发安阳市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '安政办〔2022〕33号',
      issuingDept: ['安阳市人民政府办公室', '安阳市医疗保障局'],
      publishDate: '2022-06-25',
      effectiveDate: '2022-07-01',
      status: 'active',
      officialUrl: 'http://ybj.anyang.gov.cn/zwgk/zcfg/202206/t20220628_210984.shtml',
      summaryQuote: '职工普通门诊按次设起付标准：基层机构免设起付线，二级及以上医院每次30元；报销比例基层65%（退休75%），二级60%（退休70%），三级55%（退休65%）；年度支付限额在职1800元，退休2300元。'
    },
    {
      docId: 'ay-medical-insurance-inpatient-2023',
      title: '安阳市医疗保障局关于印发安阳市基本医疗保险待遇保障办法的通知',
      docNumber: '安医保发〔2023〕32号',
      issuingDept: ['安阳市医疗保障局', '安阳市财政局'],
      publishDate: '2023-10-25',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.anyang.gov.cn/zwgk/zcfg/202310/t20231030_219084.shtml',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'ay-employee-outpatient-2022-33',
      annualDeductible: 30,
      ...
      tierBenefits: {
        ...
        tier3_top: { tierName: '安阳市地区医院等重点三甲', deductible: 30, reimbursementRatio: 0.55, retireeRatioBonus: 0.10 }
      },
      note: '门诊基层机构免起付线，二级及以上每次30元。基层报销65%（退休75%），二级60%（退休70%），三级55%（退休65%）。限额在职1800元，退休2300元。'
    },
    inpatient: {
      sourceDocId: 'ay-medical-insurance-inpatient-2023',
      annualCap: 500000,
      tierBenefits: {
