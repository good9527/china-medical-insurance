...
export const zhumadianCityData: CityInsuranceData = {
  cityCode: '411700',
  cityName: '驻马店市',
  provinceCode: '410000',
  provinceName: '河南省',
  hotline: '0396-12393',
  officialPortalUrl: 'http://ybj.zhumadian.gov.cn/',
  lastUpdated: '2026-03-01',

  sourceDocs: [
    {
      docId: 'zmd-employee-outpatient-2022-36',
      title: '驻马店市人民政府办公室关于印发驻马店市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '驻政办〔2022〕36号',
      issuingDept: ['驻马店市人民政府办公室', '驻马店市医疗保障局'],
      publishDate: '2022-06-25',
      effectiveDate: '2022-07-01',
      status: 'active',
      officialUrl: 'http://ybj.zhumadian.gov.cn/zwgk/zcfg/202206/t20220628_210984.shtml',
      summaryQuote: '职工普通门诊按次设起付标准：每次30元（基层医疗机构免起付）；报销比例基层65%（退休75%），二级60%（退休70%），三级55%（退休65%）；年度支付限额在职1800元，退休2300元。'
    },
    {
      docId: 'zmd-medical-insurance-inpatient-2023',
      title: '驻马店市基本医疗保险住院和大病保险管理办法',
      docNumber: '驻医保发〔2023〕33号',
      issuingDept: ['驻马店市医疗保障局', '驻马店市财政局'],
      publishDate: '2023-10-18',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.zhumadian.gov.cn/zwgk/zcfg/202310/t20231023_219084.shtml',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'zmd-employee-outpatient-2022-36',
      annualDeductible: 30,
      ...
      tierBenefits: {
        ...
        tier3_top: { tierName: '驻马店市中心医院等重点三甲', deductible: 30, reimbursementRatio: 0.55, retireeRatioBonus: 0.10 }
      },
      note: '门诊基层机构免起付线，二级及以上每次30元。基层报销65%（退休75%），二级60%（退休70%），三级55%（退休65%）。限额在职1800元，退休2300元。'
    },
    inpatient: {
      sourceDocId: 'zmd-medical-insurance-inpatient-2023',
      annualCap: 500000,
      tierBenefits: {
