...
export const shangqiuCityData: CityInsuranceData = {
  cityCode: '411400',
  cityName: '商丘市',
  provinceCode: '410000',
  provinceName: '河南省',
  hotline: '0370-12393',
  officialPortalUrl: 'http://ybj.shangqiu.gov.cn/',
  lastUpdated: '2026-03-01',

  sourceDocs: [
    {
      docId: 'sq-employee-outpatient-2022-35',
      title: '商丘市人民政府办公室关于印发商丘市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '商政办〔2022〕35号',
      issuingDept: ['商丘市人民政府办公室', '商丘市医疗保障局'],
      publishDate: '2022-06-25',
      effectiveDate: '2022-07-01',
      status: 'active',
      officialUrl: 'http://ybj.shangqiu.gov.cn/zwgk/zcfg/202206/t20220628_210984.shtml',
    ...
    },
    {
      ...
      title: '商丘市基本医疗保险统筹基金支付管理细则',
      docNumber: '商医保发〔2023〕26号',
      issuingDept: ['商丘市医疗保障局', '商丘市财政局'],
  ...
  employee: {
    outpatient: {
      sourceDocId: 'sq-employee-outpatient-2022-35',
      annualDeductible: 30,
      ...
      tierBenefits: {
        ...
        tier3_top: { tierName: '商丘市第一人民医院等三甲', deductible: 30, reimbursementRatio: 0.55, retireeRatioBonus: 0.10 }
      },
