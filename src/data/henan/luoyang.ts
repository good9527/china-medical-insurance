  ...
  employee: {
    outpatient: {
      ...
      tierBenefits: {
        ...
        tier3_top: { tierName: '河南科技大学一附院等三甲', deductible: 30, reimbursementRatio: 0.55, retireeRatioBonus: 0.10 }
      },
      note: '门诊基层机构免起付线，二级及以上每次30元。基层报销65%（退休75%），二级60%（退休70%），三级55%（退休65%）。在职限额1800元，退休2300元。'
    },
    inpatient: {
