...
export const sanmenxiaCityData: CityInsuranceData = {
  cityCode: '411200',
  cityName: '三门峡市',
  provinceCode: '410000',
  provinceName: '河南省',
  hotline: '0398-12393',
  officialPortalUrl: 'http://ybj.smx.gov.cn/',
  lastUpdated: '2026-03-01',

  sourceDocs: [
    {
      docId: 'smx-employee-outpatient-2022-30',
      title: '三门峡市人民政府办公室关于印发三门峡市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '三政办〔2022〕30号',
      issuingDept: ['三门峡市人民政府办公室', '三门峡市医疗保障局'],
      publishDate: '2022-06-25',
      effectiveDate: '2022-07-01',
      status: 'active',
      officialUrl: 'http://ybj.smx.gov.cn/zwgk/zcfg/202206/t20220628_210984.shtml',
      summaryQuote: '职工普通门诊按次设起付标准：每次30元（基层医疗机构免起付）；报销比例基层65%（退休75%），二级60%（退休70%），三级55%（退休65%）；年度支付限额在职1800元，退休2300元。'
    },
    {
      docId: 'smx-medical-insurance-inpatient-2023',
      title: '三门峡市基本医疗保险待遇保障办法',
      docNumber: '三医保发〔2023〕25号',
      issuingDept: ['三门峡市医疗保障局', '三门峡市财政局'],
  ...
  employee: {
    outpatient: {
      sourceDocId: 'smx-employee-outpatient-2022-30',
      annualDeductible: 30,
      ...
      tierBenefits: {
        ...
        tier3_top: { tierName: '黄河三门峡医院等重点三甲', deductible: 30, reimbursementRatio: 0.55, retireeRatioBonus: 0.10 }
      },
      note: '门诊基层机构免起付线，二级及以上每次30元。基层报销65%（退休75%），二级60%（退休70%），三级55%（退休65%）。限额在职1800元，退休2300元。'
    },
    inpatient: {
      sourceDocId: 'smx-medical-insurance-inpatient-2023',
      annualCap: 500000,
      tierBenefits: {
  ...
  resident: {
    ...
    inpatient: {
      ...
      tierBenefits: {
        ...
        tier3_top: { tierName: '市级重点三甲医院', deductible: 900, reimbursementRatio: 0.65 }
      },
