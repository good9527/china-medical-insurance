...
export const luoheCityData: CityInsuranceData = {
  cityCode: '411100',
  cityName: '漯河市',
  provinceCode: '410000',
  provinceName: '河南省',
  hotline: '0395-12393',
  officialPortalUrl: 'http://ybj.luohe.gov.cn/',
  lastUpdated: '2026-03-01',

  sourceDocs: [
    {
      docId: 'lh-employee-outpatient-2022-27',
      title: '漯河市人民政府办公室关于印发漯河市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '漯政办〔2022〕27号',
      issuingDept: ['漯河市人民政府办公室', '漯河市医疗保障局'],
      publishDate: '2022-06-25',
      effectiveDate: '2022-07-01',
      status: 'active',
      officialUrl: 'http://ybj.luohe.gov.cn/zwgk/zcfg/202206/t20220628_210984.shtml',
      summaryQuote: '职工普通门诊按次设起付标准：每次30元（基层医疗机构免起付）；报销比例基层65%（退休75%），二级60%（退休70%），三级55%（退休65%）；年度支付限额在职1800元，退休2300元。'
    },
    {
      docId: 'lh-medical-insurance-inpatient-2023',
      title: '漯河市基本医疗保险统筹支付与大病保险管理细则',
      docNumber: '漯医保发〔2023〕22号',
      issuingDept: ['漯河市医疗保障局', '漯河市财政局'],
      publishDate: '2023-10-18',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.luohe.gov.cn/zwgk/zcfg/202310/t20231023_219084.shtml',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'lh-employee-outpatient-2022-27',
      annualDeductible: 30,
      ...
      tierBenefits: {
        ...
        tier3_top: { tierName: '漯河市中心医院等重点三甲', deductible: 30, reimbursementRatio: 0.55, retireeRatioBonus: 0.10 }
      },
      note: '门诊基层机构免起付线，二级及以上每次30元。基层报销65%（退休75%），二级60%（退休70%），三级55%（退休65%）。限额在职1800元，退休2300元。'
    },
    inpatient: {
      sourceDocId: 'lh-medical-insurance-inpatient-2023',
      annualCap: 500000,
      tierBenefits: {
