...
export const jiaozuoCityData: CityInsuranceData = {
  cityCode: '410800',
  cityName: '焦作市',
  provinceCode: '410000',
  provinceName: '河南省',
  hotline: '0391-12393',
  officialPortalUrl: 'http://ybj.jiaozuo.gov.cn/',
  lastUpdated: '2026-03-01',

  sourceDocs: [
    {
      docId: 'jz-employee-outpatient-2022-35',
      title: '焦作市人民政府办公室关于印发焦作市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '焦政办〔2022〕35号',
      issuingDept: ['焦作市人民政府办公室', '焦作市医疗保障局'],
      publishDate: '2022-06-25',
      effectiveDate: '2022-07-01',
      status: 'active',
      officialUrl: 'http://ybj.jiaozuo.gov.cn/zwgk/zcfg/202206/t20220628_210984.shtml',
      summaryQuote: '职工普通门诊按次设起付标准：每次30元（基层医疗机构免起付）；报销比例基层65%（退休75%），二级60%（退休70%），三级55%（退休65%）；年度支付限额在职1800元，退休2300元。'
    },
    {
      docId: 'jz-medical-insurance-inpatient-2023',
      title: '焦作市基本医疗保险统筹基金支付管理细则',
      docNumber: '焦医保发〔2023〕25号',
      issuingDept: ['焦作市医疗保障局', '焦作市财政局'],
  ...
  employee: {
    outpatient: {
      sourceDocId: 'jz-employee-outpatient-2022-35',
      annualDeductible: 30,
      ...
      tierBenefits: {
        ...
        tier3_top: { tierName: '焦作市人民医院等重点三甲', deductible: 30, reimbursementRatio: 0.55, retireeRatioBonus: 0.10 }
      },
      note: '门诊基层机构免起付线，二级及以上每次30元。基层报销65%（退休75%），二级60%（退休70%），三级55%（退休65%）。限额在职1800元，退休2300元。'
    },
    inpatient: {
      sourceDocId: 'jz-medical-insurance-inpatient-2023',
      annualCap: 500000,
      tierBenefits: {
