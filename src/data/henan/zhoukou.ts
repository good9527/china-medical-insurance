...
export const zhoukouCityData: CityInsuranceData = {
  cityCode: '411600',
  cityName: '周口市',
  provinceCode: '410000',
  provinceName: '河南省',
  hotline: '0394-12393',
  officialPortalUrl: 'http://ybj.zhoukou.gov.cn/',
  lastUpdated: '2026-03-01',

  sourceDocs: [
    {
      docId: 'zk-employee-outpatient-2022-29',
      title: '周口市人民政府办公室关于印发周口市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '周政办〔2022〕29号',
      issuingDept: ['周口市人民政府办公室', '周口市医疗保障局'],
      publishDate: '2022-06-25',
      effectiveDate: '2022-07-01',
      status: 'active',
      officialUrl: 'http://ybj.zhoukou.gov.cn/zwgk/zcfg/202206/t20220628_210984.shtml',
      summaryQuote: '职工普通门诊按次设起付标准：每次30元（基层医疗机构免起付）；报销比例基层65%（退休75%），二级60%（退休70%），三级55%（退休65%）；年度支付限额在职1800元，退休2300元。'
    },
    {
      docId: 'zk-medical-insurance-inpatient-2023',
      title: '周口市医疗保障局关于印发周口市基本医疗保险统筹支付管理细则的通知',
      docNumber: '周医保发〔2023〕28号',
      issuingDept: ['周口市医疗保障局', '周口市财政局'],
  ...
  employee: {
    outpatient: {
      sourceDocId: 'zk-employee-outpatient-2022-29',
      annualDeductible: 30,
      ...
      tierBenefits: {
        ...
        tier3_top: { tierName: '周口市中心医院等重点三甲', deductible: 30, reimbursementRatio: 0.55, retireeRatioBonus: 0.10 }
      },
