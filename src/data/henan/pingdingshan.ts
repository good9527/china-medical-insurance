...
export const pingdingshanCityData: CityInsuranceData = {
  cityCode: '410400',
  cityName: '平顶山市',
  provinceCode: '410000',
  provinceName: '河南省',
  hotline: '0375-12393',
  officialPortalUrl: 'http://ybj.pds.gov.cn/',
  lastUpdated: '2026-03-01',

  sourceDocs: [
    {
      docId: 'pds-employee-outpatient-2022-31',
      title: '平顶山市人民政府办公室关于印发平顶山市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '平政办〔2022〕31号',
      issuingDept: ['平顶山市人民政府办公室', '平顶山市医疗保障局'],
      publishDate: '2022-06-26',
      effectiveDate: '2022-07-01',
      status: 'active',
      officialUrl: 'http://ybj.pds.gov.cn/zwgk/zcfg/202206/t20220629_210984.shtml',
      summaryQuote: '职工普通门诊按次设起付标准：每次30元（基层医疗机构免起付）；报销比例基层65%（退休75%），二级60%（退休70%），三级55%（退休65%）；年度支付限额在职1800元，退休2300元。'
    },
    {
      docId: 'pds-medical-insurance-inpatient-2023',
      title: '平顶山市基本医疗保险统筹支付与大病保险管理细则',
      docNumber: '平医保发〔2023〕28号',
      issuingDept: ['平顶山市医疗保障局', '平顶山市财政局'],
  ...
  employee: {
    outpatient: {
      sourceDocId: 'pds-employee-outpatient-2022-31',
      annualDeductible: 30,
      ...
      tierBenefits: {
        ...
        tier3_top: { tierName: '平顶山市第一人民医院等三甲', deductible: 30, reimbursementRatio: 0.55, retireeRatioBonus: 0.10 }
      },
      note: '门诊基层机构免起付线，二级及以上每次30元。基层报销65%（退休75%），二级60%（退休70%），三级55%（退休65%）。限额在职1800元，退休2300元。'
    },
    inpatient: {
      sourceDocId: 'pds-medical-insurance-inpatient-2023',
      annualCap: 500000,
      tierBenefits: {
