...
export const kaifengCityData: CityInsuranceData = {
  ...
  employee: {
    outpatient: {
      ...
      tierBenefits: {
        community: { tierName: '基层社区及乡镇卫生院', deductible: 20, reimbursementRatio: 0.65, retireeRatioBonus: 0.10 },
        tier1: { tierName: '一级定点医疗机构', deductible: 20, reimbursementRatio: 0.65, retireeRatioBonus: 0.10 },
      ...
      note: '门诊按次设起付线（基层20元、二级40元、三级50元）。基层报销65%（退休75%），二级60%（退休70%），三级55%（退休65%）。限额在职1800元，退休2300元。'
    },
    inpatient: {
