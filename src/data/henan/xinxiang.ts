...
export const xinxiangCityData: CityInsuranceData = {
  cityCode: '410700',
  cityName: '新乡市',
  provinceCode: '410000',
  provinceName: '河南省',
  hotline: '0373-12393',
  officialPortalUrl: 'http://ybj.xinxiang.gov.cn/',
  lastUpdated: '2026-03-01',

  sourceDocs: [
    {
      docId: 'xx-employee-outpatient-2022-36',
      title: '新乡市人民政府办公室关于印发新乡市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '新政办〔2022〕36号',
      issuingDept: ['新乡市人民政府办公室', '新乡市医疗保障局'],
    ...
    },
    {
      ...
      title: '新乡市医疗保障局关于印发新乡市基本医疗保险住院和大病保险管理办法的通知',
      docNumber: '新医保发〔2023〕30号',
      issuingDept: ['新乡市医疗保障局', '新乡市财政局'],
  ...
  employee: {
    outpatient: {
      ...
      tierBenefits: {
        ...
        tier3_top: { tierName: '新乡医学院一附院等重点三甲', deductible: 30, reimbursementRatio: 0.55, retireeRatioBonus: 0.10 }
      },
