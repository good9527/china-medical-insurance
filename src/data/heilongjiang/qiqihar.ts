...
export const qiqiharCityData: CityInsuranceData = {
  cityCode: '230200',
  cityName: '齐齐哈尔市',
  provinceCode: '230000',
  provinceName: '黑龙江省',
  hotline: '0452-12393',
  officialPortalUrl: 'http://ybj.qqhr.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'qqhr-employee-outpatient-2022',
      title: '齐齐哈尔市人民政府办公室关于印发齐齐哈尔市建立健全职工基本医疗保险门诊共济保障机制实施方案的通知',
      docNumber: '齐政办规〔2022〕18号',
      issuingDept: ['齐齐哈尔市人民政府办公室', '齐齐哈尔市医疗保障局'],
      publishDate: '2022-12-15',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.qqhr.gov.cn/zwgk/zcfg/202212/t20221220_1189234.html',
    ...
    {
      docId: 'qqhr-medical-insurance-policy-2023',
      title: '齐齐哈尔市医疗保障局关于进一步完善基本医疗保险待遇政策的通知',
      docNumber: '齐医保发〔2023〕21号',
      issuingDept: ['齐齐哈尔市医疗保障局', '齐齐哈尔市财政局'],
  ...
  employee: {
    outpatient: {
      sourceDocId: 'qqhr-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'qqhr-medical-insurance-policy-2023',
      annualCap: 500000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'qqhr-medical-insurance-policy-2023',
      filingChannels: ['国家医保服务平台APP', '全省事', '齐齐哈尔医保微信公众号'],
