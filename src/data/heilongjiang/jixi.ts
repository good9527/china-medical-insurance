...
export const jixiCityData: CityInsuranceData = {
  cityCode: '230300',
  cityName: '鸡西市',
  provinceCode: '230000',
  provinceName: '黑龙江省',
  hotline: '0467-12393',
  officialPortalUrl: 'http://ybj.jixi.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'jx-employee-outpatient-2022',
      title: '鸡西市人民政府办公室关于印发鸡西市建立健全职工基本医疗保险门诊共济保障机制实施方案的通知',
      docNumber: '鸡政办规〔2022〕16号',
      issuingDept: ['鸡西市人民政府办公室', '鸡西市医疗保障局'],
      publishDate: '2022-12-16',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.jixi.gov.cn/zwgk/zcfg/202212/t20221221_1189234.html',
    ...
    {
      docId: 'jx-medical-insurance-policy-2023',
      title: '鸡西市医疗保障局关于调整基本医疗保险待遇政策的通知',
      docNumber: '鸡医保发〔2023〕19号',
      issuingDept: ['鸡西市医疗保障局', '鸡西市财政局'],
      publishDate: '2023-11-20',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.jixi.gov.cn/zwgk/zcfg/202311/t20231126_1289123.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'jx-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'jx-medical-insurance-policy-2023',
      annualCap: 500000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'jx-medical-insurance-policy-2023',
      filingChannels: ['国家医保服务平台APP', '全省事', '鸡西医保微信公众号'],
