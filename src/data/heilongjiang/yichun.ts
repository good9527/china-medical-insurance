...
export const yichunHeilongjiangCityData: CityInsuranceData = {
  cityCode: '230700',
  cityName: '伊春市',
  provinceCode: '230000',
  provinceName: '黑龙江省',
  ...
  sourceDocs: [
    {
      ...
      title: '伊春市人民政府办公室关于印发伊春市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '伊政办规〔2022〕12号',
      issuingDept: ['伊春市人民政府办公室', '伊春市医疗保障局'],
      publishDate: '2022-12-16',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.yichun.gov.cn/zwgk/zcfg/202212/t20221221_1189234.html',
    ...
    {
      docId: 'yc-medical-insurance-policy-2023',
      title: '伊春市医疗保障局关于调整优化基本医疗保险有关待遇政策的通知',
      docNumber: '伊医保发〔2023〕17号',
      issuingDept: ['伊春市医疗保障局', '伊春市财政局'],
      publishDate: '2023-11-20',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.yichun.gov.cn/zwgk/zcfg/202311/t20231126_1289123.html',
  ...
  employee: {
    ...
    inpatient: {
      sourceDocId: 'yc-medical-insurance-policy-2023',
      annualCap: 500000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'yc-medical-insurance-policy-2023',
      filingChannels: ['国家医保服务平台APP', '全省事', '伊春医保微信公众号'],
