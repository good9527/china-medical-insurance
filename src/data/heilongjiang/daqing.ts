...
export const daqingCityData: CityInsuranceData = {
  cityCode: '230600',
  cityName: '大庆市',
  provinceCode: '230000',
  provinceName: '黑龙江省',
  hotline: '0459-12393',
  officialPortalUrl: 'http://ybj.daqing.gov.cn/',
  ...
  sourceDocs: [
    ...
    },
    {
      ...
      title: '大庆市医疗保障局关于进一步完善基本医疗保险待遇政策的通知',
      docNumber: '庆医保发〔2023〕18号',
      issuingDept: ['大庆市医疗保障局', '大庆市财政局'],
  ...
  employee: {
    ...
    remoteMedical: {
      sourceDocId: 'dq-medical-insurance-policy-2023',
      filingChannels: ['国家医保服务平台APP', '全省事', '大庆医保微信公众号'],
