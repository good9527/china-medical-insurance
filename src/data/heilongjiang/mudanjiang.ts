...
export const mudanjiangCityData: CityInsuranceData = {
  cityCode: '231000',
  cityName: '牡丹江市',
  provinceCode: '230000',
  provinceName: '黑龙江省',
  hotline: '0453-12393',
  officialPortalUrl: 'http://ybj.mdj.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'mdj-employee-outpatient-2022',
      title: '牡丹江市人民政府办公室关于印发牡丹江市建立健全职工基本医疗保险门诊共济保障机制实施方案的通知',
      docNumber: '牡政办规〔2022〕15号',
      issuingDept: ['牡丹江市人民政府办公室', '牡丹江市医疗保障局'],
    ...
    },
    {
      ...
      title: '牡丹江市医疗保障局关于进一步完善基本医疗保险待遇政策的通知',
      docNumber: '牡医保发〔2023〕18号',
      issuingDept: ['牡丹江市医疗保障局', '牡丹江市财政局'],
      publishDate: '2023-11-22',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.mdj.gov.cn/zwgk/zcfg/202311/t20231128_1294812.html',
  ...
  employee: {
    ...
    remoteMedical: {
      sourceDocId: 'mdj-medical-insurance-policy-2023',
      filingChannels: ['国家医保服务平台APP', '全省事', '牡丹江医保微信公众号'],
