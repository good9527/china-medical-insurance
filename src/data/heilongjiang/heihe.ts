...
export const heiheCityData: CityInsuranceData = {
  cityCode: '231100',
  cityName: '黑河市',
  provinceCode: '230000',
  provinceName: '黑龙江省',
  hotline: '0456-12393',
  officialPortalUrl: 'http://ybj.heihe.gov.cn/',
  ...
  sourceDocs: [
    {
      ...
      title: '黑河市人民政府办公室关于印发黑河市建立健全职工基本医疗保险门诊共济保障机制实施方案的通知',
      docNumber: '黑市政办规〔2022〕13号',
      issuingDept: ['黑河市人民政府办公室', '黑河市医疗保障局'],
      publishDate: '2022-12-16',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.heihe.gov.cn/zwgk/zcfg/202212/t20221221_1189234.html',
      summaryQuote: '在职职工门诊年度起付标准400元。一级及以下机构统筹支付70%、二级机构60%、三级机构50%；退休人员支付比例分别提高5个百分点（一级75%、二级65%、三级55%）。门诊统筹年度最高支付限额在职及退休职工均为2000元。'
    },
    {
      docId: 'hh-medical-insurance-policy-2023',
      title: '黑河市医疗保障局关于进一步完善基本医疗保险待遇政策的通知',
      docNumber: '黑市医保发〔2023〕17号',
      issuingDept: ['黑河市医疗保障局', '黑河市财政局'],
  ...
  employee: {
    ...
    inpatient: {
      sourceDocId: 'hh-medical-insurance-policy-2023',
      annualCap: 500000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'hh-medical-insurance-policy-2023',
      filingChannels: ['国家医保服务平台APP', '全省事', '黑河医保微信公众号'],
