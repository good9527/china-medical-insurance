...
export const qitaiheCityData: CityInsuranceData = {
  cityCode: '230900',
  cityName: '七台河市',
  provinceCode: '230000',
  provinceName: '黑龙江省',
  hotline: '0464-12393',
  officialPortalUrl: 'http://ybj.qth.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'qth-employee-outpatient-2022',
      title: '七台河市人民政府办公室关于印发七台河市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '七政办规〔2022〕13号',
      issuingDept: ['七台河市人民政府办公室', '七台河市医疗保障局'],
      publishDate: '2022-12-16',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.qth.gov.cn/zwgk/zcfg/202212/t20221221_1189234.html',
    ...
    {
      docId: 'qth-medical-insurance-policy-2023',
      title: '七台河市医疗保障局关于进一步完善基本医疗保险待遇政策的通知',
      docNumber: '七医保发〔2023〕16号',
      issuingDept: ['七台河市医疗保障局', '七台河市财政局'],
  ...
  employee: {
    outpatient: {
      sourceDocId: 'qth-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'qth-medical-insurance-policy-2023',
      annualCap: 500000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'qth-medical-insurance-policy-2023',
      filingChannels: ['国家医保服务平台APP', '全省事', '七台河医保微信公众号'],
