...
export const daxinganlingCityData: CityInsuranceData = {
  cityCode: '232700',
  cityName: '大兴安岭地区',
  provinceCode: '230000',
  provinceName: '黑龙江省',
  hotline: '0457-12393',
  officialPortalUrl: 'http://ybj.dxal.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'dxal-employee-outpatient-2022',
      title: '大兴安岭地区行政公署办公室关于印发大兴安岭地区建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '署办规〔2022〕12号',
      issuingDept: ['大兴安岭地区行政公署办公室', '大兴安岭地区医疗保障局'],
      publishDate: '2022-12-16',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.dxal.gov.cn/zwgk/zcfg/202212/t20221221_1189234.html',
    ...
    {
      docId: 'dxal-medical-insurance-policy-2023',
      title: '大兴安岭地区医疗保障局关于进一步完善基本医疗保险待遇政策的通知',
      docNumber: '署医保发〔2023〕15号',
      issuingDept: ['大兴安岭地区医疗保障局', '大兴安岭地区财政局'],
      publishDate: '2023-11-20',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.dxal.gov.cn/zwgk/zcfg/202311/t20231126_1289123.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'dxal-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'dxal-medical-insurance-policy-2023',
      annualCap: 500000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'dxal-medical-insurance-policy-2023',
      filingChannels: ['国家医保服务平台APP', '全省事', '大兴安岭医保微信公众号'],
