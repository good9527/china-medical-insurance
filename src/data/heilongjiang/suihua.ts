...
export const suiHuaCityData: CityInsuranceData = {
  cityCode: '231200',
  cityName: '绥化市',
  provinceCode: '230000',
  provinceName: '黑龙江省',
  hotline: '0455-12393',
  officialPortalUrl: 'http://ybj.suihua.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'sh-employee-outpatient-2022',
      title: '绥化市人民政府办公室关于印发绥化市建立健全职工基本医疗保险门诊共济保障机制实施方案的通知',
      docNumber: '绥政办规〔2022〕15号',
      issuingDept: ['绥化市人民政府办公室', '绥化市医疗保障局'],
      publishDate: '2022-12-16',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.suihua.gov.cn/zwgk/zcfg/202212/t20221221_1189234.html',
      summaryQuote: '在职职工门诊年度起付标准400元。一级及以下机构统筹支付70%、二级机构60%、三级机构50%；退休人员支付比例分别提高5个百分点（一级75%、二级65%、三级55%）。门诊统筹年度最高支付限额在职及退休职工均为2000元。'
    },
    {
      docId: 'sh-medical-insurance-policy-2023',
      title: '绥化市医疗保障局关于进一步完善基本医疗保险待遇政策的通知',
      docNumber: '绥医保发〔2023〕18号',
      issuingDept: ['绥化市医疗保障局', '绥化市财政局'],
      publishDate: '2023-11-20',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.suihua.gov.cn/zwgk/zcfg/202311/t20231126_1289123.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'sh-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'sh-medical-insurance-policy-2023',
      annualCap: 500000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'sh-medical-insurance-policy-2023',
      filingChannels: ['国家医保服务平台APP', '全省事', '绥化医保微信公众号'],
