...
export const jiamusiCityData: CityInsuranceData = {
  cityCode: '230800',
  cityName: '佳木斯市',
  provinceCode: '230000',
  provinceName: '黑龙江省',
  hotline: '0454-12393',
  officialPortalUrl: 'http://ybj.jms.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'jms-employee-outpatient-2022',
      title: '佳木斯市人民政府办公室关于印发佳木斯市建立健全职工基本医疗保险门诊共济保障机制实施方案的通知',
      docNumber: '佳政办规〔2022〕19号',
      issuingDept: ['佳木斯市人民政府办公室', '佳木斯市医疗保障局'],
    ...
    },
    {
      ...
      title: '佳木斯市医疗保障局关于进一步完善基本医疗保险待遇政策的通知',
      docNumber: '佳医保发〔2023〕16号',
      issuingDept: ['佳木斯市医疗保障局', '佳木斯市财政局'],
  ...
  employee: {
    ...
    remoteMedical: {
      sourceDocId: 'jms-medical-insurance-policy-2023',
      filingChannels: ['国家医保服务平台APP', '全省事', '佳木斯医保微信公众号'],
