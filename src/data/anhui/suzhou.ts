...
export const suzhouAnhuiData: CityInsuranceData = {
  cityCode: '341300',
  cityName: '宿州市',
  provinceCode: '340000',
  provinceName: '安徽省',
  hotline: '0557-12393',
  officialPortalUrl: 'http://ybj.ahsz.gov.cn/',
  ...
  sourceDocs: [
    {
      ...
      title: '宿州市建立健全职工基本医疗保险门诊共济保障机制实施细则',
      docNumber: '宿医保发〔2022〕16号',
      issuingDept: ['宿州市医疗保障局', '宿州市财政局'],
      publishDate: '2022-06-25',
      effectiveDate: '2022-07-01',
      status: 'active',
      officialUrl: 'http://ybj.ahsz.gov.cn/zcfg/zcjd/6129301.html',
    ...
    {
      docId: 'sz-resident-employee-inpatient-2023',
      title: '宿州市基本医疗保险住院及门诊保障待遇实施细则通知',
      docNumber: '宿医保发〔2023〕18号',
      issuingDept: ['宿州市医疗保障局', '宿州市财政局'],
      publishDate: '2023-05-18',
      effectiveDate: '2023-06-01',
      status: 'active',
      officialUrl: 'http://ybj.ahsz.gov.cn/zcfg/gfxwj/6184920.html',
  ...
  employee: {
    ...
    inpatient: {
      sourceDocId: 'sz-resident-employee-inpatient-2023',
    ...
    remoteMedical: {
      ...
      specialNotes: [
        '长三角区域异地就医免备案直接结算，享受宿州本地同等医保报销待遇。'
      ]
    }
  },
