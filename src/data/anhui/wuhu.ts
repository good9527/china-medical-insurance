...
export const wuhuData: CityInsuranceData = {
  cityCode: '340200',
  cityName: '芜湖市',
  provinceCode: '340000',
  provinceName: '安徽省',
  hotline: '0553-12393',
  officialPortalUrl: 'http://ybj.wuhu.gov.cn/',
  ...
  sourceDocs: [
    {
      ...
      title: '芜湖市建立健全职工基本医疗保险门诊共济保障机制实施方案',
      docNumber: '芜医保〔2022〕46号',
    ...
    },
    {
      ...
      title: '芜湖市基本医疗保险待遇保障实施方案及2024年度保障标准通知',
      docNumber: '芜医保发〔2023〕16号',
      issuingDept: ['芜湖市医疗保障局', '芜湖市财政局'],
  ...
  employee: {
    ...
    remoteMedical: {
      ...
      specialNotes: [
        '长三角区域异地就医免备案直接结算，享受与本地同等医保报销待遇。'
      ]
    }
  },
