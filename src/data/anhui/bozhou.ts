...
export const bozhouData: CityInsuranceData = {
  cityCode: '341600',
  cityName: '亳州市',
  provinceCode: '340000',
  provinceName: '安徽省',
  hotline: '0558-12393',
  officialPortalUrl: 'http://ybj.bozhou.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'bz-employee-outpatient-2022',
      title: '亳州市建立健全职工基本医疗保险门诊共济保障机制实施细则',
      docNumber: '亳医保发〔2022〕15号',
      issuingDept: ['亳州市医疗保障局', '亳州市财政局'],
      publishDate: '2022-06-25',
      effectiveDate: '2022-07-01',
      status: 'active',
      officialUrl: 'http://ybj.bozhou.gov.cn/zcfg/zcjd/5129301.html',
      summaryQuote: '普通门诊统筹起付标准：一级及未定级医疗机构200元，二级及三级医疗机构400元。起付线以上统筹基金支付比例：在职职工一级60%、二级及三级50%；退休人员一级70%、二级及三级60%。年度最高支付限额在职职工2000元，退休人员3000元。'
    },
    {
      docId: 'bz-resident-employee-inpatient-2023',
      title: '亳州市基本医疗保险住院及门诊保障待遇实施方案通知',
      docNumber: '亳医保发〔2023〕18号',
      issuingDept: ['亳州市医疗保障局', '亳州市财政局'],
      publishDate: '2023-05-18',
      effectiveDate: '2023-06-01',
      status: 'active',
      officialUrl: 'http://ybj.bozhou.gov.cn/zcfg/gfxwj/5184920.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'bz-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'bz-resident-employee-inpatient-2023',
    ...
    remoteMedical: {
      ...
      specialNotes: [
        '长三角区域异地就医免备案直接结算，享受亳州本地同等医保报销待遇。'
      ]
    }
  },
