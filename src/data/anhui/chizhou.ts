...
export const chizhouData: CityInsuranceData = {
  cityCode: '341700',
  cityName: '池州市',
  provinceCode: '340000',
  provinceName: '安徽省',
  hotline: '0566-12393',
  officialPortalUrl: 'http://ybj.chizhou.gov.cn/',
  ...
  sourceDocs: [
    {
      ...
      title: '池州市建立健全职工基本医疗保险门诊共济保障机制实施细则',
      docNumber: '池医保发〔2022〕16号',
      issuingDept: ['池州市医疗保障局', '池州市财政局'],
      publishDate: '2022-06-25',
      effectiveDate: '2022-07-01',
      status: 'active',
      officialUrl: 'http://ybj.chizhou.gov.cn/zcfg/zcjd/7123901.html',
    ...
    },
    {
      ...
      title: '池州市基本医疗保险住院及门诊保障待遇实施方案通知',
      docNumber: '池医保发〔2023〕14号',
      issuingDept: ['池州市医疗保障局', '池州市财政局'],
  ...
  employee: {
    ...
    remoteMedical: {
      ...
      specialNotes: [
        '长三角区域异地就医免备案直接结算，享受池州本地同等医保报销待遇。'
      ]
    }
  },
