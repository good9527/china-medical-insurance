...
export const anqingData: CityInsuranceData = {
  cityCode: '340800',
  cityName: '安庆市',
  provinceCode: '340000',
  provinceName: '安徽省',
  hotline: '0556-12393',
  officialPortalUrl: 'http://ybj.anqing.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'aq-employee-outpatient-2022',
      title: '安庆市建立健全职工基本医疗保险门诊共济保障机制实施细则及优化待遇通知',
      docNumber: '宜医保发〔2022〕19号',
      issuingDept: ['安庆市医疗保障局', '安庆市财政局'],
      publishDate: '2022-06-26',
      effectiveDate: '2022-07-01',
      status: 'active',
      officialUrl: 'http://ybj.anqing.gov.cn/zcfg/zcjd/5182931.html',
      summaryQuote: '门诊统筹起付标准：一级及未定级定点医疗机构200元，二级及三级医疗机构400元。起付线以上统筹基金支付比例：在职职工一级60%、二级及三级50%；退休人员一级70%、二级及三级60%。年度最高支付限额在职职工2000元，退休人员3000元。定点药店购药起付与比例参照一级执行。'
    },
    {
      docId: 'aq-resident-employee-inpatient-2023',
      title: '安庆市基本医疗保险住院待遇保障实施办法及2024年度保障标准通知',
      docNumber: '宜医保发〔2023〕15号',
      issuingDept: ['安庆市医疗保障局', '安庆市财政局'],
      publishDate: '2023-05-12',
      effectiveDate: '2023-06-01',
      status: 'active',
      officialUrl: 'http://ybj.anqing.gov.cn/zcfg/gfxwj/5210943.html',
      summaryQuote: '居民基层门诊免起付线，报销50%，年度限额150元。居民住院起付线一级200元、二级500元、三级800元，支付比例对应85%、80%、70%，限额30万元。职工住院起付线一级200元、二级400元、三级600元，在职报销94%、92%、90%，退休提高3个百分点，职工医保统筹限额30万元，大病救助最高支付50万元。'
    }
  ],
  ...
  employee: {
    outpatient: {
      sourceDocId: 'aq-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'aq-resident-employee-inpatient-2023',
    ...
    remoteMedical: {
      ...
      specialNotes: [
        '长三角区域异地就医免备案直接结算，享受安庆本地同等医保报销待遇。'
      ]
    }
  },
