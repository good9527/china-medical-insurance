...
export const huaibeiData: CityInsuranceData = {
  cityCode: '340600',
  cityName: '淮北市',
  provinceCode: '340000',
  provinceName: '安徽省',
  hotline: '0561-12393',
  officialPortalUrl: 'http://ybj.huaibei.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'hb-employee-outpatient-2022',
      title: '淮北市建立健全职工基本医疗保险门诊共济保障机制实施方案',
      docNumber: '淮医保发〔2022〕14号',
      issuingDept: ['淮北市医疗保障局', '淮北市财政局'],
      publishDate: '2022-06-25',
      effectiveDate: '2022-07-01',
      status: 'active',
      officialUrl: 'http://ybj.huaibei.gov.cn/zcfg/zcjd/7123901.html',
      summaryQuote: '普通门诊统筹起付标准为一级及以下200元、二级及三级400元。起付线以上统筹基金支付比例：一级定点医疗机构60%、二级定点医疗机构55%、三级定点医疗机构50%；退休人员支付比例分别提高5个百分点。年度统筹基金最高支付限额在职职工2000元，退休人员3000元。'
    },
    {
      docId: 'hb-resident-employee-inpatient-2023',
      title: '淮北市基本医疗保险住院及门诊待遇保障细则通知',
      docNumber: '淮医保发〔2023〕18号',
      issuingDept: ['淮北市医疗保障局', '淮北市财政局'],
      publishDate: '2023-05-18',
      effectiveDate: '2023-06-01',
      status: 'active',
      officialUrl: 'http://ybj.huaibei.gov.cn/zcfg/gfxwj/7184920.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'hb-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'hb-resident-employee-inpatient-2023',
    ...
    remoteMedical: {
      ...
      specialNotes: [
        '长三角区域异地就医免备案直接结算，享受淮北本地同等医保报销待遇。'
      ]
    }
  },
