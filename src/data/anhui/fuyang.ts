...
export const fuyangData: CityInsuranceData = {
  cityCode: '341200',
  cityName: '阜阳市',
  provinceCode: '340000',
  provinceName: '安徽省',
  hotline: '0558-12393',
  officialPortalUrl: 'http://ybj.fy.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'fy-employee-outpatient-2022',
      title: '阜阳市建立健全职工基本医疗保险门诊共济保障机制实施方案',
      docNumber: '阜医保发〔2022〕18号',
      issuingDept: ['阜阳市医疗保障局', '阜阳市财政局'],
      publishDate: '2022-06-25',
      effectiveDate: '2022-07-01',
      status: 'active',
      officialUrl: 'http://ybj.fy.gov.cn/zcfg/zcjd/8123901.html',
      summaryQuote: '普通门诊统筹起付标准：一级及以下医疗机构200元，二级及三级医疗机构400元。起付线以上支付比例：在职职工一级60%、二级及三级50%；退休人员支付比例分别提高5个百分点。年度最高支付限额在职职工2000元，退休人员3000元。'
    },
    {
      docId: 'fy-resident-employee-inpatient-2023',
      title: '阜阳市基本医疗保险住院待遇保障实施细则及门诊保障通知',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'fy-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'fy-resident-employee-inpatient-2023',
    ...
    remoteMedical: {
      ...
      specialNotes: [
        '长三角区域异地就医免备案直接结算，享受阜阳本地同等医保报销待遇。'
      ]
    }
  },
  ...
  resident: {
    outpatient: {
      sourceDocId: 'fy-resident-employee-inpatient-2023',
      annualCap: 250, // 依据皖医保发〔2024〕9号，普通门诊统筹年度限额250元
      tierBenefits: {
      ...
      note: '依据皖医保发〔2024〕9号，居民普通门诊统筹在基层及一级定点医疗机构免起付线报销60%，年度限额250元。二级及以上医疗机构未纳普通门诊统筹。'
    },
    inpatient: {
      sourceDocId: 'fy-resident-employee-inpatient-2023',
