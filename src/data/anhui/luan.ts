...
export const luanData: CityInsuranceData = {
  cityCode: '341500',
  cityName: '六安市',
  provinceCode: '340000',
  provinceName: '安徽省',
  hotline: '0564-12393',
  officialPortalUrl: 'http://ybj.luan.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'la-employee-outpatient-2022',
      title: '六安市建立健全职工基本医疗保险门诊共济保障机制实施细则',
      docNumber: '六医保秘〔2022〕26号',
      issuingDept: ['六安市医疗保障局', '六安市财政局'],
      publishDate: '2022-06-28',
      effectiveDate: '2022-07-01',
      status: 'active',
      officialUrl: 'http://ybj.luan.gov.cn/zcfg/zcjd/5812930.html',
      summaryQuote: '普通门诊统筹起付标准为一级及以下200元、二级及三级400元。起付线以上统筹支付比例：在职职工一级60%、二级55%、三级50%；退休人员支付比例分别提高5个百分点。年度最高支付限额在职职工2000元，退休人员3000元。'
    },
    {
      docId: 'la-resident-employee-inpatient-2023',
      title: '六安市基本医疗保险待遇保障实施细则及年度待遇标准通知',
      docNumber: '六医保发〔2023〕18号',
      issuingDept: ['六安市医疗保障局', '六安市财政局'],
  ...
  employee: {
    outpatient: {
      sourceDocId: 'la-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'la-resident-employee-inpatient-2023',
    ...
    remoteMedical: {
      ...
      specialNotes: [
        '长三角区域异地就医免备案直接结算，享受六安本地同等医保报销待遇。'
      ]
    }
  },
