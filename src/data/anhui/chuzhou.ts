...
export const chuzhouData: CityInsuranceData = {
  cityCode: '341100',
  cityName: '滁州市',
  provinceCode: '340000',
  provinceName: '安徽省',
  hotline: '0550-12393',
  officialPortalUrl: 'http://ybj.chuzhou.gov.cn/',
  ...
  sourceDocs: [
    {
      ...
      title: '滁州市建立健全职工基本医疗保险门诊共济保障机制实施细则',
      docNumber: '滁医保发〔2022〕17号',
      issuingDept: ['滁州市医疗保障局', '滁州市财政局'],
      publishDate: '2022-06-25',
      effectiveDate: '2022-07-01',
      status: 'active',
      officialUrl: 'http://ybj.chuzhou.gov.cn/zcfg/zcjd/5129301.html',
      summaryQuote: '普通门诊统筹起付标准：一级及未定级医疗机构200元，二级及三级医疗机构400元。起付线以上支付比例：在职职工一级60%、二级及三级50%；退休人员一级70%、二级及三级60%。年度最高支付限额在职职工2000元，退休人员3000元。'
    },
    {
      docId: 'cz-resident-employee-inpatient-2023',
      title: '滁州市基本医疗保险住院及门诊待遇保障实施细则通知',
      docNumber: '滁医保发〔2023〕19号',
      issuingDept: ['滁州市医疗保障局', '滁州市财政局'],
  ...
  employee: {
    ...
    inpatient: {
      ...
      tierBenefits: {
        community: { tierName: '基层社区及一级医疗机构', deductible: 400, reimbursementRatio: 0.94, retireeRatioBonus: 0.03 },
        tier1: { tierName: '一级定点医疗机构', deductible: 400, reimbursementRatio: 0.94, retireeRatioBonus: 0.03 },
        tier2: { tierName: '二级定点医疗机构', deductible: 600, reimbursementRatio: 0.92, retireeRatioBonus: 0.03 },
        tier3: { tierName: '市属三级定点医院', deductible: 900, reimbursementRatio: 0.90, retireeRatioBonus: 0.03 },
        tier3_top: { tierName: '省属三级重点医院', deductible: 1100, reimbursementRatio: 0.88, retireeRatioBonus: 0.03 }
      },
    ...
    remoteMedical: {
      ...
      specialNotes: [
        '长三角区域及南京都市圈免备案直接结算，享受与滁州同等报销待遇。'
      ]
    }
  },
