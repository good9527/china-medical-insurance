...
export const bengbuData: CityInsuranceData = {
  cityCode: '340300',
  cityName: '蚌埠市',
  provinceCode: '340000',
  provinceName: '安徽省',
  hotline: '0552-12393',
  officialPortalUrl: 'http://ybj.bengbu.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'bb-employee-outpatient-2022',
      title: '蚌埠市职工基本医疗保险门诊共济保障实施细则及优化待遇通知',
      docNumber: '蚌医保发〔2022〕12号',
      issuingDept: ['蚌埠市医疗保障局', '蚌埠市财政局'],
    ...
    },
    {
      ...
      title: '蚌埠市基本医疗保险待遇保障实施细则及2024年度保障标准通知',
      docNumber: '蚌医保发〔2023〕15号',
      issuingDept: ['蚌埠市医疗保障局', '蚌埠市财政局'],
      publishDate: '2023-05-18',
      effectiveDate: '2023-06-01',
      status: 'active',
      officialUrl: 'http://ybj.bengbu.gov.cn/zcfg/gfxwj/7891042.html',
      summaryQuote: '居民基层普通门诊免起付线，报销60%，限额180元。居民住院起付线一级200元、二级500元、三级800元，支付比例对应85%、80%、70%，限额30万元。职工住院起付线一级200元、二级400元、三级600元，在职报销94%、92%、90%，退休提高3个百分点，职工医保限额30万元，大病救助最高支付50万元。'
    }
  ],
  ...
  employee: {
    outpatient: {
      sourceDocId: 'bb-employee-outpatient-2022',
    ...
    remoteMedical: {
      ...
      specialNotes: [
        '长三角区域异地就医免备案直接结算，享受蚌埠本地同等医保报销待遇。'
      ]
    }
  },
  ...
  resident: {
    outpatient: {
      sourceDocId: 'bb-resident-employee-inpatient-2023',
      annualCap: 180, // 依据皖医保发〔2024〕9号，普通门诊统筹年度限额180元
      tierBenefits: {
      ...
      note: '依据皖医保发〔2024〕9号，居民普通门诊统筹在基层及一级定点医疗机构免起付线报销60%，年度限额180元。二级及以上医疗机构未纳普通门诊统筹。'
    },
    inpatient: {
      sourceDocId: 'bb-resident-employee-inpatient-2023',
