...
/**
 * 湘潭市基本医疗保险政策数据与官方文件溯源库
 * 数据基准年度：2025-2026年（现行有效）
 * 统筹区编码：430300
 */
export const xiangtanCityData: CityInsuranceData = {
  cityCode: '430300',
  cityName: '湘潭市',
  provinceCode: '430000',
  provinceName: '湖南省',
  ...
  sourceDocs: [
    {
      ...
      title: '关于印发湘潭市职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '潭政办发〔2022〕36号',
      issuingDept: ['湘潭市人民政府办公室', '湘潭市医疗保障局'],
      publishDate: '2022-09-20',
      effectiveDate: '2022-10-01',
      status: 'active',
      officialUrl: 'http://ybj.xiangtan.gov.cn/zwgk/zcfg/202209/t20220925_1092834.html',
      summaryQuote: '潭政办发〔2022〕36号明确：在职职工门诊统筹年度最高支付限额1500元，退休人员2000元。一级及基层定点医疗卫生机构不设起付标准，统筹基金支付比例70%；二级定点医疗机构起付线200元，支付比例60%；三级定点医疗机构起付线300元，支付比例60%。一个自然年度内起付标准累计不超过300元，退休人员统筹支付比例提高5个百分点。'
    },
    {
      docId: 'xt-inpatient-regulations-2023',
      title: '湘潭市基本医疗保险和生育保险住院待遇实施办法',
      docNumber: '潭医保发〔2023〕16号',
      issuingDept: ['湘潭市医疗保障局', '湘潭市财政局'],
  ...
  employee: {
    ...
    remoteMedical: {
      sourceDocId: 'xt-inpatient-regulations-2023',
      filingChannels: ['国家医保服务平台APP', '湘医保小程序', '湘潭医保公众号'],
      longTermFiledRatio: 1.0,
      transferFiledRatio: 0.90,
      unfiledEmergencyRatio: 0.85,
      unfiledNormalRatio: 0.70,
      specialNotes: [
        '长株潭都市圈内异地就医直接结算，符合转诊备案人员享受参保地同等待遇。'
      ]
    }
  },
