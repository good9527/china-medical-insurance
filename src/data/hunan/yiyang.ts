...
/**
 * 益阳市基本医疗保险政策数据与官方文件溯源库
 * 数据基准年度：2025-2026年（现行有效）
 * 统筹区编码：430900
 */
export const yiyangCityData: CityInsuranceData = {
  cityCode: '430900',
  cityName: '益阳市',
  provinceCode: '430000',
  provinceName: '湖南省',
  ...
  sourceDocs: [
    {
      docId: 'yy-employee-outpatient-2022',
      title: '关于印发益阳市职工基本医疗保险门诊共济保障实施细则的通知',
      docNumber: '益政办发〔2022〕20号',
      issuingDept: ['益阳市人民政府办公室', '益阳市医疗保障局'],
      publishDate: '2022-09-08',
      effectiveDate: '2022-12-01',
      status: 'active',
      officialUrl: 'http://ybj.yiyang.gov.cn/zwgk/zcfg/202209/t20220915_928190.html',
      summaryQuote: '益政办发〔2022〕20号明确：普通门诊统筹年度最高支付限额在职职工1500元、退休人员2000元。一级医疗机构及基层卫生服务中心不设起付标准，统筹基金支付比例70%；二级定点医疗机构起付标准200元，支付比例60%；三级定点医疗机构起付标准300元，支付比例60%。年度累计起付标准不超过300元，退休人员支付比例上浮5%。'
    },
    {
      docId: 'yy-inpatient-regulations-2023',
      title: '益阳市基本医疗保险住院与医疗救助统筹实施细则',
      docNumber: '益医保发〔2023〕17号',
      issuingDept: ['益阳市医疗保障局', '益阳市财政局'],
      publishDate: '2023-11-20',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.yiyang.gov.cn/zwgk/zcjd/202311/t20231128_948210.html',
      summaryQuote: '住院起付标准：基层机构200元、一级500元、二级800元、三级1100元、省部属2000元。职工医保统筹支付比例基层93%、一级92%、二级90%、三级85%、省部属80%（退休人员增加2%）。城乡居民医保住院起付标准基层200元、一级500元、二级800元、三级1200元、省部属2000元，统筹支付比例分别为85%、82%、80%、65%、60%。同级别第二次及以上住院起付标准减半。职工统筹年度最高支付限额15万元。'
    }
  ],
  ...
  employee: {
    outpatient: {
      sourceDocId: 'yy-employee-outpatient-2022',
    ...
    remoteMedical: {
      sourceDocId: 'yy-inpatient-regulations-2023',
      filingChannels: ['国家医保服务平台APP', '湘医保小程序', '益阳医保公众号'],
