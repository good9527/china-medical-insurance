...
/**
 * 张家界市基本医疗保险政策数据与官方文件溯源库
 * 数据基准年度：2025-2026年（现行有效）
 * 统筹区编码：430800
 */
export const zhangjiajieCityData: CityInsuranceData = {
  cityCode: '430800',
  cityName: '张家界市',
  provinceCode: '430000',
  provinceName: '湖南省',
  ...
  sourceDocs: [
    {
      docId: 'zjj-employee-outpatient-2022',
      title: '关于印发张家界市职工基本医疗保险门诊共济保障实施细则（试行）的通知',
      docNumber: '张政办发〔2022〕19号',
      issuingDept: ['张家界市人民政府办公室', '张家界市医疗保障局'],
      publishDate: '2022-08-31',
      effectiveDate: '2022-12-01',
      status: 'active',
      officialUrl: 'http://ybj.zjj.gov.cn/c672/20220905/i198210.html',
      summaryQuote: '张政办发〔2022〕19号明确：在职职工普通门诊统筹年度最高支付限额1500元、退休人员2000元。一级及基层定点医疗卫生机构不设起付标准，统筹基金支付比例70%；二级定点医疗机构起付标准200元，支付比例60%；三级定点医疗机构起付标准300元，支付比例60%。年度累计起付标准不超过300元，退休人员支付比例上浮5%。'
    },
    {
      docId: 'zjj-inpatient-regulations-2023',
      title: '张家界市基本医疗保险住院统筹待遇实施办法',
      docNumber: '张医保发〔2023〕16号',
      issuingDept: ['张家界市医疗保障局', '张家界市财政局'],
  ...
  employee: {
    outpatient: {
      sourceDocId: 'zjj-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'zjj-inpatient-regulations-2023',
      annualCap: 150000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'zjj-inpatient-regulations-2023',
      filingChannels: ['国家医保服务平台APP', '湘医保小程序', '张家界医保公众号'],
