...
/**
 * 永州市基本医疗保险政策数据与官方文件溯源库
 * 数据基准年度：2025-2026年（现行有效）
 * 统筹区编码：431100
 */
export const yongzhouCityData: CityInsuranceData = {
  cityCode: '431100',
  cityName: '永州市',
  provinceCode: '430000',
  provinceName: '湖南省',
  ...
  sourceDocs: [
    {
      docId: 'yz-employee-outpatient-2022',
      title: '关于印发永州市职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '永政办发〔2022〕16号',
      issuingDept: ['永州市人民政府办公室', '永州市医疗保障局'],
      publishDate: '2022-08-25',
      effectiveDate: '2022-10-01',
      status: 'active',
      officialUrl: 'http://ybj.yzcity.gov.cn/zwgk/zcfg/202208/t20220830_172931.html',
      summaryQuote: '永政办发〔2022〕16号明确：在职职工普通门诊统筹年度最高支付限额1500元、退休人员2000元。一级及基层定点医疗卫生机构不设起付标准，统筹基金支付比例70%；二级定点医疗机构起付标准200元，支付比例60%；三级定点医疗机构起付标准300元，支付比例60%。一个结算年度内起付标准金额累计不超过300元，退休人员支付比例上浮5%。'
    },
    {
      docId: 'yz-inpatient-regulations-2023',
      title: '永州市基本医疗保险和生育保险住院待遇统筹实施细则',
      docNumber: '永医保发〔2023〕19号',
      issuingDept: ['永州市医疗保障局', '永州市财政局'],
  ...
  employee: {
    outpatient: {
      sourceDocId: 'yz-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'yz-inpatient-regulations-2023',
      annualCap: 150000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'yz-inpatient-regulations-2023',
      filingChannels: ['国家医保服务平台APP', '湘医保小程序', '永州医保公众号'],
