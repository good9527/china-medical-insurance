...
/**
 * 娄底市基本医疗保险政策数据与官方文件溯源库
 * 数据基准年度：2025-2026年（现行有效）
 * 统筹区编码：431300
 */
export const loudiCityData: CityInsuranceData = {
  cityCode: '431300',
  cityName: '娄底市',
  provinceCode: '430000',
  provinceName: '湖南省',
  ...
  sourceDocs: [
    {
      docId: 'ld-employee-outpatient-2022',
      title: '关于印发娄底市职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '娄政办发〔2022〕16号',
      issuingDept: ['娄底市人民政府办公室', '娄底市医疗保障局'],
      publishDate: '2022-08-25',
      effectiveDate: '2022-10-01',
      status: 'active',
      officialUrl: 'http://ybj.hnloudi.gov.cn/zwgk/zcfg/202208/t20220829_182931.html',
      summaryQuote: '娄政办发〔2022〕16号明确：普通门诊统筹年度最高支付限额在职职工1500元、退休人员2000元。一级医疗机构及基层卫生服务机构不设起付标准，统筹基金支付比例70%；二级定点医疗机构起付标准200元，支付比例60%；三级定点医疗机构起付标准300元，支付比例60%。年度累计起付标准不超过300元，退休人员支付比例上浮5%。'
    },
    {
      docId: 'ld-inpatient-regulations-2023',
      title: '娄底市基本医疗保险住院与医疗救助统筹管理规程',
      docNumber: '娄医保发〔2023〕18号',
      issuingDept: ['娄底市医疗保障局', '娄底市财政局'],
  ...
  employee: {
    outpatient: {
      sourceDocId: 'ld-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'ld-inpatient-regulations-2023',
      annualCap: 150000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'ld-inpatient-regulations-2023',
      filingChannels: ['国家医保服务平台APP', '湘医保小程序', '娄底医保公众号'],
