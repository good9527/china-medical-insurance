...
/**
 * 常德市基本医疗保险政策数据与官方文件溯源库
 * 数据基准年度：2025-2026年（现行有效）
 * 统筹区编码：430700
 */
export const changdeCityData: CityInsuranceData = {
  cityCode: '430700',
  cityName: '常德市',
  provinceCode: '430000',
  provinceName: '湖南省',
  ...
  sourceDocs: [
    {
      ...
      title: '常德市人民政府办公室关于印发常德市职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '常政办发〔2022〕21号',
      issuingDept: ['常德市人民政府办公室', '常德市医疗保障局'],
      publishDate: '2022-08-29',
      effectiveDate: '2022-10-01',
      status: 'active',
      officialUrl: 'http://ybj.changde.gov.cn/zwgk/zcfg/202208/t20220831_1829310.html',
      summaryQuote: '常政办发〔2022〕21号明确：普通门诊统筹年度最高支付限额在职职工1500元、退休人员2000元。一级医疗机构及基层卫生机构不设起付标准，统筹支付比例70%；二级医疗机构起付标准200元，支付比例60%；三级医疗机构起付标准300元，支付比例60%。一个自然年度内起付标准累计不超过300元，退休人员支付比例上浮5%。'
    },
    {
      docId: 'cd-inpatient-regulations-2023',
      title: '常德市基本医疗保险和生育保险住院统筹待遇实施细则',
      docNumber: '常医保发〔2023〕18号',
      issuingDept: ['常德市医疗保障局', '常德市财政局'],
  ...
  employee: {
    ...
    inpatient: {
      sourceDocId: 'cd-inpatient-regulations-2023',
      annualCap: 150000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'cd-inpatient-regulations-2023',
      filingChannels: ['国家医保服务平台APP', '湘医保小程序', '常德医保公众号'],
