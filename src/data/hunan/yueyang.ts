...
/**
 * 岳阳市基本医疗保险政策数据与官方文件溯源库
 * 数据基准年度：2025-2026年（现行有效）
 * 统筹区编码：430600
 */
export const yueyangCityData: CityInsuranceData = {
  cityCode: '430600',
  cityName: '岳阳市',
  provinceCode: '430000',
  provinceName: '湖南省',
  ...
  sourceDocs: [
    {
      ...
      title: '岳阳市人民政府办公室关于印发岳阳市职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '岳政办发〔2022〕28号',
      issuingDept: ['岳阳市人民政府办公室', '岳阳市医疗保障局'],
      publishDate: '2022-11-20',
      effectiveDate: '2022-12-01',
      status: 'active',
      officialUrl: 'http://ybj.yueyang.gov.cn/zwgk/zcfg/202211/t20221125_1729381.html',
      summaryQuote: '岳政办发〔2022〕28号规定：普通门诊统筹年度最高支付限额在职职工1500元、退休人员2000元。一级医疗机构及基层卫生机构不设起付标准，统筹基金支付比例70%；二级医疗机构起付标准200元，支付比例60%；三级医疗机构起付标准300元，支付比例60%。年度起付标准累计不超过300元，退休人员支付比例提高5个百分点。'
    },
    {
      docId: 'yy-inpatient-regulations-2023',
      title: '岳阳市基本医疗保险和生育保险市级统筹实施办法',
      docNumber: '岳医保发〔2023〕19号',
      issuingDept: ['岳阳市医疗保障局', '岳阳市财政局'],
  ...
  employee: {
    ...
    inpatient: {
      ...
      tierBenefits: {
        ...
        tier3_top: { tierName: '省部属重点医疗机构', deductible: 1600, reimbursementRatio: 0.80, retireeRatioBonus: 0.02 }
      },
    ...
    remoteMedical: {
      sourceDocId: 'yy-inpatient-regulations-2023',
      filingChannels: ['国家医保服务平台APP', '湘医保小程序', '岳阳医保公众号'],
      longTermFiledRatio: 1.0,
      transferFiledRatio: 0.90,
      unfiledEmergencyRatio: 0.85,
      unfiledNormalRatio: 0.70,
      specialNotes: [
        '跨省或省内异地就医直接结算，规范转诊备案享受同等报销待遇。'
      ]
    }
  },
  ...
  resident: {
    outpatient: {
      ...
      note: '依据湖南省门诊统筹政策，居民门诊在定点基层医疗机构免起付线报销70%，年度最高支付限额400元。二级及以上医疗机构普通门诊未纳入统筹。'
    },
    inpatient: {
      sourceDocId: 'yy-inpatient-regulations-2023',
      annualCap: 150000,
