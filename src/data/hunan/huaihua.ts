...
/**
 * 怀化市基本医疗保险政策数据与官方文件溯源库
 * 数据基准年度：2025-2026年（现行有效）
 * 统筹区编码：431200
 */
export const huaihuaCityData: CityInsuranceData = {
  cityCode: '431200',
  cityName: '怀化市',
  provinceCode: '430000',
  provinceName: '湖南省',
  ...
  sourceDocs: [
    {
      docId: 'hh-employee-outpatient-2022',
      title: '关于印发怀化市职工基本医疗保险门诊共济保障实施细则的通知',
      docNumber: '怀政办发〔2022〕26号',
      issuingDept: ['怀化市人民政府办公室', '怀化市医疗保障局'],
      publishDate: '2022-09-02',
      effectiveDate: '2022-10-01',
      status: 'active',
      officialUrl: 'http://ybj.huaihua.gov.cn/zwgk/zcfg/202209/t20220908_192831.html',
      summaryQuote: '怀政办发〔2022〕26号明确：在职职工门诊统筹年度最高支付限额1500元、退休人员2000元。一级医疗机构及基层卫生机构不设起付标准，统筹基金支付比例70%；二级定点医疗机构起付标准200元，支付比例60%；三级定点医疗机构起付标准300元，支付比例60%。年度累计起付标准不超过300元，退休人员支付比例上浮5%。'
    },
    {
      docId: 'hh-inpatient-regulations-2023',
      title: '怀化市基本医疗保险住院与医疗救助统筹管理办法',
      docNumber: '怀医保发〔2023〕20号',
      issuingDept: ['怀化市医疗保障局', '怀化市财政局'],
  ...
  employee: {
    outpatient: {
      sourceDocId: 'hh-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'hh-inpatient-regulations-2023',
      annualCap: 150000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'hh-inpatient-regulations-2023',
      filingChannels: ['国家医保服务平台APP', '湘医保小程序', '怀化医保公众号'],
