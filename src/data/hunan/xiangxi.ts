...
/**
 * 湘西土家族苗族自治州基本医疗保险政策数据与官方文件溯源库
 * 数据基准年度：2025-2026年（现行有效）
 * 统筹区编码：433100
 */
export const xiangxiCityData: CityInsuranceData = {
  cityCode: '433100',
  cityName: '湘西土家族苗族自治州',
  provinceCode: '430000',
  provinceName: '湖南省',
  ...
  sourceDocs: [
    {
      docId: 'xx-employee-outpatient-2022',
      title: '关于印发湘西自治州职工基本医疗保险门诊共济保障实施细则的通知',
      docNumber: '湘西州政办发〔2022〕13号',
      issuingDept: ['湘西土家族苗族自治州人民政府办公室', '湘西州医疗保障局'],
      publishDate: '2022-08-26',
      effectiveDate: '2022-12-01',
      status: 'active',
      officialUrl: 'http://ybj.xxz.gov.cn/zwgk/zcfg/202208/t20220830_182931.html',
      summaryQuote: '湘西州政办发〔2022〕13号规定：普通门诊统筹年度最高支付限额在职职工1500元、退休人员2000元。一级医疗机构及基层卫生服务中心不设起付标准，统筹基金支付比例70%；二级定点医疗机构起付标准200元，支付比例60%；三级定点医疗机构起付标准300元，支付比例60%。年度累计起付标准不超过300元，退休人员支付比例上浮5%。'
    },
    {
      docId: 'xx-inpatient-regulations-2023',
      title: '湘西自治州基本医疗保险住院与医疗救助统筹管理办法',
      docNumber: '湘西州医保发〔2023〕19号',
      issuingDept: ['湘西州医疗保障局', '湘西州财政局'],
      publishDate: '2023-11-20',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.xxz.gov.cn/zwgk/zcjd/202311/t20231128_192031.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'xx-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'xx-inpatient-regulations-2023',
      annualCap: 150000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'xx-inpatient-regulations-2023',
      filingChannels: ['国家医保服务平台APP', '湘医保小程序', '湘西医保公众号'],
  ...
  resident: {
    outpatient: {
      ...
      note: '依据湖南省门诊统筹政策，居民门诊在定点基层医疗机构免起付线报销70%，年度最高支付限额350元。二级及以上医疗机构普通门诊未纳入统筹。'
    },
    inpatient: {
      sourceDocId: 'xx-inpatient-regulations-2023',
      annualCap: 150000,
