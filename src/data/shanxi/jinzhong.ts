...
export const jinzhongCityData: CityInsuranceData = {
  cityCode: '140700',
  cityName: '晋中市',
  provinceCode: '140000',
  provinceName: '山西省',
  hotline: '0354-12393',
  officialPortalUrl: 'http://ybj.sxjz.gov.cn/',
  lastUpdated: '2026-03-01',

  sourceDocs: [
    {
      docId: 'jz-employee-outpatient-2022-52',
      title: '晋中市人民政府办公室关于印发晋中市职工基本医疗保险门诊共济保障机制实施办法的通知',
      docNumber: '晋中政办发〔2022〕52号',
      issuingDept: ['晋中市人民政府办公室', '晋中市医疗保障局'],
      publishDate: '2022-12-20',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.sxjz.gov.cn/zwgk/zcfg/202212/t20221223_273891.shtml',
      summaryQuote: '职工普通门诊按次起付标准：基层30元、二级50元、三级80元；支付比例基层65%（退休70%）、二级60%（退休65%）、三级55%（退休60%）；年度支付限额在职2500元，退休3000元。'
    },
    {
      docId: 'jz-medical-insurance-inpatient-2024',
      title: '晋中市基本医疗保险住院统筹待遇和异地就医管理实施细则',
      docNumber: '晋中医保发〔2024〕20号',
      issuingDept: ['晋中市医疗保障局', '晋中市财政局'],
      publishDate: '2024-06-25',
      effectiveDate: '2024-07-01',
      status: 'active',
      officialUrl: 'http://ybj.sxjz.gov.cn/zwgk/zcfg/202406/t20240628_291048.shtml',
      summaryQuote: '职工住院起付线：三类300元、二类500元、一类800元；在职支付比例三级83%、二级87%、一级91%（退休人员分别为92%、94%、96%），统筹基金封顶10万元，大额救助45万元（总额55万元）。居民住院起付线100元-1000元，报销比例60%-85%，统筹最高7万元，大病最高40万元。'
    }
  ],

  employee: {
    outpatient: {
      sourceDocId: 'jz-employee-outpatient-2022-52',
      annualDeductible: 80,
    ...
    inpatient: {
      sourceDocId: 'jz-medical-insurance-inpatient-2024',
      annualCap: 550000,
      tierBenefits: {
  ...
  resident: {
    ...
    remoteMedical: {
      ...
      specialNotes: ['跨省异地长期居住备案不降比例，规范转诊下调5%，未备案临时外出下调15%。']
    }
  }
};
