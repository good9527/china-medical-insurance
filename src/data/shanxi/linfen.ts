...
export const linfenCityData: CityInsuranceData = {
  cityCode: '141000',
  cityName: '临汾市',
  provinceCode: '140000',
  provinceName: '山西省',
  hotline: '0357-12393',
  officialPortalUrl: 'http://ybj.linfen.gov.cn/',
  lastUpdated: '2026-03-01',

  sourceDocs: [
    {
      docId: 'lf-employee-outpatient-2022-49',
      title: '临汾市人民政府办公室关于印发临汾市职工基本医疗保险门诊共济保障机制实施办法的通知',
      docNumber: '临政办发〔2022〕49号',
      issuingDept: ['临汾市人民政府办公室', '临汾市医疗保障局'],
      publishDate: '2022-12-25',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.linfen.gov.cn/zwgk/zcfg/202212/t20221228_210984.shtml',
      summaryQuote: '职工普通门诊按次起付标准：基层30元、二级50元、三级80元；支付比例基层65%（退休70%）、二级60%（退休65%）、三级55%（退休60%）；年度支付限额在职2500元，退休3000元。'
    },
    {
      docId: 'lf-medical-insurance-inpatient-2024',
      title: '临汾市基本医疗保险住院与大额医疗费用补助统筹管理办法',
      docNumber: '临医保发〔2024〕20号',
      issuingDept: ['临汾市医疗保障局', '临汾市财政局'],
      publishDate: '2024-06-26',
      effectiveDate: '2024-07-01',
      status: 'active',
      officialUrl: 'http://ybj.linfen.gov.cn/zwgk/zcfg/202406/t20240629_234891.shtml',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'lf-employee-outpatient-2022-49',
      annualDeductible: 80,
    ...
    inpatient: {
      sourceDocId: 'lf-medical-insurance-inpatient-2024',
      annualCap: 550000,
      tierBenefits: {
