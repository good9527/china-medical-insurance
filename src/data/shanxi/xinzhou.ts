...
export const xinzhouCityData: CityInsuranceData = {
  cityCode: '140900',
  cityName: '忻州市',
  provinceCode: '140000',
  provinceName: '山西省',
  hotline: '0350-12393',
  officialPortalUrl: 'http://ybj.sxxz.gov.cn/',
  lastUpdated: '2026-03-01',

  sourceDocs: [
    {
      docId: 'xz-employee-outpatient-2022-50',
      title: '忻州市人民政府办公室关于印发忻州市职工基本医疗保险门诊共济保障机制实施办法的通知',
      docNumber: '忻政办发〔2022〕50号',
      issuingDept: ['忻州市人民政府办公室', '忻州市医疗保障局'],
      publishDate: '2022-12-23',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.sxxz.gov.cn/zwgk/zcfg/202212/t20221226_219873.shtml',
      summaryQuote: '职工普通门诊按次起付标准：基层30元、二级50元、三级80元；支付比例基层65%（退休70%）、二级60%（退休65%）、三级55%（退休60%）；年度支付限额在职2500元，退休3000元。'
    },
    {
      docId: 'xz-medical-insurance-inpatient-2024',
      title: '忻州市医疗保障局关于统一落实基本医保住院待遇与大病保险管理政策的通知',
      docNumber: '忻医保发〔2024〕18号',
      issuingDept: ['忻州市医疗保障局', '忻州市财政局'],
      publishDate: '2024-06-25',
      effectiveDate: '2024-07-01',
      status: 'active',
      officialUrl: 'http://ybj.sxxz.gov.cn/zwgk/zcfg/202406/t20240628_238491.shtml',
      summaryQuote: '职工住院起付线：三类300元、二类500元、一类800元；在职支付比例三级83%、二级87%、一级91%（退休人员分别为92%、94%、96%），统筹基金封顶10万元，大额救助45万元（总额55万元）。居民住院起付线100元-1000元，支付比例60%-85%，统筹最高7万元，大病最高40万元。'
    }
  ],

  employee: {
    outpatient: {
      sourceDocId: 'xz-employee-outpatient-2022-50',
      annualDeductible: 80,
    ...
    inpatient: {
      sourceDocId: 'xz-medical-insurance-inpatient-2024',
      annualCap: 550000,
      tierBenefits: {
