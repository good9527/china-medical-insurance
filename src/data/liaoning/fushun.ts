...
export const fushunCityData: CityInsuranceData = {
  cityCode: '210400',
  cityName: '抚顺市',
  provinceCode: '210000',
  provinceName: '辽宁省',
  hotline: '024-12393',
  officialPortalUrl: 'http://ybj.fushun.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'fs-employee-outpatient-2022',
      title: '抚顺市人民政府办公室关于印发抚顺市职工基本医疗保险门诊共济保障实施方案的通知',
      docNumber: '抚政办发〔2022〕18号',
      issuingDept: ['抚顺市人民政府办公室', '抚顺市医疗保障局'],
      publishDate: '2022-12-18',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.fushun.gov.cn/zwgk/zcfg/202212/t20221223_1394812.html',
      summaryQuote: '职工门诊统筹年度起付标准调整为300元。统筹基金支付比例：一级及以下定点医疗机构65%、二级定点医疗机构60%、三级定点医疗机构50%；退休人员支付比例提高5个百分点（一级70%、二级65%、三级55%）。普通门诊统筹年度最高支付限额在职及退休职工均为3000元。'
    },
    {
      docId: 'fs-medical-treatment-policy-2023',
      title: '抚顺市医疗保障局关于进一步完善基本医疗保险待遇政策的通知',
      docNumber: '抚医保发〔2023〕15号',
      issuingDept: ['抚顺市医疗保障局', '抚顺市财政局'],
      publishDate: '2023-11-20',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.fushun.gov.cn/zwgk/zcfg/202311/t20231126_1489123.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'fs-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'fs-medical-treatment-policy-2023',
      annualCap: 500000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'fs-medical-treatment-policy-2023',
      filingChannels: ['国家医保服务平台APP', '辽事通', '抚顺医保便民微信'],
