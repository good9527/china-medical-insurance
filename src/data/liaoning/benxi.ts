...
export const benxiCityData: CityInsuranceData = {
  cityCode: '210500',
  cityName: '本溪市',
  provinceCode: '210000',
  provinceName: '辽宁省',
  hotline: '024-12393',
  officialPortalUrl: 'http://ybj.benxi.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'bx-employee-outpatient-2022',
      title: '本溪市人民政府办公室关于印发本溪市健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '本政办发〔2022〕19号',
      issuingDept: ['本溪市人民政府办公室', '本溪市医疗保障局'],
      publishDate: '2022-12-16',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.benxi.gov.cn/zwgk/zcfg/202212/t20221221_1294812.html',
      summaryQuote: '职工门诊统筹起付标准为300元。起付标准以上统筹基金支付比例：一级及以下定点医疗机构65%、二级定点机构60%、三级定点机构50%；退休人员支付比例提高5个百分点（一级70%、二级65%、三级55%）。门诊统筹年度最高支付限额在职及退休职工均为3000元。'
    },
    {
      docId: 'bx-medical-treatment-policy-2023',
      title: '本溪市医疗保障局关于进一步调整和完善基本医疗保险待遇政策的通知',
      docNumber: '本医保发〔2023〕16号',
      issuingDept: ['本溪市医疗保障局', '本溪市财政局'],
      publishDate: '2023-11-22',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.benxi.gov.cn/zwgk/zcfg/202311/t20231128_1384912.html',
      summaryQuote: '居民普通门诊基层定点机构免起付线，报销50%，年度限额200元。城乡居民住院起付线一级200元、二级400元、三级800元，政策范围内报销比例对应85%、75%、60%，统筹年度限额10万元。职工住院起付线一级300元、二级500元、三级800元，在职报销92%、88%、85%，退休提高3个百分点，职工统筹加大额补助限额50万元。'
    }
  ],
  ...
  employee: {
    outpatient: {
      sourceDocId: 'bx-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'bx-medical-treatment-policy-2023',
      annualCap: 500000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'bx-medical-treatment-policy-2023',
      filingChannels: ['国家医保服务平台APP', '辽事通', '本溪医保微信公众号'],
