...
export const liaoyangCityData: CityInsuranceData = {
  cityCode: '211000',
  cityName: '辽阳市',
  provinceCode: '210000',
  provinceName: '辽宁省',
  hotline: '0419-12393',
  officialPortalUrl: 'http://ybj.liaoyang.gov.cn/',
  ...
  sourceDocs: [
    {
      ...
      title: '辽阳市人民政府办公室关于印发辽阳市职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '辽市政办发〔2022〕19号',
      issuingDept: ['辽阳市人民政府办公室', '辽阳市医疗保障局'],
      publishDate: '2022-12-16',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.liaoyang.gov.cn/zwgk/zcfg/202212/t20221220_1495812.html',
    ...
    },
    {
      ...
      title: '辽阳市医疗保障局关于进一步做好基本医疗保险待遇保障工作的通知',
      docNumber: '辽市医保发〔2023〕18号',
      issuingDept: ['辽阳市医疗保障局', '辽阳市财政局'],
      publishDate: '2023-11-20',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.liaoyang.gov.cn/zwgk/zcfg/202311/t20231126_1584912.html',
  ...
  employee: {
    ...
    remoteMedical: {
      sourceDocId: 'ly-medical-treatment-policy-2023',
      filingChannels: ['国家医保服务平台APP', '辽事通', '辽阳医保公众号'],
