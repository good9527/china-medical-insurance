...
export const fuxinCityData: CityInsuranceData = {
  cityCode: '210900',
  cityName: '阜新市',
  provinceCode: '210000',
  provinceName: '辽宁省',
  hotline: '0418-12393',
  officialPortalUrl: 'http://ybj.fuxin.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'fx-employee-outpatient-2022',
      title: '阜新市人民政府办公室关于印发阜新市职工基本医疗保险门诊共济保障实施细则的通知',
      docNumber: '阜政办发〔2022〕20号',
      issuingDept: ['阜新市人民政府办公室', '阜新市医疗保障局'],
      publishDate: '2022-12-18',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.fuxin.gov.cn/zwgk/zcfg/202212/t20221222_1294812.html',
      summaryQuote: '职工门诊统筹年度起付标准为300元。起付标准以上统筹基金支付比例：一级及以下定点医疗机构65%、二级定点医疗机构60%、三级定点医疗机构50%；退休人员支付比例分别提高5个百分点（一级70%、二级65%、三级55%）。门诊统筹年度最高支付限额在职及退休职工均为3000元。'
    },
    {
      docId: 'fx-medical-treatment-policy-2023',
      title: '阜新市医疗保障局关于进一步做好基本医疗保险待遇保障工作的通知',
      docNumber: '阜医保发〔2023〕16号',
      issuingDept: ['阜新市医疗保障局', '阜新市财政局'],
      publishDate: '2023-11-20',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.fuxin.gov.cn/zwgk/zcfg/202311/t20231126_1384912.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'fx-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'fx-medical-treatment-policy-2023',
      annualCap: 500000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'fx-medical-treatment-policy-2023',
      filingChannels: ['国家医保服务平台APP', '辽事通', '阜新医保微信公众号'],
