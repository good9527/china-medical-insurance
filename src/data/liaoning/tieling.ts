...
export const tielingCityData: CityInsuranceData = {
  cityCode: '211200',
  cityName: '铁岭市',
  provinceCode: '210000',
  provinceName: '辽宁省',
  hotline: '024-12393',
  officialPortalUrl: 'http://ybj.tieling.gov.cn/',
  ...
  sourceDocs: [
    {
      ...
      title: '铁岭市人民政府办公室关于印发铁岭市职工基本医疗保险门诊共济保障实施细则的通知',
      docNumber: '铁政办发〔2022〕21号',
      issuingDept: ['铁岭市人民政府办公室', '铁岭市医疗保障局'],
      publishDate: '2022-12-18',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.tieling.gov.cn/zwgk/zcfg/202212/t20221222_1495812.html',
    ...
    {
      docId: 'tl-medical-treatment-policy-2023',
      title: '铁岭市医疗保障局关于进一步完善基本医疗保险待遇政策的通知',
      docNumber: '铁医保发〔2023〕19号',
      issuingDept: ['铁岭市医疗保障局', '铁岭市财政局'],
      publishDate: '2023-11-20',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.tieling.gov.cn/zwgk/zcfg/202311/t20231126_1584912.html',
  ...
  employee: {
    ...
    inpatient: {
      sourceDocId: 'tl-medical-treatment-policy-2023',
      annualCap: 500000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'tl-medical-treatment-policy-2023',
      filingChannels: ['国家医保服务平台APP', '辽事通', '铁岭医保微信公众平台'],
