...
export const jinzhouCityData: CityInsuranceData = {
  cityCode: '210700',
  cityName: '锦州市',
  provinceCode: '210000',
  provinceName: '辽宁省',
  hotline: '0416-12393',
  officialPortalUrl: 'http://ybj.jz.gov.cn/',
  ...
  sourceDocs: [
    {
      ...
      title: '锦州市人民政府办公室关于印发锦州市职工基本医疗保险门诊共济保障实施细则的通知',
      docNumber: '锦政办发〔2022〕22号',
      issuingDept: ['锦州市人民政府办公室', '锦州市医疗保障局'],
      publishDate: '2022-12-18',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.jz.gov.cn/zwgk/zcfg/202212/t20221222_1584912.html',
      summaryQuote: '职工门诊统筹年度起付标准调整为300元。统筹基金支付比例：一级及以下定点医疗机构65%、二级定点医疗机构60%、三级定点医疗机构50%；退休人员支付比例分别提高5个百分点（一级70%、二级65%、三级55%）。门诊统筹年度最高支付限额在职及退休职工均为3000元。'
    },
    {
      docId: 'jz-medical-treatment-policy-2023',
      title: '锦州市医疗保障局关于进一步完善基本医疗保险有关待遇政策的通知',
      docNumber: '锦医保发〔2023〕20号',
      issuingDept: ['锦州市医疗保障局', '锦州市财政局'],
      publishDate: '2023-11-20',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.jz.gov.cn/zwgk/zcfg/202311/t20231126_1674912.html',
  ...
  employee: {
    ...
    inpatient: {
      sourceDocId: 'jz-medical-treatment-policy-2023',
      annualCap: 500000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'jz-medical-treatment-policy-2023',
      filingChannels: ['国家医保服务平台APP', '辽事通', '锦州医保便民平台'],
