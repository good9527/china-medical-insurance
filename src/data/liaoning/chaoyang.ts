...
export const chaoyangCityData: CityInsuranceData = {
  cityCode: '211300',
  cityName: '朝阳市',
  provinceCode: '210000',
  provinceName: '辽宁省',
  hotline: '0421-12393',
  officialPortalUrl: 'http://ybj.zgcy.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'cy-employee-outpatient-2022',
      title: '朝阳市人民政府办公室关于印发朝阳市建立健全职工基本医疗保险门诊共济保障机制实施方案的通知',
      docNumber: '朝政办发〔2022〕22号',
      issuingDept: ['朝阳市人民政府办公室', '朝阳市医疗保障局'],
      publishDate: '2022-12-19',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.zgcy.gov.cn/zwgk/zcfg/202212/t20221223_1394812.html',
    ...
    {
      docId: 'cy-medical-treatment-policy-2023',
      title: '朝阳市医疗保障局关于进一步完善基本医疗保险待遇政策的通知',
      docNumber: '朝医保发〔2023〕18号',
      issuingDept: ['朝阳市医疗保障局', '朝阳市财政局'],
      publishDate: '2023-11-20',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.zgcy.gov.cn/zwgk/zcfg/202311/t20231126_1495812.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'cy-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'cy-medical-treatment-policy-2023',
      annualCap: 500000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'cy-medical-treatment-policy-2023',
      filingChannels: ['国家医保服务平台APP', '辽事通', '朝阳医保微信公众号'],
