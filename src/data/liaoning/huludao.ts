...
export const huludaoCityData: CityInsuranceData = {
  cityCode: '211400',
  cityName: '葫芦岛市',
  provinceCode: '210000',
  provinceName: '辽宁省',
  hotline: '0429-12393',
  officialPortalUrl: 'http://ybj.hld.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'hld-employee-outpatient-2022',
      title: '葫芦岛市人民政府办公室关于印发葫芦岛市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '葫政办发〔2022〕20号',
      issuingDept: ['葫芦岛市人民政府办公室', '葫芦岛市医疗保障局'],
      publishDate: '2022-12-22',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.hld.gov.cn/zwgk/zcfg/202212/t20221226_1123456.html',
    ...
    {
      docId: 'hld-medical-treatment-policy-2023',
      title: '葫芦岛市医疗保障局 葫芦岛市财政局关于调整基本医疗保险有关待遇政策的通知',
      docNumber: '葫医保发〔2023〕16号',
      issuingDept: ['葫芦岛市医疗保障局', '葫芦岛市财政局'],
      publishDate: '2023-11-15',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.hld.gov.cn/zwgk/zcfg/202311/t20231120_1134567.html',
      summaryQuote: '居民普通门诊在基层定点机构免起付线，报销50%，年度限额200元。城乡居民住院起付线一级200元、二级500元、三级900元，政策范围内报销比例对应85%、75%、60%，统筹年度限额8万元。职工住院起付线一级300元、二级500元、三级800元，在职报销92%、88%、85%，退休提高3个百分点，职工统筹加大额补助限额50万元。'
    }
  ],
  ...
  employee: {
    outpatient: {
      sourceDocId: 'hld-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'hld-medical-treatment-policy-2023',
      annualCap: 500000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'hld-medical-treatment-policy-2023',
      filingChannels: ['国家医保服务平台APP', '辽事通', '葫芦岛医保微信公众号'],
