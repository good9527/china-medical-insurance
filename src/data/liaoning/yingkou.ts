...
export const yingkouCityData: CityInsuranceData = {
  cityCode: '210800',
  cityName: '营口市',
  provinceCode: '210000',
  provinceName: '辽宁省',
  hotline: '0417-12393',
  officialPortalUrl: 'http://ybj.yingkou.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'yk-employee-outpatient-2022',
      title: '营口市人民政府办公室关于印发营口市职工基本医疗保险门诊共济保障机制实施方案的通知',
      docNumber: '营政办发〔2022〕25号',
      issuingDept: ['营口市人民政府办公室', '营口市医疗保障局'],
      publishDate: '2022-12-19',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.yingkou.gov.cn/zwgk/zcfg/202212/t20221223_1394812.html',
    ...
    {
      docId: 'yk-medical-treatment-policy-2023',
      title: '营口市医疗保障局关于进一步做好基本医疗保险待遇保障工作的通知',
      docNumber: '营医保发〔2023〕17号',
      issuingDept: ['营口市医疗保障局', '营口市财政局'],
      publishDate: '2023-11-20',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.yingkou.gov.cn/zwgk/zcfg/202311/t20231126_1495812.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'yk-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'yk-medical-treatment-policy-2023',
      annualCap: 500000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'yk-medical-treatment-policy-2023',
      filingChannels: ['国家医保服务平台APP', '辽事通', '营口医保微信公众平台'],
