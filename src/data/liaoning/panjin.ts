...
export const panjinCityData: CityInsuranceData = {
  cityCode: '211100',
  cityName: '盘锦市',
  provinceCode: '210000',
  provinceName: '辽宁省',
  hotline: '0427-12393',
  officialPortalUrl: 'http://ybj.panjin.gov.cn/',
  ...
  sourceDocs: [
    ...
    },
    {
      ...
      title: '盘锦市医疗保障局关于进一步完善基本医疗保险待遇政策的通知',
      docNumber: '盘医保发〔2023〕17号',
      issuingDept: ['盘锦市医疗保障局', '盘锦市财政局'],
      publishDate: '2023-11-20',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.panjin.gov.cn/zwgk/zcfg/202311/t20231126_1384912.html',
  ...
  employee: {
    ...
    remoteMedical: {
      sourceDocId: 'pj-medical-treatment-policy-2023',
      filingChannels: ['国家医保服务平台APP', '辽事通', '盘锦医保公众号'],
