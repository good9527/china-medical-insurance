...
export const songyuanCityData: CityInsuranceData = {
  cityCode: '220700',
  cityName: '松原市',
  provinceCode: '220000',
  provinceName: '吉林省',
  hotline: '0438-12393',
  officialPortalUrl: 'http://ybj.jlsy.gov.cn/',
  ...
  sourceDocs: [
    {
      ...
      title: '松原市人民政府办公室关于印发松原市建立健全职工基本医疗保险门诊共济保障机制实施方案的通知',
      docNumber: '松政办发〔2022〕23号',
      issuingDept: ['松原市人民政府办公室', '松原市医疗保障局'],
      publishDate: '2022-12-19',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.jlsy.gov.cn/zwgk/zcfg/202212/t20221224_1189234.html',
      summaryQuote: '在职职工门诊起付标准300元。一级及以下定点机构统筹支付65%、二级机构60%、三级机构50%；退休人员支付比例分别提高5个百分点（一级70%、二级65%、三级55%）。门诊统筹年度最高支付限额在职及退休职工均为2000元。'
    },
    {
      docId: 'sy-medical-insurance-policy-2023',
      title: '关于完善松原市城乡居民基本医疗保险待遇政策的通知',
      docNumber: '松医保发〔2023〕18号',
      issuingDept: ['松原市医疗保障局', '松原市财政局'],
      publishDate: '2023-11-23',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.jlsy.gov.cn/zwgk/zcfg/202311/t20231129_1289123.html',
  ...
  employee: {
    ...
    inpatient: {
      sourceDocId: 'sy-medical-insurance-policy-2023',
      annualCap: 500000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'sy-medical-insurance-policy-2023',
      filingChannels: ['国家医保服务平台APP', '吉事办', '松原医保微信公众号'],
