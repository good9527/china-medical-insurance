...
export const tonghuaCityData: CityInsuranceData = {
  cityCode: '220500',
  cityName: '通化市',
  provinceCode: '220000',
  provinceName: '吉林省',
  hotline: '0435-12393',
  officialPortalUrl: 'http://ybj.tonghua.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'th-employee-outpatient-2022',
      title: '通化市人民政府办公室关于印发通化市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '通政办发〔2022〕21号',
      issuingDept: ['通化市人民政府办公室', '通化市医疗保障局'],
      publishDate: '2022-12-15',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.tonghua.gov.cn/zwgk/zcfg/202212/t20221220_1189234.html',
      summaryQuote: '在职职工门诊年度起付标准300元。一级及以下定点机构统筹支付65%、二级定点机构60%、三级定点机构50%；退休人员支付比例分别提高5个百分点（一级70%、二级65%、三级55%）。门诊统筹年度最高支付限额在职及退休职工均为2000元。'
    },
    {
      docId: 'th-medical-insurance-policy-2023',
      title: '通化市医疗保障局关于调整优化基本医疗保险待遇政策的通知',
      docNumber: '通医保发〔2023〕19号',
      issuingDept: ['通化市医疗保障局', '通化市财政局'],
      publishDate: '2023-11-22',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.tonghua.gov.cn/zwgk/zcfg/202311/t20231128_1294812.html',
      summaryQuote: '居民普通门诊在基层定点机构免起付线，报销50%，年度限额200元。城乡居民住院起付线一级200元、二级500元、三级800元，政策范围内报销比例对应85%、75%、60%，统筹年度限额10万元。职工住院起付线一级300元、二级500元、三级800元，在职报销92%、88%、85%，退休提高3个百分点。'
    }
  ],
  ...
  employee: {
    outpatient: {
      sourceDocId: 'th-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'th-medical-insurance-policy-2023',
      annualCap: 500000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'th-medical-insurance-policy-2023',
      filingChannels: ['国家医保服务平台APP', '吉事办', '通化医保微信公众号'],
