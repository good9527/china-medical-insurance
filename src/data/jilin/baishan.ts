...
export const baishanCityData: CityInsuranceData = {
  cityCode: '220600',
  cityName: '白山市',
  provinceCode: '220000',
  provinceName: '吉林省',
  hotline: '0439-12393',
  officialPortalUrl: 'http://ybj.cbs.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'bs-employee-outpatient-2022',
      title: '白山市人民政府办公室关于印发白山市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '白政办发〔2022〕20号',
      issuingDept: ['白山市人民政府办公室', '白山市医疗保障局'],
      publishDate: '2022-12-18',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.cbs.gov.cn/zwgk/zcfg/202212/t20221223_1089234.html',
      summaryQuote: '在职职工门诊年度起付标准300元。一级及以下机构统筹支付65%、二级机构60%、三级机构50%；退休人员支付比例分别提高5个百分点（一级70%、二级65%、三级55%）。门诊统筹年度最高支付限额在职及退休职工均为2000元。'
    },
    {
      docId: 'bs-medical-insurance-policy-2023',
      title: '关于调整白山市基本医疗保险有关待遇政策的通知',
      docNumber: '白医保发〔2023〕17号',
      issuingDept: ['白山市医疗保障局', '白山市财政局'],
      publishDate: '2023-11-20',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.cbs.gov.cn/zwgk/zcfg/202311/t20231126_1194812.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'bs-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'bs-medical-insurance-policy-2023',
      annualCap: 500000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'bs-medical-insurance-policy-2023',
      filingChannels: ['国家医保服务平台APP', '吉事办', '白山医保微信公众号'],
