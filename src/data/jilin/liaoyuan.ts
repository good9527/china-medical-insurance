...
export const liaoyuanCityData: CityInsuranceData = {
  cityCode: '220400',
  cityName: '辽源市',
  provinceCode: '220000',
  provinceName: '吉林省',
  hotline: '0437-12393',
  officialPortalUrl: 'http://ybj.liaoyuan.gov.cn/',
  ...
  sourceDocs: [
    {
      ...
      title: '辽源市人民政府办公室关于印发辽源市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '辽府办发〔2022〕24号',
      issuingDept: ['辽源市人民政府办公室', '辽源市医疗保障局'],
    ...
    },
    {
      ...
      title: '关于进一步规范辽源市基本医疗保险待遇政策的通知',
      docNumber: '辽医保发〔2023〕16号',
      issuingDept: ['辽源市医疗保障局', '辽源市财政局'],
      publishDate: '2023-11-28',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.liaoyuan.gov.cn/zwgk/zcfg/202312/t20231202_1293812.html',
  ...
  employee: {
    ...
    remoteMedical: {
      sourceDocId: 'ly-medical-insurance-policy-2023',
      filingChannels: ['国家医保服务平台APP', '吉事办', '辽源医保微信公众号'],
