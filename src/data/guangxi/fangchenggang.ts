...
export const fangchenggangCityData: CityInsuranceData = {
  cityCode: '450600',
  cityName: '防城港市',
  provinceCode: '450000',
  provinceName: '广西壮族自治区',
  hotline: '0770-12393',
  officialPortalUrl: 'http://ybj.fcgs.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'fcg-employee-outpatient-2022',
      title: '防城港市人民政府关于印发防城港市职工基本医疗保险门诊共济保障实施细则的通知',
      docNumber: '防政规〔2022〕10号',
      issuingDept: ['防城港市人民政府', '防城港市医疗保障局'],
      publishDate: '2022-12-16',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.fcgs.gov.cn/zwgk/zcfg/202212/t20221220_1289145.html',
      summaryQuote: '职工门诊统筹起付标准一级100元、二级200元、三级300元。统筹支付比例一级及以下60%（退休65%）、二级55%（退休60%）、三级50%（退休55%）。门诊统筹年度最高支付限额在职职工1800元，退休人员2400元。'
    },
    {
      docId: 'fcg-medical-treatment-policy-2023',
      title: '防城港市医疗保障局关于进一步完善基本医疗保险待遇政策的通知',
      docNumber: '防医保发〔2023〕16号',
      issuingDept: ['防城港市医疗保障局', '防城港市财政局'],
      publishDate: '2023-11-20',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.fcgs.gov.cn/zwgk/zcfg/202311/t20231126_1394812.html',
      summaryQuote: '居民普通门诊在基层定点机构免起付线，报销60%，年度封顶200元。城乡居民住院起付线一级100元、二级300元、三级600元，政策范围内报销比例对应90%、75%、60%，统筹年度限额15万元。职工住院起付线一级200元、二级400元、三级800元，在职报销92%、90%、85%，退休提高3个百分点，职工统筹加大额补助限额50万元。'
    }
  ],
  ...
  employee: {
    outpatient: {
      sourceDocId: 'fcg-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'fcg-medical-treatment-policy-2023',
      annualCap: 500000,
      tierBenefits: {
        ...
        tier3_top: { tierName: '自治区级重点医院', deductible: 800, reimbursementRatio: 0.85, retireeRatioBonus: 0.03 }
      },
  ...
  resident: {
    outpatient: {
      ...
      note: '居民门诊统筹基层机构免起付线，报销60%，年度限额200元。'
    },
    inpatient: {
      sourceDocId: 'fcg-medical-treatment-policy-2023',
      annualCap: 150000,
