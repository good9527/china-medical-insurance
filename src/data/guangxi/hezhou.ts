...
export const hezhouCityData: CityInsuranceData = {
  cityCode: '451100',
  cityName: '贺州市',
  provinceCode: '450000',
  provinceName: '广西壮族自治区',
  hotline: '0774-12393',
  officialPortalUrl: 'http://ybj.gxhz.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'hz-employee-outpatient-2022',
      title: '贺州市人民政府关于印发贺州市职工基本医疗保险门诊共济保障实施细则的通知',
      docNumber: '贺政规〔2022〕9号',
      issuingDept: ['贺州市人民政府', '贺州市医疗保障局'],
      publishDate: '2022-12-15',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.gxhz.gov.cn/zwgk/zcfg/202212/t20221219_1894512.html',
      summaryQuote: '职工门诊统筹起付标准一级100元、二级200元、三级300元。统筹支付比例一级及以下60%（退休65%）、二级55%（退休60%）、三级50%（退休55%）。门诊统筹年度最高支付限额在职职工1800元，退休人员2400元。'
    },
    {
      docId: 'hz-medical-treatment-policy-2023',
      title: '贺州市医疗保障局关于进一步做好基本医疗保险待遇保障工作的通知',
      docNumber: '贺医保发〔2023〕15号',
      issuingDept: ['贺州市医疗保障局', '贺州市财政局'],
      publishDate: '2023-11-22',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.gxhz.gov.cn/zwgk/zcfg/202311/t20231128_1985412.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'hz-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'hz-medical-treatment-policy-2023',
      annualCap: 500000,
      tierBenefits: {
