...
export const yulinGuangxiCityData: CityInsuranceData = {
  cityCode: '450900',
  cityName: '玉林市',
  provinceCode: '450000',
  provinceName: '广西壮族自治区',
  hotline: '0775-12393',
  officialPortalUrl: 'http://ybj.yulin.gov.cn/',
  ...
  sourceDocs: [
    {
      ...
      title: '玉林市人民政府关于印发玉林市职工基本医疗保险门诊共济保障实施办法的通知',
      docNumber: '玉政规〔2022〕12号',
      issuingDept: ['玉林市人民政府', '玉林市医疗保障局'],
      publishDate: '2022-12-15',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.yulin.gov.cn/zwgk/zcfg/202212/t20221220_1495810.html',
      summaryQuote: '职工门诊统筹起付标准一级100元、二级200元、三级300元。统筹支付比例一级及以下60%（退休65%）、二级55%（退休60%）、三级50%（退休55%）。门诊统筹年度最高支付限额在职职工1800元，退休人员2400元。'
    },
    {
      docId: 'yl-medical-treatment-policy-2023',
      title: '玉林市医疗保障局关于进一步做好基本医疗保险待遇保障工作的通知',
      docNumber: '玉医保发〔2023〕20号',
      issuingDept: ['玉林市医疗保障局', '玉林市财政局'],
  ...
  employee: {
    ...
    inpatient: {
      sourceDocId: 'yl-medical-treatment-policy-2023',
      annualCap: 500000,
      tierBenefits: {
