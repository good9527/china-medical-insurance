...
export const chongzuoCityData: CityInsuranceData = {
  cityCode: '451400',
  cityName: '崇左市',
  provinceCode: '450000',
  provinceName: '广西壮族自治区',
  hotline: '0771-12393',
  officialPortalUrl: 'http://ybj.chongzuo.gov.cn/',
  ...
  sourceDocs: [
    {
      ...
      title: '崇左市人民政府关于印发崇左市职工基本医疗保险门诊共济保障实施细则的通知',
      docNumber: '崇政规〔2022〕11号',
      issuingDept: ['崇左市人民政府', '崇左市医疗保障局'],
      publishDate: '2022-12-18',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.chongzuo.gov.cn/zwgk/zcfg/202212/t20221222_1294815.html',
      summaryQuote: '职工门诊统筹起付标准一级100元、二级200元、三级300元。统筹支付比例一级及以下60%（退休65%）、二级55%（退休60%）、三级50%（退休55%）。门诊统筹年度最高支付限额在职职工1800元，退休人员2400元。'
    },
    {
      docId: 'cz-medical-treatment-policy-2023',
      title: '崇左市医疗保障局关于进一步做好基本医疗保险待遇保障工作的通知',
      docNumber: '崇医保发〔2023〕19号',
      issuingDept: ['崇左市医疗保障局', '崇左市财政局'],
      publishDate: '2023-11-25',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.chongzuo.gov.cn/zwgk/zcfg/202311/t20231130_1384912.html',
      summaryQuote: '居民普通门诊在基层定点机构免起付线，报销60%，年度限额200元。城乡居民住院起付线一级100元、二级300元、三级600元，政策范围内报销比例对应90%、75%、60%，统筹年度限额15万元。职工住院起付线一级200元、二级400元、三级800元，在职报销92%、90%、85%，退休提高3个百分点，职工医保统筹加大额补助最高支付50万元。'
    }
  ],
  ...
  employee: {
    ...
    inpatient: {
      sourceDocId: 'cz-medical-treatment-policy-2023',
      annualCap: 500000,
      tierBenefits: {
  ...
  resident: {
    outpatient: {
      ...
      note: '居民门诊统筹基层机构免起付享受，报销60%，年度限额200元。'
    },
    inpatient: {
      sourceDocId: 'cz-medical-treatment-policy-2023',
      annualCap: 150000,
