...
export const baiseCityData: CityInsuranceData = {
  cityCode: '451000',
  cityName: '百色市',
  provinceCode: '450000',
  provinceName: '广西壮族自治区',
  hotline: '0776-12393',
  officialPortalUrl: 'http://ybj.baise.gov.cn/',
  ...
  sourceDocs: [
    {
      ...
      title: '百色市人民政府关于印发百色市职工基本医疗保险门诊共济保障实施细则的通知',
      docNumber: '百政规〔2022〕11号',
      issuingDept: ['百色市人民政府', '百色市医疗保障局'],
      publishDate: '2022-12-16',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.baise.gov.cn/zwgk/zcfg/202212/t20221221_1684912.html',
      summaryQuote: '职工门诊统筹起付标准一级100元、二级200元、三级300元。统筹支付比例一级及以下60%（退休65%）、二级55%（退休60%）、三级50%（退休55%）。门诊统筹年度最高支付限额在职职工1800元，退休人员2400元。'
    },
    {
      docId: 'bs-medical-treatment-policy-2023',
      title: '百色市医疗保障局关于进一步做好基本医疗保险待遇保障工作的通知',
      docNumber: '百医保发〔2023〕16号',
      issuingDept: ['百色市医疗保障局', '百色市财政局'],
      publishDate: '2023-11-20',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.baise.gov.cn/zwgk/zcfg/202311/t20231126_1795841.html',
  ...
  employee: {
    ...
    inpatient: {
      sourceDocId: 'bs-medical-treatment-policy-2023',
      annualCap: 500000,
      tierBenefits: {
