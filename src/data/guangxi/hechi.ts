...
export const hechiCityData: CityInsuranceData = {
  cityCode: '451200',
  cityName: '河池市',
  provinceCode: '450000',
  provinceName: '广西壮族自治区',
  hotline: '0778-12393',
  officialPortalUrl: 'http://ybj.hechi.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'hc-employee-outpatient-2022',
      title: '河池市人民政府关于印发河池市职工基本医疗保险门诊共济保障实施细则的通知',
      docNumber: '河政规〔2022〕10号',
      issuingDept: ['河池市人民政府', '河池市医疗保障局'],
      publishDate: '2022-12-18',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.hechi.gov.cn/zwgk/zcfg/202212/t20221222_1948512.html',
      summaryQuote: '职工门诊统筹起付标准一级100元、二级200元、三级300元。统筹支付比例一级及以下60%（退休65%）、二级55%（退休60%）、三级50%（退休55%）。门诊统筹年度最高支付限额在职职工1800元，退休人员2400元。'
    },
    {
      docId: 'hc-medical-treatment-policy-2023',
      title: '河池市医疗保障局关于进一步完善基本医疗保险待遇保障政策的通知',
      docNumber: '河医保发〔2023〕17号',
      issuingDept: ['河池市医疗保障局', '河池市财政局'],
  ...
  employee: {
    outpatient: {
      sourceDocId: 'hc-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'hc-medical-treatment-policy-2023',
      annualCap: 500000,
      tierBenefits: {
