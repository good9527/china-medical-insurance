...
export const guigangCityData: CityInsuranceData = {
  cityCode: '450800',
  cityName: '贵港市',
  provinceCode: '450000',
  provinceName: '广西壮族自治区',
  hotline: '0775-12393',
  officialPortalUrl: 'http://ybj.gxgg.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'gg-employee-outpatient-2022',
      title: '贵港市人民政府关于印发贵港市职工基本医疗保险门诊共济保障实施细则的通知',
      docNumber: '贵政规〔2022〕13号',
      issuingDept: ['贵港市人民政府', '贵港市医疗保障局'],
      publishDate: '2022-12-19',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.gxgg.gov.cn/zwgk/zcfg/202212/t20221223_1784910.html',
      summaryQuote: '职工门诊统筹起付标准一级100元、二级200元、三级300元。统筹支付比例一级及以下60%（退休65%）、二级55%（退休60%）、三级50%（退休55%）。门诊统筹年度最高支付限额在职职工1800元，退休人员2400元。'
    },
    {
      docId: 'gg-medical-treatment-policy-2023',
      title: '贵港市医疗保障局关于调整完善基本医疗保险待遇政策的通知',
      docNumber: '贵医保发〔2023〕18号',
      issuingDept: ['贵港市医疗保障局', '贵港市财政局'],
      publishDate: '2023-11-20',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.gxgg.gov.cn/zwgk/zcfg/202311/t20231126_1895612.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'gg-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'gg-medical-treatment-policy-2023',
      annualCap: 500000,
      tierBenefits: {
