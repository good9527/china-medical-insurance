...
export const qinzhouCityData: CityInsuranceData = {
  cityCode: '450700',
  cityName: '钦州市',
  provinceCode: '450000',
  provinceName: '广西壮族自治区',
  hotline: '0777-12393',
  officialPortalUrl: 'http://ybj.qinzhou.gov.cn/',
  ...
  sourceDocs: [
    {
      ...
      title: '钦州市人民政府关于印发钦州市职工基本医疗保险门诊共济保障实施细则的通知',
      docNumber: '钦政规〔2022〕14号',
      issuingDept: ['钦州市人民政府', '钦州市医疗保障局'],
      publishDate: '2022-12-18',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.qinzhou.gov.cn/zwgk/zcfg/202212/t20221222_3849120.html',
    ...
    },
    {
      ...
      title: '钦州市医疗保障局关于进一步做好基本医疗保险待遇保障工作的通知',
      docNumber: '钦医保发〔2023〕19号',
      issuingDept: ['钦州市医疗保障局', '钦州市财政局'],
      publishDate: '2023-11-22',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.qinzhou.gov.cn/zwgk/zcfg/202311/t20231128_3958124.html',
      summaryQuote: '居民普通门诊在基层定点医疗机构免起付线，报销60%，年度限额200元。城乡居民住院起付线一级100元、二级300元、三级600元，政策范围内报销比例对应90%、75%、60%，统筹年度限额15万元。职工住院起付线一级200元、二级400元、三级800元，在职报销92%、90%、85%，退休提高3个百分点，职工统筹加大额补助限额50万元。'
    }
  ],
