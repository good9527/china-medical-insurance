...
export const chifengData: CityInsuranceData = {
  cityCode: '150400',
  cityName: '赤峰市',
  provinceCode: '150000',
  provinceName: '内蒙古自治区',
  hotline: '0476-12393',
  officialPortalUrl: 'http://ybj.chifeng.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'cf-employee-outpatient-2022',
      title: '赤峰市职工基本医疗保险门诊共济保障实施细则',
      docNumber: '赤政办发〔2022〕55号',
      issuingDept: ['赤峰市人民政府办公室', '赤峰市医疗保障局'],
      publishDate: '2022-09-20',
      effectiveDate: '2022-10-01',
      status: 'active',
      officialUrl: 'http://ybj.chifeng.gov.cn/art/2022/09/25/art_11221_1189912.html',
      summaryQuote: '门诊年度起付标准统一为1000元。在职职工支付比例二级及以下60%、三级50%，退休人员各增加5个百分点（分别为65%、55%）。年度累计最高支付限额在职4000元，退休人员5000元。'
    },
    {
      docId: 'cf-medical-insurance-inpatient-2024',
      title: '赤峰市基本医疗保险综合保障管理细则',
      docNumber: '赤医保发〔2024〕33号',
      issuingDept: ['赤峰市医疗保障局', '赤峰市财政局'],
      publishDate: '2024-11-20',
      effectiveDate: '2025-01-01',
      status: 'active',
      officialUrl: 'http://ybj.chifeng.gov.cn/art/2024/11/25/art_11221_1345672.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'cf-employee-outpatient-2022',
      annualDeductible: 1000,
      annualCap: 4000,
      annualCapRetiree: 5000,
      tierBenefits: {
        community: { tierName: '基层及一级定点医疗机构', deductible: 1000, reimbursementRatio: 0.60, retireeRatioBonus: 0.05 },
        tier1: { tierName: '一级定点医疗机构', deductible: 1000, reimbursementRatio: 0.60, retireeRatioBonus: 0.05 },
        ...
        tier3_top: { tierName: '重点三甲医院', deductible: 1000, reimbursementRatio: 0.50, retireeRatioBonus: 0.05 }
      },
      note: '门诊年度起付标准1000元，二级及以下在职报销60%、三级50%，退休各加5%，在职封顶4000元，退休封顶5000元。'
    },
    inpatient: {
      sourceDocId: 'cf-medical-insurance-inpatient-2024',
      annualCap: 500000,
      tierBenefits: {
