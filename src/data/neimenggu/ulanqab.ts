...
export const ulanqabData: CityInsuranceData = {
  cityCode: '150900',
  cityName: '乌兰察布市',
  provinceCode: '150000',
  provinceName: '内蒙古自治区',
  hotline: '0474-12393',
  officialPortalUrl: 'http://ybj.ulan-qab.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'wlcb-employee-outpatient-2022',
      title: '乌兰察布市职工基本医疗保险门诊共济保障机制实施办法',
      docNumber: '乌医保发〔2022〕83号',
      issuingDept: ['乌兰察布市医疗保障局', '乌兰察布市财政局'],
      publishDate: '2022-11-25',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.ulan-qab.gov.cn/art/2022/11/30/art_11221_1189912.html',
      summaryQuote: '门诊年度起付标准统一为1000元。统筹基金支付比例：二级及以下定点医疗机构60%、三级50%，退休人员各增加5个百分点（分别为65%、55%）。年度累计最高支付限额在职4000元，退休人员5000元。'
    },
    {
      docId: 'wlcb-medical-insurance-inpatient-2024',
      title: '乌兰察布市基本医疗保险综合保障政策管理方案',
      docNumber: '乌医保发〔2024〕36号',
      issuingDept: ['乌兰察布市医疗保障局', '乌兰察布市财政局'],
      publishDate: '2024-11-20',
      effectiveDate: '2025-01-01',
      status: 'active',
      officialUrl: 'http://ybj.ulan-qab.gov.cn/art/2024/11/25/art_11221_1345672.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'wlcb-employee-outpatient-2022',
    ...
    inpatient: {
      sourceDocId: 'wlcb-medical-insurance-inpatient-2024',
      annualCap: 500000,
      tierBenefits: {
