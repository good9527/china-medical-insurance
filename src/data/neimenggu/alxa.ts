...
export const alxaData: CityInsuranceData = {
  cityCode: '152900',
  cityName: '阿拉善盟',
  provinceCode: '150000',
  provinceName: '内蒙古自治区',
  hotline: '0483-12393',
  officialPortalUrl: 'http://ybj.als.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'als-employee-outpatient-2023',
      title: '关于建立完善职工基本医疗保险门诊共济保障机制的实施方案',
      docNumber: '阿署办发〔2023〕35号',
      issuingDept: ['阿拉善盟行政公署办公室', '阿拉善盟医疗保障局'],
    ...
    },
    {
      ...
      title: '阿拉善盟基本医疗保险综合保障管理规程',
      docNumber: '阿医保发〔2024〕28号',
      issuingDept: ['阿拉善盟医疗保障局', '阿拉善盟财政局'],
      publishDate: '2024-11-20',
      effectiveDate: '2025-01-01',
      status: 'active',
      officialUrl: 'http://ybj.als.gov.cn/art/2024/11/25/art_11221_1345672.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'als-employee-outpatient-2023',
      ...
      note: '门诊起付标准一级200/二级300/三级500，报销比例一级80%、二级80%、三级60%（退休各加5%），在职封顶5000元，退休封顶6000元。'
    },
    inpatient: {
      sourceDocId: 'als-medical-insurance-inpatient-2024',
      annualCap: 500000,
      tierBenefits: {
