...
export const tongliaoData: CityInsuranceData = {
  cityCode: '150500',
  cityName: '通辽市',
  provinceCode: '150000',
  provinceName: '内蒙古自治区',
  hotline: '0475-12393',
  officialPortalUrl: 'http://ybj.tongliao.gov.cn/',
  ...
  sourceDocs: [
    {
      ...
      title: '通辽市职工基本医疗保险门诊共济保障机制实施细则',
      docNumber: '通政办发〔2022〕34号',
      issuingDept: ['通辽市人民政府办公室', '通辽市医疗保障局'],
      publishDate: '2022-09-20',
      effectiveDate: '2022-10-01',
      status: 'active',
      officialUrl: 'http://ybj.tongliao.gov.cn/art/2022/09/25/art_11221_1189912.html',
      summaryQuote: '门诊年度起付标准统一为1000元。在职职工支付比例二级及以下60%、三级50%，退休人员各增加5个百分点（分别为65%、55%）。年度累计最高支付限额在职4000元，退休人员5000元。'
    },
    {
      docId: 'tl-medical-insurance-inpatient-2024',
      title: '通辽市基本医疗保险综合保障政策管理办法',
      docNumber: '通医保发〔2024〕31号',
      issuingDept: ['通辽市医疗保障局', '通辽市财政局'],
      publishDate: '2024-11-20',
      effectiveDate: '2025-01-01',
      status: 'active',
      officialUrl: 'http://ybj.tongliao.gov.cn/art/2024/11/25/art_11221_1345672.html',
  ...
  employee: {
    outpatient: {
      ...
      note: '门诊年度起付标准1000元，二级及以下在职报销60%、三级50%，退休各加5%，在职限额4000元，退休限额5000元。'
    },
    inpatient: {
      sourceDocId: 'tl-medical-insurance-inpatient-2024',
      annualCap: 500000,
      tierBenefits: {
