...
export const wuhaiData: CityInsuranceData = {
  cityCode: '150300',
  cityName: '乌海市',
  provinceCode: '150000',
  provinceName: '内蒙古自治区',
  hotline: '0473-12393',
  officialPortalUrl: 'http://ybj.wuhai.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'wh-employee-outpatient-2022',
      title: '乌海市职工基本医疗保险门诊共济保障实施细则',
      docNumber: '乌海政办发〔2022〕42号',
      issuingDept: ['乌海市人民政府办公室', '乌海市医疗保障局'],
      publishDate: '2022-11-25',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.wuhai.gov.cn/art/2022/11/30/art_11221_1189912.html',
      summaryQuote: '门诊年度起付标准统一为1000元。在职职工支付比例二级及以下60%、三级50%，退休人员各增加5个百分点（分别为65%、55%）。最高支付限额在职4000元，退休5000元。'
    },
    {
      docId: 'wh-medical-insurance-inpatient-2024',
      title: '乌海市基本医疗保险综合保障管理方案',
      docNumber: '乌医保发〔2024〕28号',
      issuingDept: ['乌海市医疗保障局', '乌海市财政局'],
      publishDate: '2024-11-20',
      effectiveDate: '2025-01-01',
      status: 'active',
      officialUrl: 'http://ybj.wuhai.gov.cn/art/2024/11/25/art_11221_1345672.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'wh-employee-outpatient-2022',
      ...
      note: '门诊年度起付标准统一为1000元，在职人员二级及以下60%、三级50%，退休各加5%，在职限额4000元，退休限额5000元。'
    },
    inpatient: {
