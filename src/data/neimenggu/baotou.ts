...
export const baotouData: CityInsuranceData = {
  cityCode: '150200',
  cityName: '包头市',
  provinceCode: '150000',
  provinceName: '内蒙古自治区',
  hotline: '0472-12393',
  officialPortalUrl: 'http://ybj.baotou.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'bt-employee-outpatient-2023',
      title: '包头市建立完善职工基本医疗保险门诊共济保障实施细则',
      docNumber: '包政办发〔2023〕48号',
      issuingDept: ['包头市人民政府办公室', '包头市医疗保障局'],
      publishDate: '2023-11-20',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.baotou.gov.cn/art/2023/11/25/art_11221_1189912.html',
      summaryQuote: '职工门诊统筹起付线按年度累计计算：一级200元、二级300元、三级500元（退休人员相应为50元、200元、300元）。统筹支付比例：一级70%、二级60%、三级50%（退休人员各提高5%）。最高支付限额在职4000元、退休5000元。'
    },
    {
      docId: 'bt-medical-insurance-inpatient-2024',
      title: '包头市基本医疗保险综合保障政策管理规程',
      docNumber: '包医保发〔2024〕30号',
      issuingDept: ['包头市医疗保障局', '包头市财政局'],
      publishDate: '2024-11-20',
      effectiveDate: '2025-01-01',
      status: 'active',
      officialUrl: 'http://ybj.baotou.gov.cn/art/2024/11/25/art_11221_1345672.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'bt-employee-outpatient-2023',
      annualDeductible: 500, // 门诊年度起付线
      ...
      tierBenefits: {
        ...
        tier3_top: { tierName: '重点三甲综合医院', deductible: 500, reimbursementRatio: 0.50, retireeRatioBonus: 0.05 }
      },
      note: '门诊按机构级别设起付线（一级200/二级300/三级500），报销比例一级70%、二级60%、三级50%（退休各加5%），在职封顶4000元，退休封顶5000元。'
    },
    inpatient: {
      sourceDocId: 'bt-medical-insurance-inpatient-2024',
      annualCap: 500000,
      tierBenefits: {
