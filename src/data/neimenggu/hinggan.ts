...
export const hingganData: CityInsuranceData = {
  cityCode: '152200',
  cityName: '兴安盟',
  provinceCode: '150000',
  provinceName: '内蒙古自治区',
  hotline: '0482-12393',
  officialPortalUrl: 'http://ybj.xam.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'xam-employee-outpatient-2022',
      title: '兴安盟职工基本医疗保险门诊共济保障机制实施细则',
      docNumber: '兴署办发〔2022〕23号',
      issuingDept: ['兴安盟行政公署办公室', '兴安盟医疗保障局'],
      publishDate: '2022-09-20',
      effectiveDate: '2022-10-01',
      status: 'active',
      officialUrl: 'http://ybj.xam.gov.cn/art/2022/09/25/art_11221_1189912.html',
      summaryQuote: '门诊年度累计起付线为1000元。统筹基金支付比例：二级及以下医疗机构在职65%、退休70%，三级机构在职55%、退休60%。年度累计最高支付限额在职4000元，退休人员5000元。'
    },
    {
      docId: 'xam-medical-insurance-inpatient-2024',
      title: '兴安盟基本医疗保险综合保障管理细则',
      docNumber: '兴医保发〔2024〕30号',
      issuingDept: ['兴安盟医疗保障局', '兴安盟财政局'],
      publishDate: '2024-11-20',
      effectiveDate: '2025-01-01',
      status: 'active',
      officialUrl: 'http://ybj.xam.gov.cn/art/2024/11/25/art_11221_1345672.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'xam-employee-outpatient-2022',
      annualDeductible: 1000,
      annualCap: 4000,
      annualCapRetiree: 5000,
      tierBenefits: {
        community: { tierName: '基层及一级定点医疗机构', deductible: 1000, reimbursementRatio: 0.65, retireeRatioBonus: 0.05 },
        tier1: { tierName: '一级定点医疗机构', deductible: 1000, reimbursementRatio: 0.65, retireeRatioBonus: 0.05 },
        tier2: { tierName: '二级定点医疗机构', deductible: 1000, reimbursementRatio: 0.65, retireeRatioBonus: 0.05 },
        tier3: { tierName: '三级定点医疗机构', deductible: 1000, reimbursementRatio: 0.55, retireeRatioBonus: 0.05 },
        tier3_top: { tierName: '重点三甲综合医院', deductible: 1000, reimbursementRatio: 0.55, retireeRatioBonus: 0.05 }
      },
      note: '门诊年度起付标准1000元，二级及以下在职报销65%、三级55%（退休各加5%），在职封顶4000元，退休封顶5000元。'
    },
    inpatient: {
      sourceDocId: 'xam-medical-insurance-inpatient-2024',
      annualCap: 500000,
      tierBenefits: {
