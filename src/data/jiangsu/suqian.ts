...
/**
 * 宿迁市基本医疗保险政策数据与官方文件溯源库
 * 数据基准年度：2025-2026年（现行有效）
 * 统筹区编码：321300
 */
export const suqianCityData: CityInsuranceData = {
  cityCode: '321300',
  cityName: '宿迁市',
  provinceCode: '320000',
  provinceName: '江苏省',
  hotline: '0527-12393',
  officialPortalUrl: 'https://ybj.suqian.gov.cn/',
  lastUpdated: '2026-03-01',

  // 官方规范性红头文件与政府公开溯源凭证
  sourceDocs: [
    {
      docId: 'sq-employee-outpatient-reform-2022',
      title: '宿迁市职工基本医疗保险门诊共济保障机制实施办法',
      docNumber: '宿政规发〔2022〕8号',
      issuingDept: ['宿迁市人民政府', '宿迁市医疗保障局'],
      publishDate: '2022-12-25',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'https://ybj.suqian.gov.cn/ybj/zcfg/202212/8ec54972e60c4aa387e37603c14dcb99.shtml',
      summaryQuote: '在职职工门诊起付标准为650元，退休人员为500元。普通门诊统筹基金年度最高支付限额为6000元。统筹支付比例：一级及以下医疗机构在职70%（退休75%）、二级医疗机构在职65%（退休70%）、三级医疗机构在职60%（退休65%）。'
    },
    {
      docId: 'sq-medical-insurance-inpatient-2023',
      title: '宿迁市医疗保障局关于调整基本医疗保险住院统筹待遇标准的通知',
      docNumber: '宿医保发〔2022〕52号',
  ...
  employee: {
    outpatient: {
      ...
      tierBenefits: {
        ...
        tier1: { tierName: '一级定点医疗机构', deductible: 650, reimbursementRatio: 0.70, retireeRatioBonus: 0.05 },
        tier2: { tierName: '二级定点医疗机构', deductible: 650, reimbursementRatio: 0.65, retireeRatioBonus: 0.05 },
        tier3: { tierName: '三级综合医院', deductible: 650, reimbursementRatio: 0.60, retireeRatioBonus: 0.05 },
        tier3_top: { tierName: '重点三级甲等医院', deductible: 650, reimbursementRatio: 0.60, retireeRatioBonus: 0.05 }
      },
      note: '门诊年度起付线在职650元、退休500元。一级报销70%（退休75%）、二级报销65%（退休70%）、三级报销60%（退休65%）。年度最高支付限额6000元。'
    },
    inpatient: {
      sourceDocId: 'sq-medical-insurance-inpatient-2023',
