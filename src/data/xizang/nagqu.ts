...
export const nagquData: CityInsuranceData = {
  cityCode: '540600',
  cityName: '那曲市',
  provinceCode: '540000',
  provinceName: '西藏自治区',
  ...
  sourceDocs: [
    {
      docId: 'nq-employee-outpatient-2021-36',
      title: '西藏自治区关于建立职工基本医疗保险门诊共济保障机制的实施办法',
      docNumber: '藏政办发〔2021〕36号及那曲市实施细则',
      issuingDept: ['西藏自治区人民政府办公厅', '那曲市医疗保障局'],
    ...
    {
      docId: 'nq-medical-insurance-inpatient-2024',
      title: '那曲市基本医疗保险综合保障管理实施细则',
      docNumber: '那医保发〔2024〕15号',
      issuingDept: ['那曲市医疗保障局', '那曲市财政局'],
      publishDate: '2024-11-20',
      effectiveDate: '2025-01-01',
      status: 'active',
      officialUrl: 'http://ybj.xizang.gov.cn/zwgk/zcfg/202411/t20241126_3490129.html',
  ...
  employee: {
    ...
    inpatient: {
      sourceDocId: 'nq-medical-insurance-inpatient-2024',
      annualCap: 500000,
      tierBenefits: {
