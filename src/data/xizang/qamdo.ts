...
export const qamdoData: CityInsuranceData = {
  cityCode: '540300',
  cityName: '昌都市',
  provinceCode: '540000',
  provinceName: '西藏自治区',
  ...
  sourceDocs: [
    {
      docId: 'cd-employee-outpatient-2021-36',
      title: '西藏自治区关于建立职工基本医疗保险门诊共济保障机制的实施办法',
      docNumber: '藏政办发〔2021〕36号及昌都市实施细则',
      issuingDept: ['西藏自治区人民政府办公厅', '昌都市医疗保障局'],
    ...
    {
      docId: 'cd-medical-insurance-inpatient-2024',
      title: '昌都市基本医疗保险综合保障管理实施细则',
      docNumber: '昌医保发〔2024〕16号',
      issuingDept: ['昌都市医疗保障局', '昌都市财政局'],
      publishDate: '2024-11-20',
      effectiveDate: '2025-01-01',
      status: 'active',
      officialUrl: 'http://ybj.xizang.gov.cn/zwgk/zcfg/202411/t20241126_3490126.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'cd-employee-outpatient-2021-36',
    ...
    inpatient: {
      sourceDocId: 'cd-medical-insurance-inpatient-2024',
      annualCap: 500000,
      tierBenefits: {
