...
export const ngariData: CityInsuranceData = {
  cityCode: '542500',
  cityName: '阿里地区',
  provinceCode: '540000',
  provinceName: '西藏自治区',
  ...
  sourceDocs: [
    {
      docId: 'al-employee-outpatient-2021-36',
      title: '西藏自治区关于建立职工基本医疗保险门诊共济保障机制的实施办法',
      docNumber: '藏政办发〔2021〕36号及阿里地区实施细则',
      issuingDept: ['西藏自治区人民政府办公厅', '阿里地区医疗保障局'],
    ...
    {
      docId: 'al-medical-insurance-inpatient-2024',
      title: '阿里地区基本医疗保险综合保障管理实施细则',
      docNumber: '阿医保发〔2024〕14号',
      issuingDept: ['阿里地区医疗保障局', '阿里地区财政局'],
      publishDate: '2024-11-20',
      effectiveDate: '2025-01-01',
      status: 'active',
      officialUrl: 'http://ybj.xizang.gov.cn/zwgk/zcfg/202411/t20241126_3490130.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'al-employee-outpatient-2021-36',
      ...
      tierBenefits: {
        ...
        tier3: { tierName: '地区三级定点医疗机构', deductible: 200, reimbursementRatio: 0.60, retireeRatioBonus: 0.10 },
    ...
    inpatient: {
      sourceDocId: 'al-medical-insurance-inpatient-2024',
      annualCap: 500000,
      tierBenefits: {
        ...
        tier3: { tierName: '地区三级定点医疗机构', deductible: 600, reimbursementRatio: 0.90, retireeRatioBonus: 0.04 },
