...
export const shannanData: CityInsuranceData = {
  cityCode: '540500',
  cityName: '山南市',
  provinceCode: '540000',
  provinceName: '西藏自治区',
  ...
  sourceDocs: [
    {
      docId: 'sn-employee-outpatient-2021-36',
      title: '西藏自治区关于建立职工基本医疗保险门诊共济保障机制的实施办法',
      docNumber: '藏政办发〔2021〕36号及山南市实施细则',
      issuingDept: ['西藏自治区人民政府办公厅', '山南市医疗保障局'],
    ...
    },
    {
      ...
      title: '山南市基本医疗保险综合保障管理实施细则',
      docNumber: '山医保发〔2024〕17号',
      issuingDept: ['山南市医疗保障局', '山南市财政局'],
      publishDate: '2024-11-20',
      effectiveDate: '2025-01-01',
      status: 'active',
      officialUrl: 'http://ybj.xizang.gov.cn/zwgk/zcfg/202411/t20241126_3490128.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'sn-employee-outpatient-2021-36',
