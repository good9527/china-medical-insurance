...
export const shigatseData: CityInsuranceData = {
  cityCode: '540200',
  cityName: '日喀则市',
  provinceCode: '540000',
  provinceName: '西藏自治区',
  ...
  sourceDocs: [
    {
      docId: 'rkz-employee-outpatient-2021-36',
      title: '西藏自治区关于建立职工基本医疗保险门诊共济保障机制的实施办法',
      docNumber: '藏政办发〔2021〕36号及日喀则市实施细则',
      issuingDept: ['西藏自治区人民政府办公厅', '日喀则市医疗保障局'],
    ...
    {
      docId: 'rkz-medical-insurance-inpatient-2024',
      title: '日喀则市基本医疗保险综合保障管理实施细则',
      docNumber: '日医保发〔2024〕18号',
      issuingDept: ['日喀则市医疗保障局', '日喀则市财政局'],
      publishDate: '2024-11-20',
      effectiveDate: '2025-01-01',
      status: 'active',
      officialUrl: 'http://ybj.xizang.gov.cn/zwgk/zcfg/202411/t20241126_3490125.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'rkz-employee-outpatient-2021-36',
    ...
    inpatient: {
      sourceDocId: 'rkz-medical-insurance-inpatient-2024',
      annualCap: 500000,
      tierBenefits: {
