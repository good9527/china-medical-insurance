...
export const yinchuanCityData: CityInsuranceData = {
  cityCode: '640100',
  cityName: '银川市',
  provinceCode: '640000',
  provinceName: '宁夏回族自治区',
  hotline: '0951-12393',
  officialPortalUrl: 'http://ybj.yinchuan.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'yc-employee-outpatient-2023-3',
      title: '宁夏回族自治区职工基本医疗保险门诊共济保障实施办法',
      docNumber: '宁医保规〔2023〕3号',
      issuingDept: ['宁夏回族自治区医疗保障局', '宁夏回族自治区财政厅'],
      publishDate: '2023-05-15',
      effectiveDate: '2023-06-01',
      status: 'active',
      officialUrl: 'http://ybj.nx.gov.cn/zwgk/zcfg/202305/t20230520_4109234.html',
    ...
    },
    {
      ...
      title: '银川市基本医疗保险住院保障及统筹支付管理细则',
      docNumber: '银医保发〔2024〕22号',
      issuingDept: ['银川市医疗保障局', '银川市财政局'],
      publishDate: '2024-11-20',
      effectiveDate: '2025-01-01',
      status: 'active',
      officialUrl: 'http://ybj.yinchuan.gov.cn/zwgk/zcfg/202411/t20241126_5190123.html',
      summaryQuote: '职工住院起付线：三级800元、二级400元、一级200元；在职支付比例三级85%、二级88%、一级92%（退休人员提高至89%、92%、95%）。居民住院起付线三级700元/60%、二级300元/75%、一级100元/85%。基本统筹限额15万元。大病保险起付线1万元，分段报销60%-75%，封顶30万元。'
    }
  ],
  ...
  employee: {
    outpatient: {
      sourceDocId: 'yc-employee-outpatient-2023-3',
      annualDeductible: 300, // 门诊年度基准起付线
      annualCap: 4000,       // 在职限额 4000 元
      annualCapRetiree: 4500, // 退休限额 4500 元
      tierBenefits: {
        ...
        tier3_top: { tierName: '自治区重点三甲医院', deductible: 300, reimbursementRatio: 0.60, retireeRatioBonus: 0.05 }
      },
    ...
    inpatient: {
      ...
      tierBenefits: {
        ...
        tier3_top: { tierName: '自治区级重点三甲医院', deductible: 800, reimbursementRatio: 0.85, retireeRatioBonus: 0.04 }
      },
      repeatedDeductibleRule: '同自然年度内多次住院起付线按规定递减减免。'
    },
    catastrophic: {
      sourceDocId: 'yc-medical-insurance-inpatient-2024',
      name: '职工大额医疗费用补助',
  ...
  resident: {
    ...
    inpatient: {
      ...
      tierBenefits: {
        ...
        tier3_top: { tierName: '自治区重点三甲医院', deductible: 700, reimbursementRatio: 0.60 }
      }
    },
    catastrophic: {
      sourceDocId: 'yc-medical-insurance-inpatient-2024',
    ...
    remoteMedical: {
      sourceDocId: 'yc-medical-insurance-inpatient-2024',
      filingChannels: ['国家医保服务平台APP', '宁夏医保小程序'],
      longTermFiledRatio: 1.0,
