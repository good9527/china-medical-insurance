...
export const guyuanData: CityInsuranceData = {
  cityCode: '640400',
  cityName: '固原市',
  provinceCode: '640000',
  provinceName: '宁夏回族自治区',
  hotline: '0954-12393',
  officialPortalUrl: 'http://ybj.nxgy.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'gy-employee-outpatient-2023',
      title: '宁夏回族自治区职工基本医疗保险门诊共济保障实施办法',
      docNumber: '宁医保规〔2023〕3号',
      issuingDept: ['宁夏回族自治区医疗保障局', '固原市医疗保障局'],
      publishDate: '2023-05-15',
      effectiveDate: '2023-06-01',
      status: 'active',
      officialUrl: 'http://ybj.nxgy.gov.cn/zwgk/zcfg/202305/t20230520_4109234.html',
    ...
    },
    {
      ...
      title: '固原市基本医疗保险综合保障管理实施细则',
      docNumber: '固医保发〔2024〕28号',
      issuingDept: ['固原市医疗保障局', '固原市财政局'],
      publishDate: '2024-11-20',
      effectiveDate: '2025-01-01',
      status: 'active',
      officialUrl: 'http://ybj.nxgy.gov.cn/zwgk/zcfg/202411/t20241126_5190123.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'gy-employee-outpatient-2023',
    ...
    inpatient: {
      ...
      repeatedDeductibleRule: '同自然年度内多次住院起付线按全区统一规定递减。'
    },
    catastrophic: {
      sourceDocId: 'gy-medical-insurance-inpatient-2024',
      name: '职工大额医疗费用补助',
