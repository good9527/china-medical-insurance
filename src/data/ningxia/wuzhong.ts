...
export const wuzhongData: CityInsuranceData = {
  cityCode: '640300',
  cityName: '吴忠市',
  provinceCode: '640000',
  provinceName: '宁夏回族自治区',
  hotline: '0953-12393',
  officialPortalUrl: 'http://ybj.wuzhong.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'wz-employee-outpatient-2023',
      title: '宁夏回族自治区职工基本医疗保险门诊共济保障实施办法',
      docNumber: '宁医保规〔2023〕3号',
      issuingDept: ['宁夏回族自治区医疗保障局', '吴忠市医疗保障局'],
      publishDate: '2023-05-15',
      effectiveDate: '2023-06-01',
      status: 'active',
      officialUrl: 'http://ybj.wuzhong.gov.cn/zwgk/zcfg/202305/t20230520_4109234.html',
    ...
    },
    {
      ...
      title: '吴忠市基本医疗保险综合保障管理实施细则',
      docNumber: '吴医保发〔2024〕26号',
      issuingDept: ['吴忠市医疗保障局', '吴忠市财政局'],
      publishDate: '2024-11-20',
      effectiveDate: '2025-01-01',
      status: 'active',
      officialUrl: 'http://ybj.wuzhong.gov.cn/zwgk/zcfg/202411/t20241126_5190123.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'wz-employee-outpatient-2023',
