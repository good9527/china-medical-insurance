...
export const zhongweiData: CityInsuranceData = {
  cityCode: '640500',
  cityName: '中卫市',
  provinceCode: '640000',
  provinceName: '宁夏回族自治区',
  hotline: '0955-12393',
  officialPortalUrl: 'http://ybj.nxzw.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'zw-employee-outpatient-2023',
      title: '宁夏回族自治区职工基本医疗保险门诊共济保障实施办法',
      docNumber: '宁医保规〔2023〕3号',
      issuingDept: ['宁夏回族自治区医疗保障局', '中卫市医疗保障局'],
      publishDate: '2023-05-15',
      effectiveDate: '2023-06-01',
      status: 'active',
      officialUrl: 'http://ybj.nxzw.gov.cn/zwgk/zcfg/202305/t20230520_4109234.html',
    ...
    {
      docId: 'zw-medical-insurance-inpatient-2024',
      title: '中卫市基本医疗保险综合保障管理细则',
      docNumber: '卫医保发〔2024〕27号',
      issuingDept: ['中卫市医疗保障局', '中卫市财政局'],
      publishDate: '2024-11-20',
      effectiveDate: '2025-01-01',
      status: 'active',
      officialUrl: 'http://ybj.nxzw.gov.cn/zwgk/zcfg/202411/t20241126_5190123.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'zw-employee-outpatient-2023',
    ...
    inpatient: {
      sourceDocId: 'zw-medical-insurance-inpatient-2024',
      annualCap: 500000,
      tierBenefits: {
      ...
      repeatedDeductibleRule: '同自然年度内多次住院起付线按全区统筹规则执行。'
    },
    catastrophic: {
      sourceDocId: 'zw-medical-insurance-inpatient-2024',
      name: '职工大额医疗费用补助',
