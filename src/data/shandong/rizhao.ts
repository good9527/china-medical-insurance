...
export const rizhaoCityData: CityInsuranceData = {
  cityCode: '371100',
  cityName: '日照市',
  provinceCode: '370000',
  provinceName: '山东省',
  hotline: '0633-12393',
  officialPortalUrl: 'http://ybj.rizhao.gov.cn/',
  lastUpdated: '2026-03-01',

  sourceDocs: [
    {
      docId: 'rz-employee-outpatient-2022-17',
      title: '日照市人民政府办公室关于印发日照市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '日政办发〔2022〕17号',
      issuingDept: ['日照市人民政府办公室', '日照市医疗保障局'],
      publishDate: '2022-12-16',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.rizhao.gov.cn/zwgk/zcfg/202212/t20221220_198231.shtml',
      summaryQuote: '职工普通门诊统筹起付标准为200元；报销比例：基层医疗机构75%（退休80%），二级医疗机构65%（退休70%），三级医疗机构55%（退休60%）；年度最高支付限额在职职工2000元，退休人员2500元。'
    },
    {
      docId: 'rz-medical-insurance-inpatient-2023',
      title: '日照市医疗保障局关于印发日照市基本医疗保险和重大疾病医疗保障实施细则的通知',
      docNumber: '日医保发〔2023〕22号',
      issuingDept: ['日照市医疗保障局', '日照市财政局'],
  ...
  employee: {
    outpatient: {
      sourceDocId: 'rz-employee-outpatient-2022-17',
      ...
      tierBenefits: {
        ...
        tier3_top: { tierName: '日照市人民医院等重点三甲', deductible: 200, reimbursementRatio: 0.55, retireeRatioBonus: 0.05 }
      },
      note: '普通门诊统筹按年度设起付线200元。基层报销75%（退休80%），二级65%（退休70%），三级55%（退休60%）。限额在职2000元，退休2500元。'
    },
    inpatient: {
      sourceDocId: 'rz-medical-insurance-inpatient-2023',
      annualCap: 500000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'rz-medical-insurance-inpatient-2023',
      filingChannels: ['国家医保服务平台APP', '爱山东APP', '日照医保微信公众号'],
