  ...
  resident: {
    outpatient: {
      ...
      tierBenefits: {
        ...
        tier1: { tierName: '一级医疗机构(普通门诊未签约)', deductible: 200, reimbursementRatio: 0.85 },
        tier2: { tierName: '二级医疗机构(未纳统筹)', deductible: 700, reimbursementRatio: 0.75 },
        tier3: { tierName: '三级医疗机构(未纳统筹)', deductible: 1000, reimbursementRatio: 0.60 },
        tier3_top: { tierName: '重点三甲医院(未纳统筹)', deductible: 1000, reimbursementRatio: 0.60 }
      },
