...
export const zaozhuangCityData: CityInsuranceData = {
  cityCode: '370400',
  cityName: '枣庄市',
  provinceCode: '370000',
  provinceName: '山东省',
  hotline: '0632-12393',
  officialPortalUrl: 'http://ybj.zaozhuang.gov.cn/',
  lastUpdated: '2026-03-01',

  sourceDocs: [
    {
      docId: 'zz-employee-outpatient-2022-19',
      title: '枣庄市人民政府办公室关于印发枣庄市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '枣政办发〔2022〕19号',
      issuingDept: ['枣庄市人民政府办公室', '枣庄市医疗保障局'],
      publishDate: '2022-12-18',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.zaozhuang.gov.cn/zwgk/zcfg/202212/t20221222_198231.shtml',
      summaryQuote: '职工普通门诊统筹起付标准为200元；报销比例：基层医疗机构75%（退休80%），二级医疗机构65%（退休70%），三级医疗机构55%（退休60%）；年度最高支付限额在职职工2000元，退休人员2500元。'
    },
    {
      docId: 'zz-medical-insurance-inpatient-2023',
      title: '枣庄市医疗保障局关于印发枣庄市基本医疗保险和重大疾病保障细则的通知',
      docNumber: '枣医保发〔2023〕18号',
      issuingDept: ['枣庄市医疗保障局', '枣庄市财政局'],
  ...
  employee: {
    outpatient: {
      sourceDocId: 'zz-employee-outpatient-2022-19',
      ...
      tierBenefits: {
        ...
        tier3_top: { tierName: '市级重点三甲医院', deductible: 200, reimbursementRatio: 0.55, retireeRatioBonus: 0.05 }
      },
      note: '普通门诊统筹按年度设起付线200元。基层报销75%（退休80%），二级65%（退休70%），三级55%（退休60%）。限额在职2000元，退休2500元。'
    },
    inpatient: {
      sourceDocId: 'zz-medical-insurance-inpatient-2023',
      annualCap: 500000,
      tierBenefits: {
        ...
        tier3_top: { tierName: '市立医院等重点三甲', deductible: 800, reimbursementRatio: 0.85, retireeRatioBonus: 0.03 }
      },
    ...
    remoteMedical: {
      sourceDocId: 'zz-medical-insurance-inpatient-2023',
      filingChannels: ['国家医保服务平台APP', '爱山东APP', '枣庄医保微信公众号'],
