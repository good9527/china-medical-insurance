...
export const jiningCityData: CityInsuranceData = {
  cityCode: '370800',
  cityName: '济宁市',
  provinceCode: '370000',
  provinceName: '山东省',
  hotline: '0537-12393',
  officialPortalUrl: 'http://ybj.jining.gov.cn/',
  lastUpdated: '2026-03-01',

  sourceDocs: [
    {
      docId: 'jn2-employee-outpatient-2022-15',
      title: '济宁市人民政府办公室关于印发济宁市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '济政办发〔2022〕15号',
      issuingDept: ['济宁市人民政府办公室', '济宁市医疗保障局'],
      publishDate: '2022-12-16',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.jining.gov.cn/zwgk/zcfg/202212/t20221220_192834.shtml',
      summaryQuote: '职工普通门诊统筹起付标准为200元；报销比例：基层医疗机构75%（退休80%），二级医疗机构65%（退休70%），三级医疗机构55%（退休60%）；年度最高支付限额在职职工2000元，退休人员2500元。'
    },
    {
      docId: 'jn2-medical-insurance-inpatient-2024',
      title: '济宁市医疗保障局关于调整基本医疗保险住院与大病保险待遇政策的通知',
      docNumber: '济医保规〔2024〕1号',
      issuingDept: ['济宁市医疗保障局', '济宁市财政局'],
      publishDate: '2024-03-20',
      effectiveDate: '2024-05-01',
      status: 'active',
      officialUrl: 'http://ybj.jining.gov.cn/zwgk/zcfg/202403/t20240325_229108.shtml',
  ...
  employee: {
    ...
    remoteMedical: {
      sourceDocId: 'jn2-medical-insurance-inpatient-2024',
      filingChannels: ['国家医保服务平台APP', '爱山东APP', '济宁医保微信公众号'],
