...
export const liaochengCityData: CityInsuranceData = {
  cityCode: '371500',
  cityName: '聊城市',
  provinceCode: '370000',
  provinceName: '山东省',
  hotline: '0635-12393',
  officialPortalUrl: 'http://ybj.liaocheng.gov.cn/',
  lastUpdated: '2026-03-01',

  sourceDocs: [
    {
      docId: 'lc-employee-outpatient-2022-16',
      title: '聊城市人民政府办公室关于印发聊城市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '聊政办发〔2022〕16号',
      issuingDept: ['聊城市人民政府办公室', '聊城市医疗保障局'],
      publishDate: '2022-12-16',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.liaocheng.gov.cn/zwgk/zcfg/202212/t20221220_198231.shtml',
      summaryQuote: '职工普通门诊统筹起付标准为200元；报销比例：基层医疗机构75%（退休80%），二级医疗机构65%（退休70%），三级医疗机构55%（退休60%）；年度最高支付限额在职职工2000元，退休人员2500元。'
    },
    {
      docId: 'lc-medical-insurance-inpatient-2023',
      title: '聊城市医疗保障局关于印发聊城市基本医疗保险统筹支付管理细则的通知',
      docNumber: '聊医保发〔2023〕29号',
      issuingDept: ['聊城市医疗保障局', '聊城市财政局'],
      publishDate: '2023-10-22',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.liaocheng.gov.cn/zwgk/zcfg/202310/t20231026_219084.shtml',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'lc-employee-outpatient-2022-16',
      ...
      tierBenefits: {
        ...
        tier3_top: { tierName: '聊城市人民医院等重点三甲', deductible: 200, reimbursementRatio: 0.55, retireeRatioBonus: 0.05 }
      },
      note: '普通门诊统筹按年度设起付线200元。基层报销75%（退休80%），二级65%（退休70%），三级55%（退休60%）。限额在职2000元，退休2500元。'
    },
    inpatient: {
      sourceDocId: 'lc-medical-insurance-inpatient-2023',
      annualCap: 500000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'lc-medical-insurance-inpatient-2023',
      filingChannels: ['国家医保服务平台APP', '爱山东APP', '聊城医保微信公众号'],
  ...
  resident: {
    outpatient: {
      ...
      tierBenefits: {
        ...
        tier1: { tierName: '一级医疗机构(普通门诊未签约)', deductible: 200, reimbursementRatio: 0.80 },
        tier2: { tierName: '二级医疗机构(未纳统筹)', deductible: 500, reimbursementRatio: 0.75 },
