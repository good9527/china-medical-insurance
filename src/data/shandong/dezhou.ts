...
export const dezhouCityData: CityInsuranceData = {
  cityCode: '371400',
  cityName: '德州市',
  provinceCode: '370000',
  provinceName: '山东省',
  hotline: '0534-12393',
  officialPortalUrl: 'http://ybj.dezhou.gov.cn/',
  lastUpdated: '2026-03-01',

  sourceDocs: [
    {
      docId: 'dz-employee-outpatient-2022-14',
      title: '德州市人民政府办公室关于印发德州市建立健全职工基本医疗保险门诊共济保障机制实施细则的通知',
      docNumber: '德政办发〔2022〕14号',
      issuingDept: ['德州市人民政府办公室', '德州市医疗保障局'],
      publishDate: '2022-12-16',
      effectiveDate: '2023-01-01',
      status: 'active',
      officialUrl: 'http://ybj.dezhou.gov.cn/zwgk/zcfg/202212/t20221220_198231.shtml',
      summaryQuote: '职工普通门诊统筹起付标准为200元；报销比例：基层医疗机构75%（退休80%），二级医疗机构65%（退休70%），三级医疗机构55%（退休60%）；年度最高支付限额在职职工2000元，退休人员2500元。'
    },
    {
      docId: 'dz-medical-insurance-inpatient-2023',
      title: '德州市医疗保障局关于印发德州市基本医疗保险住院和大病保险管理办法的通知',
      docNumber: '德医保发〔2023〕27号',
      issuingDept: ['德州市医疗保障局', '德州市财政局'],
      publishDate: '2023-10-18',
      effectiveDate: '2024-01-01',
      status: 'active',
      officialUrl: 'http://ybj.dezhou.gov.cn/zwgk/zcfg/202310/t20231024_219084.shtml',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'dz-employee-outpatient-2022-14',
      ...
      tierBenefits: {
        ...
        tier3_top: { tierName: '德州市人民医院等重点三甲', deductible: 200, reimbursementRatio: 0.55, retireeRatioBonus: 0.05 }
      },
      note: '普通门诊统筹按年度设起付线200元。基层报销75%（退休80%），二级65%（退休70%），三级55%（退休60%）。限额在职2000元，退休2500元。'
    },
    inpatient: {
      sourceDocId: 'dz-medical-insurance-inpatient-2023',
      annualCap: 500000,
      tierBenefits: {
    ...
    remoteMedical: {
      sourceDocId: 'dz-medical-insurance-inpatient-2023',
      filingChannels: ['国家医保服务平台APP', '爱山东APP', '德州医保微信公众号'],
  ...
  resident: {
    outpatient: {
      ...
      tierBenefits: {
        ...
        tier1: { tierName: '一级医疗机构(普通门诊未签约)', deductible: 200, reimbursementRatio: 0.90 },
        tier2: { tierName: '二级医疗机构(未纳统筹)', deductible: 500, reimbursementRatio: 0.72 },
        tier3: { tierName: '三级医疗机构(未纳统筹)', deductible: 900, reimbursementRatio: 0.60 },
        tier3_top: { tierName: '重点三甲医院(未纳统筹)', deductible: 900, reimbursementRatio: 0.60 }
      },
    ...
    inpatient: {
      ...
      tierBenefits: {
        ...
        tier2: { tierName: '二级定点医疗机构', deductible: 500, reimbursementRatio: 0.72 },
        tier3: { tierName: '三级定点医疗机构', deductible: 900, reimbursementRatio: 0.60 },
        tier3_top: { tierName: '市级重点三甲医院', deductible: 900, reimbursementRatio: 0.60 }
      },
