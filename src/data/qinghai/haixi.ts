...
export const haixiData: CityInsuranceData = {
  cityCode: '632800',
  cityName: '海西蒙古族藏族自治州',
  provinceCode: '630000',
  provinceName: '青海省',
  hotline: '0977-12393',
  officialPortalUrl: 'http://ybj.haixi.gov.cn/',
  lastUpdated: '2026-03-01',

  // 权威规范性红头文件与政府溯源凭证
  sourceDocs: [
    {
      docId: 'hx-employee-outpatient-2021',
      title: '青海省职工基本医疗保险门诊共济保障实施办法',
      docNumber: '青政办〔2021〕79号',
      issuingDept: ['青海省人民政府办公厅', '海西州医疗保障局'],
      publishDate: '2021-12-28',
      effectiveDate: '2022-01-01',
      status: 'active',
      officialUrl: 'http://ybj.haixi.gov.cn/zwgk/zcfg/202112/t20211230_3190823.html',
      summaryQuote: '门诊统筹不设起付标准。统筹基金支付比例二级及以下60%（退休70%）、三级50%（退休60%）。门诊统筹每人每年最高支付限额统一为2000元。'
    },
    {
      docId: 'hx-medical-insurance-inpatient-2024',
      title: '海西州基本医疗保险综合保障管理实施方案',
      docNumber: '西医保发〔2024〕28号',
      issuingDept: ['海西蒙古族藏族自治州医疗保障局', '海西蒙古族藏族自治州财政局'],
      publishDate: '2024-11-20',
      effectiveDate: '2025-01-01',
      status: 'active',
      officialUrl: 'http://ybj.haixi.gov.cn/zwgk/zcfg/202411/t20241126_6391024.html',
  ...
  employee: {
    outpatient: {
      sourceDocId: 'hx-employee-outpatient-2021',
      annualDeductible: 0,
      annualCap: 2000,
    ...
    inpatient: {
      sourceDocId: 'hx-medical-insurance-inpatient-2024',
      annualCap: 500000,
      tierBenefits: {
