...
export const haidongData: CityInsuranceData = {
  cityCode: '630200',
  cityName: '海东市',
  provinceCode: '630000',
  provinceName: '青海省',
  hotline: '0972-12393',
  officialPortalUrl: 'http://ybj.haidong.gov.cn/',
  ...
  sourceDocs: [
    {
      ...
      issuingDept: ['青海省人民政府办公厅', '海东市医疗保障局'],
      publishDate: '2021-12-28',
      effectiveDate: '2022-01-01',
      status: 'active',
      officialUrl: 'http://ybj.haidong.gov.cn/zwgk/zcfg/202112/t20211230_3190823.html',
      summaryQuote: '门诊统筹不设起付标准。统筹基金支付比例二级及以下60%（退休70%）、三级50%（退休60%）。门诊统筹每人每年最高支付限额统一为2000元。'
    },
    {
      docId: 'hd-medical-insurance-inpatient-2024',
      title: '海东市基本医疗保险综合保障管理细则',
      docNumber: '东医保发〔2024〕25号',
      issuingDept: ['海东市医疗保障局', '海东市财政局'],
      publishDate: '2024-11-20',
      effectiveDate: '2025-01-01',
      status: 'active',
      officialUrl: 'http://ybj.haidong.gov.cn/zwgk/zcfg/202411/t20241126_6391024.html',
  ...
  employee: {
    ...
    inpatient: {
      sourceDocId: 'hd-medical-insurance-inpatient-2024',
      annualCap: 500000,
      tierBenefits: {
