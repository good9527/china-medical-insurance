...
// ============================================================================
// 全省 11 统筹区医保精算与官方溯源自动化全量测试套件
// ============================================================================

export function runCalculatorTests() {
  console.log('====== 开始全国已录入统筹区医保精算与官方数据全量校验 ======');
  ...
  // --------------------------------------------------------------------------
  // Suite B: 门诊共济机制与门诊待遇全场景精算校验 (全省 11 统筹区)
  // --------------------------------------------------------------------------
  console.log('\n=========================================');
  ...
  // --------------------------------------------------------------------------
  // Suite H: Challenger 2 缺陷闭环回归与防御性精算校验
  // --------------------------------------------------------------------------
  console.log('\n=========================================');
  console.log('>>> [Suite H] Challenger 2 缺陷闭环回归与防御性精算校验');
  ...
  // --------------------------------------------------------------------------
  // Suite H5: 广东省重点城市医保精算专项断言 (珠海、佛山、东莞、惠州、中山、江门、肇庆、汕头)
  // --------------------------------------------------------------------------
  console.log('\n>>> [Suite H5] 执行广东省地级市专项医保精算断言...');
  ...
  // --------------------------------------------------------------------------
  // Suite H6: 四川省全域市州专项医保精算断言
  // --------------------------------------------------------------------------
  console.log('\n>>> [Suite H6] 执行四川省市州专项医保精算断言...');
  ...
  // --------------------------------------------------------------------------
  // Suite H7: 山东省全域地级市专项医保精算断言
  // --------------------------------------------------------------------------
  console.log('\n>>> [Suite H7] 执行山东省地级市专项医保精算断言...');
  ...
  // --------------------------------------------------------------------------
  // Suite H8: 河南省全域地级市及示范区专项医保精算断言
  // --------------------------------------------------------------------------
  console.log('\n>>> [Suite H8] 执行河南省地级市专项医保精算断言...');
  ...
  // --------------------------------------------------------------------------
  // Suite H9: 湖北省全域统筹区专项精算断言
  // --------------------------------------------------------------------------
  console.log('\n>>> [Suite H9] 执行湖北省地级市/省直管市专项医保精算断言...');
  ...
  // --------------------------------------------------------------------------
  // Suite H10: 湖南省全域统筹区专项精算断言
  // --------------------------------------------------------------------------
  console.log('\n>>> [Suite H10] 执行湖南省地级市/州专项医保精算断言...');
  ...
  console.log(`\n>>> [Suite H11] 执行河北省地级市/直管市/雄安新区专项医保精算断言...`);
  ...
  console.log(`\n>>> [Suite H15] 执行广西壮族自治区地级市专项医保精算断言...`);
  ...
  // =========================================================================
  // Suite H16: 辽宁省全域 14 个地级市精算核验与红头文件依据闭环
  // =========================================================================
  ...
  // =========================================================================
  // Suite H17: 吉林省全域 9 个市州精算核验与红头文件依据闭环
  // =========================================================================
  ...
  // =========================================================================
  // Suite H18: 黑龙江省全域 13 个市地精算核验与红头文件依据闭环
  // =========================================================================
  ...
  // =========================================================================
  // Suite H19: 贵州省全域 9 个市州精算核验与红头文件依据闭环
  // =========================================================================
  ...
  // =========================================================================
  // Suite H20: 云南省全域 16 个市州精算核验与红头文件依据闭环
  // =========================================================================
  ...
  // =========================================================================
  // Suite H21: 甘肃省地级市、自治州及兰州新区医保待遇精算断言
  // =========================================================================
  console.log('\n>>> [Suite H21] 执行甘肃省地级市及自治州专项医保精算断言...');
  ...
  // =========================================================================
  // Suite H22: 内蒙古自治区地级市与盟市专项医保精算断言
  // =========================================================================
  console.log('\n>>> [Suite H22] 执行内蒙古自治区地级市与盟市专项医保精算断言...');
  ...
  // =========================================================================
  // Suite H23: 宁夏回族自治区地级市专项医保精算断言
  // =========================================================================
  console.log('\n>>> [Suite H23] 执行宁夏回族自治区地级市专项医保精算断言...');
  ...
  // =========================================================================
  // Suite H24: 青海省地级市与自治州专项医保精算断言
  // =========================================================================
  console.log('\n>>> [Suite H24] 执行青海省地级市与自治州专项医保精算断言...');
  ...
  // =========================================================================
  // Suite H25: 新疆维吾尔自治区地级市与自治州/地区专项医保精算断言
  // =========================================================================
  console.log('\n>>> [Suite H25] 执行新疆维吾尔自治区地级市与自治州/地区专项医保精算断言...');
  ...
  // =========================================================================
  // Suite H26: 西藏自治区地级市与地区专项医保精算断言
  // =========================================================================
  console.log('\n>>> [Suite H26] 执行西藏自治区地级市与地区专项医保精算断言...');
